...
FF/9599: 80 80        BRA Local_FF951B
...
FF/95AD: 30 30        BMI Local_FF95DF
FF/95AF: 00 1B        BRK $1B
FF/95B1: 16 7C        ASL $7C,X
FF/95B3: 68           PLA
FF/95B4: 6E 04 3E     ROR $3E04
FF/95B7: 3C 7D 42     BIT Local_FF427D,X
FF/95BA: 62 40 7E     PER $FF13FD
FF/95BD: 3C 3C 00     BIT Local_FF003C,X
FF/95C0: 20 60 74     JSR Local_FF7460
FF/95C3: 18           CLC
FF/95C4: 7B           TDC
...
FF/95CB: 08           PHP
FF/95CC: 78           SEI
FF/95CD: 70 70        BVS Local_FF963F
