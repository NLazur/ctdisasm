...
FF/5970: 3C C5 E9     BIT Local_FFE9C5,X
...
FF/59B1: 2C F1 0B     BIT Local_FF0BF1
...
FF/59DB: 80 EF        BRA Local_FF59CC
FF/59DD: 61 CC        ADC ($CC,X)
FF/59DF: CE 37 EF     DEC $EF37
FF/59E2: 4C EF D0     JMP Local_FFD0EF
...
FF/5A61: 3C C9 2A     BIT Local_FF2AC9,X
...
FF/5A7E: CB           WAI
FF/5A7F: 2C 98 EF     BIT Local_FFEF98
FF/5A82: 2A           ROL
