...
C7/7E3D: 68           PLA
C7/7E3E: 20 CB BF     JSR $BFCB
C7/7E41: 35 6F        AND $6F,X
C7/7E43: D0 1F        BNE $7E64
...
C7/7EC3: F0 68        BEQ $7F2D
C7/7EC5: 10 CD        BPL $7E94
...
C7/7F4E: B0 30        BCS $7F80
C7/7F50: D0 41        BNE $7F93
C7/7F52: CE 32 68     DEC $6832
C7/7F55: ED 24 1D     SBC $1D24
C7/7F58: D0 22        BNE $7F7C
...
C7/7FD9: 22 FC 48 A4  JSR $A448FC
C7/7FDD: 63 20        ADC $20,S
C7/7FDF: F0 DA        BEQ $7FBB
C7/7FE1: D1 65        CMP ($65),Y
C7/7FE3: 1E 58 E0     ASL $E058,X
C7/7FE6: 20 EC 13     JSR $13EC
C7/7FE9: 30 EE        BMI $7FD9
...
C7/809E: 22 ED 13 38  JSR $3813ED
...
C7/80F4: 22 FD 02 52  JSR $5202FD
C7/80F8: CC 02 FE     CPY $FE02
C7/80FB: 28           PLP
C7/80FC: 03 1E        ORA $1E,S
C7/80FE: E3 3F        SBC $3F,S
C7/8100: D0 21        BNE $8123
C7/8102: EE 00 28     INC $2800
C7/8105: 22 11 EE F0  JSR $F0EE11
C7/8109: F0 E3        BEQ $80EE
...
C7/81BA: 80 32        BRA $81EE
C7/81BC: 22 12 22 20  JSR $202212
C7/81C0: A3 11        LDA $11,S
C7/81C2: 32 94        AND ($94)
C7/81C4: F0 3F        BEQ $8205
...
C7/81F9: A8           TAY
C7/81FA: 22 00 ED E0  JSR $E0ED00
...
C7/824B: 5C 5C 6D E0  JMP $E06D5C
...
C7/826F: 10 2F        BPL $82A0
C7/8271: 00 41        BRK $41
C7/8273: 21 42        AND ($42,X)
C7/8275: 20 50 78     JSR $7850
