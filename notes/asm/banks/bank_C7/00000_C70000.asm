...
C7/0052: 8D 41 21     STA APUIO1
C7/0055: A9 FF        LDA #$FF
C7/0057: 8D 40 21     STA APUIO0
C7/005A: EC 40 21     CPX APUIO0
C7/005D: D0 F1        BNE Local_C70050
C7/005F: A2 00 00     LDX #$0000
C7/0062: AF 1C 00 C7  LDA $C7001C
C7/0066: 8D 42 21     STA APUIO2
C7/0069: AF 1D 00 C7  LDA $C7001D
C7/006D: 8D 43 21     STA APUIO3
C7/0070: A9 CC        LDA #$CC
C7/0072: 8D 41 21     STA APUIO1
C7/0075: 8D 40 21     STA APUIO0
Local_C70078:
C7/0078: CD 40 21     CMP APUIO0
...
C7/00A4: 8D 41 21     STA APUIO1
C7/00A7: EB           XBA
C7/00A8: 8D 40 21     STA APUIO0
Local_C700AB:
C7/00AB: CD 40 21     CMP APUIO0
...
C7/00CA: 8D 42 21     STA APUIO2
C7/00CD: BF 1D 00 C7  LDA $C7001D,X
C7/00D1: 8D 43 21     STA APUIO3
C7/00D4: EB           XBA
C7/00D5: 8D 41 21     STA APUIO1
C7/00D8: 8D 40 21     STA APUIO0
Local_C700DB:
C7/00DB: CD 40 21     CMP APUIO0
C7/00DE: D0 FB        BNE Local_C700DB
C7/00E0: 80 9B        BRA Local_C7007D
Local_C700E2:
C7/00E2: EB           XBA
C7/00E3: A9 02        LDA #$02
C7/00E5: 8D 43 21     STA APUIO3
C7/00E8: A9 00        LDA #$00
C7/00EA: 8D 42 21     STA APUIO2
C7/00ED: A9 00        LDA #$00
C7/00EF: 8D 41 21     STA APUIO1
C7/00F2: EB           XBA
C7/00F3: 8D 40 21     STA APUIO0
Local_C700F6:
C7/00F6: CD 40 21     CMP APUIO0
C7/00F9: D0 FB        BNE Local_C700F6
C7/00FB: EB           XBA
C7/00FC: 8D 40 21     STA APUIO0
