...
C7/A986: 10 02        BPL $A98A
C7/A988: 10 22        BPL $A9AC
C7/A98A: 00 EC        BRK $EC
C7/A98C: 10 21        BPL $A9AF
...
C7/A9EA: 10 1E        BPL $AA0A
C7/A9EC: 50 F1        BVC $A9DF
...
C7/A9FB: 10 BC        BPL $A9B9
C7/A9FD: 5C 22 1F 10  JMP $101F22
C7/AA01: E3 C0        SBC $C0,S
C7/AA03: A0 E0        LDY #$E0
C7/AA05: 24 33        BIT $33
C7/AA07: 30 20        BMI $AA29
...
C7/AA58: F0 B3        BEQ $AA0D
C7/AA5A: 3A           DEC
C7/AA5B: DF 6A A4 F5  CMP $F5A46A,X
C7/AA5F: F0 1F        BEQ $AA80
...
C7/AAE2: 22 E2 A4 D0  JSR $D0A4E2
...
C7/AAFA: 22 01 1F 20  JSR $201F01
C7/AAFE: 60           RTS