...
C7/96CB: F0 DB        BEQ $96A8
C7/96CD: 80 E1        BRA $96B0
...
C7/9777: 10 84        BPL $96FD
C7/9779: EE 40 03     INC $0340
C7/977C: ED D3 41     SBC $41D3
C7/977F: D0 DE        BNE $975F
C7/9781: 70 B0        BVS $9733
C7/9783: 34 40        BIT $40,X
C7/9785: 0F 12 EE 13  ORA $13EE12
C7/9789: 0D 80 E1     ORA $E180
C7/978C: 10 1F        BPL $97AD
C7/978E: F0 F1        BEQ $9781
C7/9790: 10 1C        BPL $97AE
...
C7/97BB: 4C BC F3     JMP $F3BC
C7/97BE: 22 32 70 CB  JSR $CB7032
...
C7/98A0: 22 60 69 E3  JSR $E36960
C7/98A4: 2B           PLD
C7/98A5: 25 1D        AND $1D
C7/98A7: F0 CE        BEQ $9877
...
C7/9907: 22 DD F3 F2  JSR $F2F3DD
...
C7/9947: 10 DC        BPL $9925
C7/9949: 3D 40 43     AND $4340,X
C7/994C: 64 1D        STZ $1D
C7/994E: 0B           PHD
C7/994F: AE 57 30     LDX $3057
C7/9952: EA           NOP
C7/9953: B0 53        BCS $99A8
C7/9955: 68           PLA
