...
C7/968C: F0 EF        BEQ Local_C7967D
C7/968E: 84 35        STY $35
C7/9690: ED 30 F0     SBC $F030
C7/9693: 3C A2 62     BIT Local_C762A2,X
C7/9696: E1 70        SBC ($70,X)
C7/9698: 2B           PLD
C7/9699: B0 52        BCS Local_C796ED
...
C7/96CD: 80 E1        BRA Local_C796B0
...
C7/9751: D0 34        BNE Local_C79787
...
C7/97BB: 4C BC F3     JMP Local_C7F3BC
...
C7/97DA: DA           PHX
C7/97DB: 70 D2        BVS Local_C797AF
...
C7/9800: D0 0F        BNE Local_C79811
...
C7/9822: 10 70        BPL Local_C79894
C7/9824: 10 33        BPL Local_C79859
C7/9826: FB           XCE
C7/9827: EF 25 53 CA  SBC $CA5325
C7/982B: F0 74        BEQ Local_C798A1
C7/982D: 23 BE        AND $BE,S
C7/982F: F3 4E        SBC ($4E,S),Y
C7/9831: 01 DF        ORA ($DF,X)
C7/9833: 20 FC 70     JSR Local_C770FC
...
C7/988F: 70 EF        BVS Local_C79880
...
C7/98A7: F0 CE        BEQ Local_C79877
...
C7/98BC: 70 3F        BVS Local_C798FD
...
C7/9952: EA           NOP
C7/9953: B0 53        BCS Local_C799A8
C7/9955: 68           PLA
