...
C7/C4B7: F0 20        BEQ Local_C7C4D9
...
C7/C4E4: B0 E0        BCS Local_C7C4C6
...
C7/C52B: B0 53        BCS Local_C7C580
C7/C52D: BB           TYX
C7/C52E: E1 4E        SBC ($4E,X)
C7/C530: A4 11        LDY $11
C7/C532: 5B           TCD
C7/C533: D0 B0        BNE Local_C7C4E5
C7/C535: 01 10        ORA ($10,X)
C7/C537: 12 10        ORA ($10)
C7/C539: BF E2 70 1F  LDA $1F70E2,X
C7/C53D: B0 E0        BCS Local_C7C51F
C7/C53F: D0 42        BNE Local_C7C583
