...
C7/0BEF: 0A           ASL
C7/0BF0: 4C 08 78     JMP Local_C77808
...
C7/0C77: F0 E1        BEQ Local_C70C5A
...
C7/0C92: 3C 00 00     BIT Local_C70000,X
...
C7/0DC5: CB           WAI
C7/0DC6: 50 7C        BVC Local_C70E44
C7/0DC8: CB           WAI
C7/0DC9: 57 7D        EOR [$7D],Y
C7/0DCB: CB           WAI
C7/0DCC: 01 84        ORA ($84,X)
C7/0DCE: CB           WAI
C7/0DCF: 50 8B        BVC Local_C70D5C
C7/0DD1: CB           WAI
