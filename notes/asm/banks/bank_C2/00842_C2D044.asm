...
C2/D06E: 20 0D D1     JSR Routine_C2D10D
...
C2/D07E: 20 1E 82     JSR Routine_C2821E
...
C2/D09E: 20 6C D3     JSR Routine_C2D36C
C2/D0A1: A2 1B FC     LDX #$FC1B
C2/D0A4: 20 85 83     JSR Routine_C28385
C2/D0A7: 9C 15 0D     STZ $0D15
C2/D0AA: 20 1E 82     JSR Routine_C2821E
...
C2/D0C2: 20 4A 98     JSR Routine_C2984A
C2/D0C5: 20 DD 86     JSR Routine_C286DD
C2/D0C8: A9 19        LDA #$19
C2/D0CA: 8D 13 0D     STA $0D13
C2/D0CD: A2 E3 FB     LDX #$FBE3
C2/D0D0: 20 85 83     JSR Routine_C28385
C2/D0D3: A2 FF FB     LDX #$FBFF
C2/D0D6: 20 85 83     JSR Routine_C28385
C2/D0D9: 28           PLP
C2/D0DA: 60           RTS