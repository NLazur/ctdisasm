...
C2/909B: 4A           LSR
C2/909C: AA           TAX
C2/909D: B0 06        BCS $90A5
C2/909F: B5 8A        LDA $8A,X
C2/90A1: 29 0F        AND #$0F
C2/90A3: 80 08        BRA $90AD
...
C2/90AB: 4A           LSR
C2/90AC: 4A           LSR
C2/90AD: D0 08        BNE $90B7
C2/90AF: A6 00        LDX $00
C2/90B1: F0 04        BEQ $90B7
C2/90B3: A6 02        LDX $02
C2/90B5: F0 2F        BEQ $90E6
C2/90B7: A6 02        LDX $02
C2/90B9: D0 0A        BNE $90C5
C2/90BB: 48           PHA
