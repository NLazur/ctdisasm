...
C2/8429: 2B           PLD
C2/842A: CD 10 42     CMP RDNMI
C2/842D: E6 00        INC $00
C2/842F: A9 80        LDA #$80
C2/8431: 8D 00 21     STA INIDISP
