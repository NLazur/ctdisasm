...
Routine_C2BECF:
C2/BECF: 58           CLI
C2/BED0: 80 2E        BRA Local_C2BF00
...
C2/BEE8: 20 20 88     JSR Routine_C28820
C2/BEEB: 05 51        ORA $51
C2/BEED: D0 3E        BNE Local_C2BF2D
C2/BEEF: 20 EF A1     JSR Routine_C2A1EF
C2/BEF2: A2 56 C0     LDX #$C056
C2/BEF5: 20 31 ED     JSR Routine_C2ED31
C2/BEF8: AD 90 9A     LDA $9A90
C2/BEFB: 20 26 F6     JSR Routine_C2F626
...
C2/BF1E: 90 02        BCC Local_C2BF22
...
C2/BF2B: D0 B9        BNE Local_C2BEE6
Local_C2BF2D:
C2/BF2D: 28           PLP
C2/BF2E: 60           RTS