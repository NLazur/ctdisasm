...
C2/C9B2: F0 19        BEQ Routine_C2C9CD
C2/C9B4: A5 54        LDA $54
C2/C9B6: C9 03        CMP #$03
C2/C9B8: B0 09        BCS Local_C2C9C3
C2/C9BA: AE 0B 0F     LDX $0F0B
C2/C9BD: D0 0E        BNE Routine_C2C9CD
C2/C9BF: 69 03        ADC #$03
C2/C9C1: 80 07        BRA Local_C2C9CA
Local_C2C9C3:
C2/C9C3: AE 0C 0F     LDX $0F0C
C2/C9C6: D0 05        BNE Routine_C2C9CD
