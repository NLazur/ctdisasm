; Bank: C2 | Start Address: 088F
Routine_C2088F:
C2/088F: 20 DB 08     JSR Routine_C208DB
...
C2/08B1: 4A           LSR
C2/08B2: B0 07        BCS Local_C208BB
C2/08B4: BD 04 00     LDA $0004,X
C2/08B7: 91 06        STA ($06),Y
C2/08B9: 80 10        BRA Local_C208CB
Local_C208BB:
...
C2/08C6: 90 01        BCC Local_C208C9
C2/08C8: 7B           TDC
Local_C208C9:
...
C2/08D7: D0 C7        BNE Local_C208A0
C2/08D9: AB           PLB
C2/08DA: 60           RTS