...
C2/BF42: 4C B5 C3     JMP Local_C2C3B5
C2/BF45: A9 5D 8D     LDA #$8D5D
C2/BF48: 13 0D        ORA ($0D,S),Y
C2/BF4A: 20 84 E9     JSR Local_C2E984
C2/BF4D: 2C 1D 0D     BIT Local_C20D1D
C2/BF50: 70 0D        BVS Local_C2BF5F
C2/BF52: 20 D4 BF     JSR Local_C2BFD4
C2/BF55: A5 81        LDA $81
C2/BF57: C5 54        CMP $54
C2/BF59: F0 03        BEQ Local_C2BF5E
C2/BF5B: 20 C2 EA     JSR Local_C2EAC2
C2/BF5E: 60           RTS