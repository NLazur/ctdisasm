...
C2/FEED: FA           PLX
C2/FEEE: 20 85 83     JSR Local_C28385
C2/FEF1: A2 89        LDX #$89
C2/FEF3: FA           PLX
C2/FEF4: 20 85 83     JSR Local_C28385
C2/FEF7: 28           PLP
C2/FEF8: 4C 7B E7     JMP Local_C2E77B
C2/FEFB: 08           PHP
...
C2/FF08: 20 89 EB     JSR Local_C2EB89
...
C2/FF21: 20 85 83     JSR Local_C28385
C2/FF24: 28           PLP
C2/FF25: 6B           RTL