...
C2/6FBB: 8C 20 43     STY DMAP2
C2/6FBE: A0 42 1E     LDY #$1E42
C2/6FC1: 8C 50 43     STY DMAP5
C2/6FC4: A0 42 8A     LDY #$8A42
C2/6FC7: 8C 22 43     STY A1T2L
C2/6FCA: 8C 52 43     STY A1T5L
C2/6FCD: A9 7E        LDA #$7E
C2/6FCF: 8D 24 43     STA A1B2
C2/6FD2: 8D 27 43     STA DASB2
C2/6FD5: 8D 54 43     STA A1B5
C2/6FD8: 8D 57 43     STA DASB5
C2/6FDB: A0 42 1C     LDY #$1C42
C2/6FDE: 8C 30 43     STY DMAP3
C2/6FE1: A0 42 1D     LDY #$1D42
C2/6FE4: 8C 40 43     STY DMAP4
C2/6FE7: A0 4F 8A     LDY #$8A4F
C2/6FEA: 8C 32 43     STY A1T3L
C2/6FED: 8C 42 43     STY A1T4L
C2/6FF0: A9 7E        LDA #$7E
C2/6FF2: 8D 34 43     STA A1B3
C2/6FF5: 8D 37 43     STA DASB3
C2/6FF8: 8D 44 43     STA A1B4
C2/6FFB: 8D 47 43     STA DASB4
...
C2/704F: 22 5A 22 C2  JSR Routine_C2225A
...
C2/7062: 22 5E 22 C2  JSR Routine_C2225E
...
C2/7079: D0 D2        BNE Local_C2704D
