...
C2/EDAD: 4C 7F EE     JMP Routine_C2EE7F
Local_C2EDB0:
C2/EDB0: 20 D3 ED     JSR Routine_C2EDD3
C2/EDB3: 4C F6 ED     JMP Routine_C2EDF6
C2/EDB6: 08           PHP
C2/EDB7: C2 30        REP #$30
C2/EDB9: 20 D3 ED     JSR Routine_C2EDD3
...
C2/EDCE: 20 7F EE     JSR Routine_C2EE7F
C2/EDD1: 28           PLP
C2/EDD2: 60           RTS