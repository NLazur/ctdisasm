...
C2/09D3: D0 03        BNE $09D8
C2/09D5: 4C 6A 0A     JMP $0A6A
C2/09D8: 3A           DEC
C2/09D9: 0A           ASL
C2/09DA: AA           TAX
...
C2/0A30: F0 06        BEQ $0A38
C2/0A32: 38           SEC
C2/0A33: E9 08 00     SBC #$0008
C2/0A36: 80 04        BRA $0A3C
C2/0A38: 38           SEC
...
C2/0A46: 20 6C 0A     JSR $0A6C
C2/0A49: 20 DC 0A     JSR $0ADC
C2/0A4C: A5 08        LDA $08
C2/0A4E: 1A           INC
C2/0A4F: C9 60 00     CMP #$0060
C2/0A52: 90 01        BCC $0A55
C2/0A54: 7B           TDC
