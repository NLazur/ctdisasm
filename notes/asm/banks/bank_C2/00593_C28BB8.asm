...
C2/8BC6: 10 08        BPL Local_C28BD0
...
C2/8BD3: 4A           LSR
C2/8BD4: 90 4E        BCC Local_C28C24
C2/8BD6: AD 9A 0D     LDA $0D9A
C2/8BD9: D0 55        BNE Local_C28C30
...
Local_C28C30:
C2/8C30: 20 1E 82     JSR Routine_C2821E
C2/8C33: 4C B8 8B     JMP Local_C28BB8