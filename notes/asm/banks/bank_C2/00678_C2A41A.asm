...
C2/A41D: 20 AF A4     JSR Local_C2A4AF
C2/A420: A2 EC BE     LDX #$BEEC
C2/A423: 20 31 ED     JSR Local_C2ED31
C2/A426: A2 FF FB     LDX #$FBFF
C2/A429: 20 85 83     JSR Local_C28385
...
C2/A44A: 20 F3 F2     JSR Local_C2F2F3
...
C2/A494: 20 81 EA     JSR Local_C2EA81
C2/A497: AD 94 0D     LDA $0D94
C2/A49A: 20 A6 8B     JSR Local_C28BA6
C2/A49D: 8D 94 0D     STA $0D94
C2/A4A0: 9C 95 0D     STZ $0D95
C2/A4A3: 20 93 8B     JSR Local_C28B93
C2/A4A6: 20 69 A5     JSR Local_C2A569
C2/A4A9: 28           PLP
C2/A4AA: 60           RTS