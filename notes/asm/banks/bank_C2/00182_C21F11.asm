...
C2/1F1E: F0 0C        BEQ Local_C21F2C
C2/1F20: B0 0B        BCS Local_C21F2D
C2/1F22: 49 FF        EOR #$FF
C2/1F24: 1A           INC
C2/1F25: 18           CLC
C2/1F26: 69 1F        ADC #$1F
C2/1F28: 09 80        ORA #$80
C2/1F2A: 80 01        BRA Local_C21F2D
C2/1F2C: 7B           TDC
...
C2/1F4B: F0 0C        BEQ Local_C21F59
C2/1F4D: B0 0B        BCS Local_C21F5A
C2/1F4F: 49 FF        EOR #$FF
C2/1F51: 1A           INC
C2/1F52: 18           CLC
C2/1F53: 69 1F        ADC #$1F
C2/1F55: 09 80        ORA #$80
C2/1F57: 80 01        BRA Local_C21F5A
C2/1F59: 7B           TDC
...
C2/1F70: F0 0C        BEQ Local_C21F7E
C2/1F72: B0 0B        BCS Local_C21F7F
C2/1F74: 49 FF        EOR #$FF
C2/1F76: 1A           INC
C2/1F77: 18           CLC
C2/1F78: 69 1F        ADC #$1F
C2/1F7A: 09 80        ORA #$80
C2/1F7C: 80 01        BRA Local_C21F7F
C2/1F7E: 7B           TDC
