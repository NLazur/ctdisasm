...
C2/EFDB: F0 22        BEQ $EFFF
C2/EFDD: F0 36        BEQ $F015
C2/EFDF: F0 A2        BEQ $EF83
C2/EFE1: F0 71        BEQ $F054
C2/EFE3: F0 8D        BEQ $EF72
C2/EFE5: F0 B8        BEQ $EF9F
C2/EFE7: F0 68        BEQ $F051
C2/EFE9: F0 C1        BEQ $EFAC
C2/EFEB: F0 D1        BEQ $EFBE
C2/EFED: F0 D3        BEQ $EFC2
