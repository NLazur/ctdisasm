...
C2/4DD7: 20 A6 4E     JSR $4EA6
C2/4DDA: AD F8 00     LDA $00F8
C2/4DDD: F0 3C        BEQ $4E1B
C2/4DDF: 89 80 00     BIT #$0080
C2/4DE2: D0 3C        BNE $4E20
C2/4DE4: C2 20        REP #$20
C2/4DE6: A6 4E        LDX $4E
C2/4DE8: AD F8 00     LDA $00F8
C2/4DEB: 89 40 00     BIT #$0040
C2/4DEE: F0 03        BEQ $4DF3
C2/4DF0: 4C BE 4E     JMP $4EBE
C2/4DF3: 89 04 00     BIT #$0004
C2/4DF6: F0 03        BEQ $4DFB
C2/4DF8: 4C C8 4E     JMP $4EC8
C2/4DFB: 89 00 08     BIT #$0800
C2/4DFE: F0 03        BEQ $4E03
C2/4E00: 4C D2 4E     JMP $4ED2
C2/4E03: 89 00 04     BIT #$0400
C2/4E06: F0 03        BEQ $4E0B
C2/4E08: 4C D5 4E     JMP $4ED5
C2/4E0B: 89 00 02     BIT #$0200
C2/4E0E: F0 03        BEQ $4E13
C2/4E10: 4C DA 4E     JMP $4EDA
C2/4E13: 89 00 01     BIT #$0100
C2/4E16: F0 03        BEQ $4E1B
C2/4E18: 4C DF 4E     JMP $4EDF
C2/4E1B: 20 1D 0E     JSR $0E1D
C2/4E1E: 18           CLC
C2/4E1F: 60           RTS