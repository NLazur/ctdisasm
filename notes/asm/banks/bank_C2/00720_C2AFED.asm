...
C2/AFFB: 20 20 88     JSR Routine_C28820
C2/AFFE: 05 51        ORA $51
C2/B000: D0 3B        BNE Local_C2B03D
C2/B002: 20 EF A1     JSR Routine_C2A1EF
C2/B005: A2 0E BE     LDX #$BE0E
C2/B008: 20 31 ED     JSR Routine_C2ED31
C2/B00B: AD 90 9A     LDA $9A90
C2/B00E: 20 26 F6     JSR Routine_C2F626
...
C2/B02E: F0 02        BEQ Local_C2B032
...
C2/B03B: 90 BC        BCC Local_C2AFF9
Local_C2B03D:
C2/B03D: A2 EA FB     LDX #$FBEA
C2/B040: 20 85 83     JSR Routine_C28385
C2/B043: 28           PLP
C2/B044: 60           RTS