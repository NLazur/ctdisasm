...
C2/CA21: 20 A7 F5     JSR $F5A7
C2/CA24: A0 00 95     LDY #$9500
C2/CA27: 20 E7 A0     JSR $A0E7
C2/CA2A: 20 2B CD     JSR $CD2B
C2/CA2D: 20 1E 82     JSR $821E
C2/CA30: 20 DB CC     JSR $CCDB
C2/CA33: 20 1E 82     JSR $821E
C2/CA36: A9 02 00     LDA #$0002
C2/CA39: 8D 75 0D     STA $0D75
C2/CA3C: 20 43 F6     JSR $F643
C2/CA3F: 20 4F CC     JSR $CC4F
C2/CA42: 20 DD 86     JSR $86DD
C2/CA45: E2 20        SEP #$20
C2/CA47: EE 15 0D     INC $0D15
C2/CA4A: A9 01        LDA #$01
C2/CA4C: 8D 13 0D     STA $0D13
C2/CA4F: A2 E3 FB     LDX #$FBE3
C2/CA52: 20 85 83     JSR $8385
C2/CA55: A2 FF FB     LDX #$FBFF
C2/CA58: 20 85 83     JSR $8385
C2/CA5B: A2 37 FC     LDX #$FC37
C2/CA5E: 20 85 83     JSR $8385
C2/CA61: 28           PLP
C2/CA62: 60           RTS