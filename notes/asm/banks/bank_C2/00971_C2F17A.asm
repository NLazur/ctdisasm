...
C2/F1A3: 10 00        BPL Local_C2F1A5
Local_C2F1A5:
C2/F1A5: 00 48        BRK $48
C2/F1A7: 20 00 00     JSR Routine_C20000
...
C2/F1BF: 10 13        BPL Routine_C2F1D4
...
C2/F1E8: 4A           LSR
C2/F1E9: AA           TAX
C2/F1EA: 90 09        BCC Local_C2F1F5
Local_C2F1EC:
...
C2/F1F0: 4A           LSR
C2/F1F1: 4A           LSR
C2/F1F2: 20 0B F2     JSR Routine_C2F20B
Local_C2F1F5:
C2/F1F5: E0 00 00     CPX #$0000
C2/F1F8: D0 08        BNE Local_C2F202
C2/F1FA: A5 8F        LDA $8F
C2/F1FC: 29 08        AND #$08
C2/F1FE: D0 02        BNE Local_C2F202
C2/F200: 64 8F        STZ $8F
Local_C2F202:
C2/F202: B5 8A        LDA $8A,X
C2/F204: 20 0B F2     JSR Routine_C2F20B
C2/F207: CA           DEX
C2/F208: 10 E2        BPL Local_C2F1EC
C2/F20A: 60           RTS