...
FE/C79B: 08           PHP
FE/C79C: 20 C4 5A     JSR $5AC4
FE/C79F: 57 10        EOR [$10],Y
FE/C7A1: 20 52 56     JSR $5652
FE/C7A4: 11 7F        ORA ($7F),Y
FE/C7A6: 03 20        ORA $20,S
FE/C7A8: 10 0E        BPL $C7B8
...
FE/C820: 22 00 7B 15  JSR $157B00
FE/C824: DB           STP
