...
FE/C79B: 08           PHP
FE/C79C: 20 C4 5A     JSR Local_FE5AC4
FE/C79F: 57 10        EOR [$10],Y
FE/C7A1: 20 52 56     JSR Local_FE5652
FE/C7A4: 11 7F        ORA ($7F),Y
FE/C7A6: 03 20        ORA $20,S
FE/C7A8: 10 0E        BPL Local_FEC7B8
...
FE/C7D7: 4C 00 84     JMP Local_FE8400
...
FE/C7EB: 20 CF 20     JSR Local_FE20CF
...
FE/C80F: 10 D8        BPL Local_FEC7E9
...
FE/C84F: 80 55        BRA Local_FEC8A6
