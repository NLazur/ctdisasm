...
FE/F38C: F0 90        BEQ $F31E
FE/F38E: 67 00        ADC [$00]
FE/F390: 50 EF        BVC $F381
FE/F392: 00 91        BRK $91
FE/F394: 90 30        BCC $F3C6
FE/F396: 00 A4        BRK $A4
FE/F398: 90 A0        BCC $F33A
FE/F39A: B0 58        BCS $F3F4
FE/F39C: E0 E6 A0     CPX #$A0E6
FE/F39F: 28           PLP
FE/F3A0: 01 0C        ORA ($0C,X)
FE/F3A2: 07 F6        ORA [$F6]
FE/F3A4: B0 03        BCS $F3A9
...
FE/F3CE: 80 00        BRA $F3D0
FE/F3D0: 28           PLP
FE/F3D1: 80 C8        BRA $F39B
FE/F3D3: 00 28        BRK $28
FE/F3D5: C0 28 C0     CPY #$C028
FE/F3D8: 00 78        BRK $78
FE/F3DA: 00 40        BRK $40
FE/F3DC: 30 F0        BMI $F3CE
FE/F3DE: 70 70        BVS $F450
FE/F3E0: F0 1C        BEQ $F3FE
FE/F3E2: 70 F0        BVS $F3D4
...
FE/F404: 5C 3F 4C 02  JMP $024C3F
