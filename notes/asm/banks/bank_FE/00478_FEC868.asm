...
Routine_FEC868:
FE/C868: 10 10        BPL Routine_FEC87A
...
FE/C8A2: 10 18        BPL Routine_FEC8BC
FE/C8A4: 07 20        ORA [$20]
FE/C8A6: 0A           ASL
FE/C8A7: 08           PHP
FE/C8A8: FF C4 09 07  SBC $0709C4,X
FE/C8AC: 10 91        BPL Routine_FEC83F
...
FE/C8D6: 10 20        BPL Routine_FEC8F8
FE/C8D8: FF 09 64 68  SBC $686409,X
FE/C8DC: 20 39 44     JSR Routine_FE4439
FE/C8DF: 48           PHA
FE/C8E0: 64 4A        STZ $4A
FE/C8E2: 84 40        STY $40
FE/C8E4: 30 3F        BMI Routine_FEC925
...
FE/C8F5: 10 FF        BPL Routine_FEC8F6
