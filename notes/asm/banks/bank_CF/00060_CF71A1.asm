...
CF/73AF: 4C 7F FF     JMP $FF7F
CF/73B2: FF FF AE FF  SBC $FFAEFF,X
CF/73B6: 45 FF        EOR $FF
CF/73B8: 22 FF 31 FF  JSR $FF31FF
CF/73BC: 3B           TSC
...
CF/7461: 22 3E 21 0F  JSR $0F213E
CF/7465: 10 16        BPL $747D
...
CF/74E9: B0 BF        BCS $74AA
CF/74EB: 4C 7F 82     JMP $827F
