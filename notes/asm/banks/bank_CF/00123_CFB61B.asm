...
CF/B627: 20 7A 2B     JSR Local_CF2B7A
CF/B62A: 1C 20 7C     TRB $7C20
CF/B62D: 2B           PLD
CF/B62E: 7E 2B 1C     ROR $1C2B,X
CF/B631: 20 1C 20     JSR Local_CF201C
CF/B634: 80 2B        BRA Local_CFB661
CF/B636: 1C 20 82     TRB $8220
CF/B639: 2B           PLD
CF/B63A: 84 2B        STY $2B
CF/B63C: 1C 20 1C     TRB $1C20
CF/B63F: 20 A9 29     JSR Local_CF29A9
...
CF/B695: 2B           PLD
CF/B696: B0 2B        BCS Local_CFB6C3
...
CF/B6BD: 20 C0 2B     JSR Local_CF2BC0
...
CF/B6CD: 2B           PLD
CF/B6CE: D0 2B        BNE Local_CFB6FB
...
CF/B6F5: 2B           PLD
CF/B6F6: F0 2B        BEQ Local_CFB723
...
CF/B73E: 20 6C 1C     JSR Local_CF1C6C
CF/B741: 20 1C 20     JSR Local_CF201C
CF/B744: BB           TYX
...
CF/B775: 20 1C 20     JSR Local_CF201C
CF/B778: 33 A4        AND ($A4,S),Y
CF/B77A: 35 A4        AND $A4,X
CF/B77C: 37 A4        AND [$A4],Y
CF/B77E: 39 A4 22     AND $22A4,Y
CF/B781: 2C 24 2C     BIT Local_CF2C24
CF/B784: 26 2C        ROL $2C
CF/B786: 28           PLP
CF/B787: 2C 2A 2C     BIT Local_CF2C2A
CF/B78A: 2C 2C 2E     BIT Local_CF2E2C
CF/B78D: 2C 30 2C     BIT Local_CF2C30
CF/B790: 32 2C        AND ($2C)
CF/B792: 34 2C        BIT $2C,X
CF/B794: 36 2C        ROL $2C,X
CF/B796: 38           SEC
CF/B797: 2C 3A 2C     BIT Local_CF2C3A
CF/B79A: 3C 2C 3E     BIT Local_CF3E2C,X
CF/B79D: 2C 40 2C     BIT Local_CF2C40
CF/B7A0: 42 2C        WDM $2C
CF/B7A2: 44 2C 46     MVP $2C,$46
CF/B7A5: 2C 48 2C     BIT Local_CF2C48
CF/B7A8: 4A           LSR
CF/B7A9: 2C 4C 2C     BIT Local_CF2C4C
CF/B7AC: 4E 2C 50     LSR $502C
CF/B7AF: 2C 52 2C     BIT Local_CF2C52
CF/B7B2: 54 2C 56     MVN $2C,$56
CF/B7B5: 2C 58 2C     BIT Local_CF2C58
CF/B7B8: 5A           PHY
CF/B7B9: 2C 5C 2C     BIT Local_CF2C5C
CF/B7BC: 5E 2C 60     LSR $602C,X
CF/B7BF: 2C 1C 20     BIT Local_CF201C
...
CF/B7D7: 20 3B 24     JSR Local_CF243B
CF/B7DA: 3D 24 3F     AND $3F24,X
CF/B7DD: 24 1C        BIT $1C
CF/B7DF: 20 1C 20     JSR Local_CF201C
...
CF/B7F7: 20 3B A4     JSR Local_CFA43B
CF/B7FA: 3D A4 3F     AND $3FA4,X
CF/B7FD: A4 1C        LDY $1C
CF/B7FF: 20 62 2C     JSR Local_CF2C62
CF/B802: 64 2C        STZ $2C
CF/B804: 1C 20 1C     TRB $1C20
CF/B807: 20 1C 20     JSR Local_CF201C
CF/B80A: 66 2C        ROR $2C
CF/B80C: 1C 20 1C     TRB $1C20
CF/B80F: 20 68 2C     JSR Local_CF2C68
CF/B812: 6A           ROR
CF/B813: 2C 1C 20     BIT Local_CF201C
CF/B816: 6C 2C 6E     JMP ($6E2C)
CF/B819: 2C 70 2C     BIT Local_CF2C70
CF/B81C: 1C 20 1C     TRB $1C20
CF/B81F: 20 72 2C     JSR Local_CF2C72
CF/B822: 74 2C        STZ $2C,X
CF/B824: 76 2C        ROR $2C,X
CF/B826: 1C 20 78     TRB $7820
CF/B829: 2C 7A 2C     BIT Local_CF2C7A
CF/B82C: 7C 2C 1C     JMP ($1C2C,X)
CF/B82F: 20 1C 20     JSR Local_CF201C
CF/B832: 1C 20 7E     TRB $7E20
CF/B835: 2C 80 2C     BIT Local_CF2C80
CF/B838: 02 20        COP $20
CF/B83A: 1C 20 1C     TRB $1C20
CF/B83D: 20 1C 20     JSR Local_CF201C
CF/B840: 1C 20 82     TRB $8220
CF/B843: 2C 84 2C     BIT Local_CF2C84
CF/B846: 86 2C        STX $2C
CF/B848: 88           DEY
CF/B849: 2C 8A 2C     BIT Local_CF2C8A
CF/B84C: 8C 2C 8E     STY $8E2C
CF/B84F: 2C 90 2C     BIT Local_CF2C90
CF/B852: 92 2C        STA ($2C)
CF/B854: D7 A7        CMP [$A7],Y
CF/B856: 94 2C        STY $2C,X
CF/B858: 96 2C        STX $2C,Y
CF/B85A: 98           TYA
CF/B85B: 2C 9A 2C     BIT Local_CF2C9A
CF/B85E: 1C 20 1C     TRB $1C20
CF/B861: 20 1C 20     JSR Local_CF201C
CF/B864: 1C 20 1C     TRB $1C20
CF/B867: 20 1C 20     JSR Local_CF201C
CF/B86A: 1C 20 1C     TRB $1C20
CF/B86D: 20 1C 20     JSR Local_CF201C
CF/B870: 1C 20 1C     TRB $1C20
CF/B873: 20 1C 20     JSR Local_CF201C
CF/B876: 1C 20 9C     TRB $9C20
CF/B879: 2C 9E 2C     BIT Local_CF2C9E
CF/B87C: A0 2C        LDY #$2C
CF/B87E: A2 2C        LDX #$2C
CF/B880: 1C 20 A4     TRB $A420
CF/B883: 2C A6 2C     BIT Local_CF2CA6
CF/B886: A8           TAY
CF/B887: 2C AA 2C     BIT Local_CF2CAA
CF/B88A: 1C 20 1C     TRB $1C20
CF/B88D: 20 AC 2C     JSR Local_CF2CAC
CF/B890: AE 2C B0     LDX $B02C
CF/B893: 2C 02 60     BIT Local_CF6002
...
CF/B8A0: BB           TYX
CF/B8A1: 2C BD 2C     BIT Local_CF2CBD
CF/B8A4: BF 2C 1C 20  LDA $201C2C,X
CF/B8A8: 1C 20 1C     TRB $1C20
CF/B8AB: 20 C1 2C     JSR Local_CF2CC1
CF/B8AE: C3 2C        CMP $2C,S
CF/B8B0: C5 2C        CMP $2C
CF/B8B2: 1C 20 C7     TRB $C720
CF/B8B5: 2C C9 2C     BIT Local_CF2CC9
CF/B8B8: CB           WAI
CF/B8B9: 2C CD 2C     BIT Local_CF2CCD
...
CF/B91D: 2C 1C 20     BIT Local_CF201C
CF/B920: FD 2C FF     SBC $FF2C,X
CF/B923: 2C 01 2D     BIT Local_CF2D01
CF/B926: 1C 20 1C     TRB $1C20
CF/B929: 20 1C 20     JSR Local_CF201C
CF/B92C: 03 2D        ORA $2D,S
CF/B92E: 05 2D        ORA $2D
CF/B930: BD 21 1C     LDA $1C21,X
CF/B933: 20 1C 20     JSR Local_CF201C
...
CF/B94F: 20 D7 21     JSR Local_CF21D7
...
CF/B963: 20 1B 2D     JSR Local_CF2D1B
...
CF/B981: 2C 86 2C     BIT Local_CF2C86
CF/B984: 8C 2C 8E     STY $8E2C
CF/B987: 2C 90 2C     BIT Local_CF2C90
CF/B98A: 92 2C        STA ($2C)
CF/B98C: 68           PLA
CF/B98D: 2C 6A 2C     BIT Local_CF2C6A
...
CF/B9A3: 20 1C 20     JSR Local_CF201C
CF/B9A6: 1C 20 1C     TRB $1C20
CF/B9A9: 20 1C 20     JSR Local_CF201C
CF/B9AC: 1C 20 1C     TRB $1C20
CF/B9AF: 20 1C 20     JSR Local_CF201C
...
CF/BB49: 20 21 2E     JSR Local_CF2E21
...
CF/BB6F: 20 37 2E     JSR Local_CF2E37
CF/BB72: 1C 20 39     TRB $3920
CF/BB75: 2E 3B 2E     ROL $2E3B
CF/BB78: 1C 20 1C     TRB $1C20
CF/BB7B: 20 1C 20     JSR Local_CF201C
CF/BB7E: 1C 20 19     TRB $1920
CF/BB81: 22 1B 22 1D  JSR Routine_1D221B
CF/BB85: 22 1F 22 21  JSR Routine_21221F
CF/BB89: 22 23 22 25  JSR Routine_252223
CF/BB8D: 22 27 22 29  JSR Routine_292227
CF/BB91: 22 1C 20 2B  JSR Routine_2B201C
CF/BB95: 22 2D 22 2F  JSR Routine_2F222D
CF/BB99: 22 1C 20 A5  JSR Routine_A5201C
CF/BB9D: 02 A8        COP $A8
CF/BB9F: 02 35        COP $35
CF/BBA1: 22 02 A0 37  JSR Routine_37A002
CF/BBA5: 22 39 22 3B  JSR Routine_3B2239
CF/BBA9: 22 3D 22 3F  JSR Routine_3F223D
CF/BBAD: 22 41 22 1C  JSR Routine_1C2241
CF/BBB1: 20 1C 20     JSR Local_CF201C
CF/BBB4: 43 22        EOR $22,S
CF/BBB6: 45 22        EOR $22
CF/BBB8: 1C 20 1C     TRB $1C20
CF/BBBB: 20 C1 02     JSR Local_CF02C1
...
CF/BBC9: 20 F7 03     JSR Local_CF03F7
CF/BBCC: FA           PLX
...
CF/BBDF: 20 C7 02     JSR Local_CF02C7
CF/BBE2: CA           DEX
CF/BBE3: 02 CD        COP $CD
CF/BBE5: 02 D0        COP $D0
CF/BBE7: 02 1C        COP $1C
CF/BBE9: 20 15 04     JSR Local_CF0415
CF/BBEC: 18           CLC
...
CF/BBFF: 20 3C 2A     JSR Local_CF2A3C
...
CF/BC0E: 4A           LSR
CF/BC0F: 2A           ROL
CF/BC10: 4C 2A 4E     JMP Local_CF4E2A
CF/BC13: 2A           ROL
CF/BC14: 50 2A        BVC Local_CFBC40
CF/BC16: 52 2A        EOR ($2A)
CF/BC18: 1C 20 1C     TRB $1C20
CF/BC1B: 20 1C 20     JSR Local_CF201C
...
CF/BC26: 5A           PHY
CF/BC27: 2A           ROL
CF/BC28: 5C 2A 5E 2A  JMP Routine_2A5E2A
CF/BC2C: 60           RTS