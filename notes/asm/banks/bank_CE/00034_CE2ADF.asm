...
CE/2B3F: 7A           PLY
CE/2B40: 4C 0C 2D     JMP $2D0C
CE/2B43: 80 12        BRA $2B57
...
CE/2B4B: 0A           ASL
CE/2B4C: 7A           PLY
CE/2B4D: 4C 0C 2D     JMP $2D0C
CE/2B50: 80 12        BRA $2B64
CE/2B52: B0 20        BCS $2B74
...
CE/2B6E: 20 0F D8     JSR $D80F
CE/2B71: 04 03        TSB $03
CE/2B73: 1E 1E 0B     ASL $0B1E,X
CE/2B76: 20 14 24     JSR $2414
