...
Routine_CE7A3A:
CE/7A3A: 30 01        BMI Local_CE7A3D
CE/7A3C: 80 02        BRA Local_CE7A40
...
CE/7A52: 80 0C        BRA Local_CE7A60
CE/7A54: 2B           PLD
CE/7A55: 1B           TCS
...
CE/7A62: 30 02        BMI Local_CE7A66
CE/7A64: A0 30 03     LDY #$0330
CE/7A67: 80 02        BRA Local_CE7A6B
...
CE/7A79: 18           CLC
CE/7A7A: 20 00 0C     JSR Local_CE0C00
CE/7A7D: 2B           PLD
CE/7A7E: 1B           TCS
CE/7A7F: 1A           INC
...
CE/7AA5: 18           CLC
CE/7AA6: 88           DEY
CE/7AA7: 80 01        BRA Local_CE7AAA
...
CE/7ADE: 50 35        BVC Local_CE7B15
...
CE/7AF6: 80 12        BRA Local_CE7B0A
CE/7AF8: A0 20 08     LDY #$0820
CE/7AFB: 2D 80 02     AND $0280
CE/7AFE: 70 20        BVS Local_CE7B20
CE/7B00: 40           RTI