...
CE/EC92: F0 4A        BEQ $ECDE
CE/EC94: A5 4F        LDA $4F
CE/EC96: F0 26        BEQ $ECBE
CE/EC98: C9 FF        CMP #$FF
CE/EC9A: D0 37        BNE $ECD3
...
CE/ECBA: D0 EE        BNE $ECAA
CE/ECBC: 80 20        BRA $ECDE
...
CE/ECCC: D0 F5        BNE $ECC3
CE/ECCE: 7B           TDC
CE/ECCF: E2 20        SEP #$20
CE/ECD1: 80 0B        BRA $ECDE
...
CE/ECF0: D0 02        BNE $ECF4
CE/ECF2: 80 40        BRA $ED34
CE/ECF4: A5 4F        LDA $4F
CE/ECF6: AA           TAX
CE/ECF7: AD 9F CA     LDA $CA9F
CE/ECFA: 30 1D        BMI $ED19
CE/ECFC: A5 45        LDA $45
CE/ECFE: C5 49        CMP $49
CE/ED00: 90 05        BCC $ED07
CE/ED02: E5 49        SBC $49
CE/ED04: E8           INX
CE/ED05: 80 F7        BRA $ECFE
...
CE/ED15: D0 E5        BNE $ECFC
CE/ED17: 80 1B        BRA $ED34
CE/ED19: A5 45        LDA $45
CE/ED1B: C5 49        CMP $49
CE/ED1D: 90 05        BCC $ED24
CE/ED1F: E5 49        SBC $49
CE/ED21: CA           DEX
CE/ED22: 80 F7        BRA $ED1B
...
CE/ED32: D0 E5        BNE $ED19
CE/ED34: 68           PLA
CE/ED35: 29 02        AND #$02
CE/ED37: F0 03        BEQ $ED3C
CE/ED39: 4C D5 ED     JMP $EDD5
CE/ED3C: AD A3 CA     LDA $CAA3
CE/ED3F: 30 79        BMI $EDBA
CE/ED41: D0 17        BNE $ED5A
CE/ED43: 7B           TDC
CE/ED44: A8           TAY
