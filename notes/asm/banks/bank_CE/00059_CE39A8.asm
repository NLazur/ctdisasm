...
CE/39BB: 20 04 7A     JSR Local_CE7A04
...
CE/39F7: 20 04 70     JSR Local_CE7004
...
CE/3A22: 20 08 70     JSR Local_CE7008
...
CE/3A3E: 20 12 02     JSR Local_CE0212
...
CE/3A4C: 20 0C 70     JSR Local_CE700C
CE/3A4F: 98           TYA
...
CE/3A5C: 80 05        BRA Local_CE3A63
...
CE/3A6B: 20 10 70     JSR Local_CE7010
...
CE/3A96: 80 C0        BRA Local_CE3A58
...
CE/3AB1: D0 98        BNE Local_CE3A4B
...
CE/3AD8: D0 98        BNE Local_CE3A72
...
CE/3AE6: 20 05 72     JSR Local_CE7205
...
CE/3B10: 20 03 C4     JSR Local_CEC403
CE/3B13: F6 FF        INC $FF,X
CE/3B15: 20 05 C5     JSR Local_CEC505
...
CE/3B2D: 3B           TSC
CE/3B2E: 20 1E 1E     JSR Local_CE1E1E
CE/3B31: 0B           PHD
...
CE/3B6B: 20 0A 02     JSR Local_CE020A
...
CE/3B81: 20 0A 06     JSR Local_CE060A
...
CE/3B94: 20 80 30     JSR Local_CE3080
...
CE/3BB4: 20 14 6C     JSR Local_CE6C14
CE/3BB7: 00 04        BRK $04
CE/3BB9: 24 02        BIT $02
CE/3BBB: 20 02 1E     JSR Local_CE1E02
...
CE/3BCA: 20 02 1E     JSR Local_CE1E02
...
CE/3C2D: EB           XBA
CE/3C2E: 20 02 78     JSR Local_CE7802
...
CE/3C59: 1B           TCS
CE/3C5A: 2C D1 36     BIT Local_CE36D1
...
CE/3C7E: 0A           ASL
CE/3C7F: 50 36        BVC Local_CE3CB7
...
CE/3C9F: 3C E7 3C     BIT Local_CE3CE7,X
CE/3CA2: 08           PHP
...
CE/3CB8: 80 02        BRA Local_CE3CBC
...
CE/3D52: 30 99        BMI Local_CE3CED
...
CE/3D76: 30 1F        BMI Local_CE3D97
CE/3D78: 18           CLC
...
CE/3D86: 2C 20 01     BIT Local_CE0120
CE/3D89: 36 0A        ROL $0A,X
CE/3D8B: 1B           TCS
CE/3D8C: 09 02 01     ORA #$0102
CE/3D8F: 70 20        BVS Local_CE3DB1
CE/3D91: 0A           ASL
...
CE/3E16: 20 14 0D     JSR Local_CE0D14
CE/3E19: 33 03        AND ($03,S),Y
CE/3E1B: 30 1F        BMI Local_CE3E3C
CE/3E1D: 08           PHP
CE/3E1E: 23 02        AND $02,S
CE/3E20: 20 0A 1A     JSR Local_CE1A0A
CE/3E23: 27 06        AND [$06]
CE/3E25: 3B           TSC
CE/3E26: 2A           ROL
CE/3E27: 12 0C        ORA ($0C)
CE/3E29: DA           PHX
CE/3E2A: 20 14 06     JSR Local_CE0614
CE/3E2D: 3C 35 7B     BIT Local_CE7B35,X
...
CE/3E52: 3B           TSC
CE/3E53: 20 0A 1E     JSR Local_CE1E0A
CE/3E56: 2A           ROL
...
CE/3E69: 20 14 34     JSR Local_CE3414
CE/3E6C: 1B           TCS
CE/3E6D: 78           SEI
...
CE/3E83: 20 0A 22     JSR Local_CE220A
CE/3E86: 1B           TCS
