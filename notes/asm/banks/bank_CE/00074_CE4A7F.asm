...
CE/4A8B: 0A           ASL
CE/4A8C: 70 7B        BVS Local_CE4B09
...
CE/4AC2: 0A           ASL
CE/4AC3: 20 04 70     JSR Local_CE7004
CE/4AC6: 98           TYA
...
CE/4AF1: 0A           ASL
CE/4AF2: 20 08 70     JSR Local_CE7008
CE/4AF5: 98           TYA
...
CE/4B42: 70 7A        BVS Local_CE4BBE
CE/4B44: 9F 00 98 00  STA $009800,X
CE/4B48: 14 2D        TRB $2D
CE/4B4A: 80 02        BRA Local_CE4B4E
...
CE/4B71: 20 16 1E     JSR Local_CE1E16
CE/4B74: 2C 1B 09     BIT Local_CE091B
CE/4B77: 24 03        BIT $03
CE/4B79: 0A           ASL
CE/4B7A: 02 02        COP $02
CE/4B7C: 20 04 70     JSR Local_CE7004
CE/4B7F: 98           TYA
...
CE/4B8C: 70 9C        BVS Local_CE4B2A
...
CE/4B9F: 20 16 1E     JSR Local_CE1E16
CE/4BA2: 2C 1B 09     BIT Local_CE091B
CE/4BA5: 24 03        BIT $03
CE/4BA7: 0A           ASL
CE/4BA8: 02 02        COP $02
CE/4BAA: 20 08 70     JSR Local_CE7008
CE/4BAD: 98           TYA
...
CE/4BBF: 20 16 1E     JSR Local_CE1E16
CE/4BC2: 2C 00 D0     BIT Local_CED000
CE/4BC5: FF C0 00 E2  SBC $E200C0,X
CE/4BC9: 4B           PHK
CE/4BCA: 22 4C 2D 4C  JSR Routine_4C2D4C
CE/4BCE: 3C 4C 61     BIT Local_CE614C,X
CE/4BD1: 4C 7B 4C     JMP Local_CE4C7B
CE/4BD4: 95 4C        STA $4C,X
CE/4BD6: D1 4C        CMP ($4C),Y
CE/4BD8: 04 4D        TSB $4D
CE/4BDA: 2C 4D 3B     BIT Local_CE3B4D
...
CE/4C16: 20 2D 80     JSR Local_CE802D
CE/4C19: 12 74        ORA ($74)
CE/4C1B: 20 0A 24     JSR Local_CE240A
