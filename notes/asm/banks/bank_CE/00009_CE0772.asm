...
CE/07C4: 20 04 2D     JSR Routine_CE2D04
CE/07C7: 80 12        BRA Routine_CE07DB
CE/07C9: A0 03        LDY #$03
CE/07CB: 00 35        BRK $35
CE/07CD: 20 05 2D     JSR Routine_CE2D05
CE/07D0: 80 12        BRA Routine_CE07E4
CE/07D2: A8           TAY
