...
Routine_CE30A3:
CE/30A3: 98           TYA
CE/30A4: F0 80        BEQ Local_CE3026
CE/30A6: 00 B7        BRK $B7
CE/30A8: 30 15        BMI Local_CE30BF
...
CE/30C6: 20 3C 78     JSR Local_CE783C
CE/30C9: 85 20        STA $20
CE/30CB: 30 78        BMI Local_CE3145
...
CE/30EF: 20 1E 06     JSR Local_CE061E
