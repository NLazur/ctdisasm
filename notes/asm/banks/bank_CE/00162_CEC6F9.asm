...
CE/C825: D8           CLD
CE/C826: F0 05        BEQ Local_CEC82D
CE/C828: 08           PHP
CE/C829: D8           CLD
CE/C82A: F0 05        BEQ Local_CEC831
CE/C82C: 09 D8        ORA #$D8
CE/C82E: F0 05        BEQ Local_CEC835
...
CE/C845: D0 E0        BNE Local_CEC827
CE/C847: 05 49        ORA $49
CE/C849: D0 E0        BNE Local_CEC82B
...
CE/C870: 10 E4        BPL Local_CEC856
...
CE/C902: F0 03        BEQ Local_CEC907
CE/C904: 06 E8        ASL $E8
CE/C906: F0 03        BEQ Local_CEC90B
CE/C908: 09 E8        ORA #$E8
CE/C90A: F0 03        BEQ Local_CEC90F
CE/C90C: 08           PHP
CE/C90D: E8           INX
CE/C90E: F0 03        BEQ Local_CEC913
CE/C910: 0A           ASL
CE/C911: E8           INX
CE/C912: F0 03        BEQ Local_CEC917
CE/C914: 2A           ROL
CE/C915: E8           INX
CE/C916: F0 00        BEQ Local_CEC918
CE/C918: 00 F8        BRK $F8
CE/C91A: D0 01        BNE Local_CEC91D
...
CE/C979: F0 F8        BEQ Local_CEC973
...
CE/C9A1: F0 F8        BEQ Local_CEC99B
...
CE/CA0A: F8           SED
CE/CA0B: 8A           TXA
CE/CA0C: 20 F8 F8     JSR Local_CEF8F8
...
CE/CA86: F8           SED
CE/CA87: 8A           TXA
CE/CA88: 20 F8 F8     JSR Local_CEF8F8
...
CE/CB35: D8           CLD
CE/CB36: F0 06        BEQ Local_CECB3E
CE/CB38: 20 D8 F0     JSR Local_CEF0D8
CE/CB3B: 06 01        ASL $01
CE/CB3D: F0 F8        BEQ Local_CECB37
...
CE/CB85: D8           CLD
CE/CB86: F0 03        BEQ Local_CECB8B
...
CE/CBE0: 20 00 CC     JSR Local_CECC00
...
CE/CBEE: 20 06 00     JSR Local_CE0006
CE/CBF1: 18           CLC
CE/CBF2: 18           CLC
CE/CBF3: 06 00        ASL $00
CE/CBF5: 20 00 06     JSR Local_CE0600
...
CE/CC28: 20 E8 00     JSR Local_CE00E8
CE/CC2B: 06 00        ASL $00
CE/CC2D: E1 CB        SBC ($CB,X)
CE/CC2F: 10 40        BPL Local_CECC71
CE/CC31: E1 CB        SBC ($CB,X)
CE/CC33: 00 01        BRK $01
CE/CC35: DB           STP
CE/CC36: C8           INY
CE/CC37: 10 41        BPL Local_CECC7A
CE/CC39: DB           STP
CE/CC3A: C8           INY
