...
CE/1BF5: 20 14 03     JSR $0314
CE/1BF8: 00 12        BRK $12
CE/1BFA: 18           CLC
CE/1BFB: 71 77        ADC ($77),Y
CE/1BFD: 10 1E        BPL $1C1D
...
CE/1CB3: 90 FF        BCC $1CB4
CE/1CB5: 90 80        BCC $1C37
CE/1CB7: D1 1C        CMP ($1C),Y
CE/1CB9: F5 1C        SBC $1C,X
CE/1CBB: 00 1D        BRK $1D
CE/1CBD: 30 1D        BMI $1CDC
CE/1CBF: 4C 1D 68     JMP $681D
