...
CE/1B34: 10 1E        BPL Routine_CE1B54
...
CE/1B5C: 20 05 02     JSR Routine_CE0205
CE/1B5F: 00 70        BRK $70
CE/1B61: 12 18        ORA ($18)
CE/1B63: 71 77        ADC ($77),Y
CE/1B65: 10 1E        BPL Routine_CE1B85
...
CE/1B8F: 20 0A 02     JSR Routine_CE020A
CE/1B92: 00 70        BRK $70
CE/1B94: 12 18        ORA ($18)
CE/1B96: 71 77        ADC ($77),Y
CE/1B98: 10 1E        BPL Routine_CE1BB8
...
CE/1BC2: 20 0F 02     JSR Routine_CE020F
CE/1BC5: 00 70        BRK $70
CE/1BC7: 12 18        ORA ($18)
CE/1BC9: 71 77        ADC ($77),Y
CE/1BCB: 10 1E        BPL Routine_CE1BEB
...
CE/1BF5: 20 14 03     JSR Routine_CE0314
CE/1BF8: 00 12        BRK $12
CE/1BFA: 18           CLC
CE/1BFB: 71 77        ADC ($77),Y
CE/1BFD: 10 1E        BPL Routine_CE1C1D
...
CE/1C27: 20 19 02     JSR Routine_CE0219
CE/1C2A: 00 70        BRK $70
CE/1C2C: 12 18        ORA ($18)
CE/1C2E: 71 77        ADC ($77),Y
CE/1C30: 10 1E        BPL Routine_CE1C50
...
CE/1C5A: 20 1E 02     JSR Routine_CE021E
...
CE/1C8E: 20 23 02     JSR Routine_CE0223
...
CE/1CA6: 20 01 78     JSR Routine_CE7801
...
CE/1CB3: 90 FF        BCC Routine_CE1CB4
CE/1CB5: 90 80        BCC Routine_CE1C37
Local_CE1CB7:
CE/1CB7: D1 1C        CMP ($1C),Y
CE/1CB9: F5 1C        SBC $1C,X
CE/1CBB: 00 1D        BRK $1D
CE/1CBD: 30 1D        BMI Local_CE1CDC
CE/1CBF: 4C 1D 68     JMP Routine_CE681D
...
CE/1D3D: 70 12        BVS Routine_CE1D51
...
CE/1D68: 20 01 1B     JSR Routine_CE1B01
CE/1D6B: 09 72 00     ORA #$0072
CE/1D6E: 73 03        ADC ($03,S),Y
CE/1D70: 0C 06 04     TSB $0406
CE/1D73: 24 01        BIT $01
CE/1D75: 70 12        BVS Routine_CE1D89
CE/1D77: 3C 1B 3C     BIT $3C1B,X
...
CE/1D92: 70 12        BVS Routine_CE1DA6
