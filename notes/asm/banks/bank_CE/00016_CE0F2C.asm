...
CE/0F32: 20 01 80     JSR $8001
CE/0F35: 51 2D        EOR ($2D),Y
CE/0F37: 80 12        BRA $0F4B
CE/0F39: 30 26        BMI $0F61
CE/0F3B: 32 02        AND ($02)
CE/0F3D: 20 0A 1E     JSR $1E0A
CE/0F40: 2A           ROL
CE/0F41: 28           PLP
CE/0F42: DA           PHX
...
CE/0F9D: 10 02        BPL $0FA1
CE/0F9F: 22 78 A5 34  JSR $34A578
CE/0FA3: 1B           TCS
...
CE/0FB6: 22 0F 01 78  JSR $78010F
...
CE/0FE0: 10 49        BPL $102B
CE/0FE2: 10 59        BPL $103D
CE/0FE4: 10 85        BPL $0F6B
CE/0FE6: 09 72 15     ORA #$1572
CE/0FE9: 06 34        ASL $34
CE/0FEB: 20 14 06     JSR $0614
CE/0FEE: 20 20 14     JSR $1420
CE/0FF1: 26 34        ROL $34
CE/0FF3: 02 36        COP $36
CE/0FF5: 20 50 36     JSR $3650
...
CE/106F: 90 80        BCC $0FF1
CE/1071: 80 00        BRA $1073
CE/1073: 7B           TDC
CE/1074: 10 B3        BPL $1029
CE/1076: 2A           ROL
CE/1077: 8F 10 85 09  STA $098510
CE/107B: 02 1A        COP $1A
CE/107D: 20 14 02     JSR $0214
...
CE/118A: 22 00 1B 09  JSR $091B00
CE/118E: 72 03        ADC ($03)
CE/1190: 73 00        ADC ($00,S),Y
CE/1192: 20 10 1E     JSR $1E10
...
CE/11B8: 22 00 1B 09  JSR $091B00
CE/11BC: 72 03        ADC ($03)
CE/11BE: 73 00        ADC ($00,S),Y
CE/11C0: 20 10 1E     JSR $1E10
