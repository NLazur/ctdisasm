...
CE/5788: 80 01        BRA Routine_CE578B
...
CE/579C: 80 01        BRA Routine_CE579F
...
CE/57BA: 70 C2        BVS Routine_CE577E
CE/57BC: 01 24        ORA ($24,X)
CE/57BE: 80 01        BRA Routine_CE57C1
CE/57C0: C2 01        REP #$01
CE/57C2: 20 C0 01     JSR Routine_CE01C0
