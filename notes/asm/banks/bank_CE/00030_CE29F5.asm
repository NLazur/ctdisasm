...
CE/2A06: 20 0A 36     JSR Routine_CE360A
CE/2A09: 24 03        BIT $03
CE/2A0B: 50 03        BVC Local_CE2A10
CE/2A0D: 1A           INC
CE/2A0E: 06 03        ASL $03
Local_CE2A10:
CE/2A10: 2E 01 00     ROL $0001
CE/2A13: 98           TYA
CE/2A14: 80 80        BRA Routine_CE2996
CE/2A16: 00 21        BRK $21
CE/2A18: 2A           ROL
CE/2A19: 47 2A        EOR [$2A]
CE/2A1B: 73 2A        ADC ($2A,S),Y
CE/2A1D: 90 2A        BCC Routine_CE2A49
CE/2A1F: 85 09        STA $09
CE/2A21: 30 00        BMI Local_CE2A23
Local_CE2A23:
CE/2A23: 40           RTI