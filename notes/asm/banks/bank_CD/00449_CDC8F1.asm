...
Routine_CDC8F1:
CD/C8F1: 70 09        BVS Local_CDC8FC
CD/C8F3: A8           TAY
CD/C8F4: 0A           ASL
CD/C8F5: 0A           ASL
CD/C8F6: A8           TAY
...
CD/C8F9: A8           TAY
CD/C8FA: 0A           ASL
CD/C8FB: 20 0A 03     JSR Local_CD030A
...
CD/C912: 70 09        BVS Local_CDC91D
CD/C914: A8           TAY
CD/C915: 0A           ASL
CD/C916: 0A           ASL
CD/C917: A8           TAY
...
CD/C91A: A8           TAY
CD/C91B: 0A           ASL
CD/C91C: 20 0A 03     JSR Local_CD030A
CD/C91F: 01 00        ORA ($00,X)
CD/C921: 98           TYA
CD/C922: F0 80        BEQ Local_CDC8A4
...
CD/C944: 80 45        BRA Local_CDC98B
