...
CD/39BD: D0 03        BNE $39C2
CD/39BF: 4C 7B 3A     JMP $3A7B
...
CD/3AB7: 4C BA 3A     JMP $3ABA
CD/3ABA: A5 0F        LDA $0F
CD/3ABC: 20 10 3B     JSR $3B10
CD/3ABF: A5 11        LDA $11
CD/3AC1: 38           SEC
CD/3AC2: E5 0F        SBC $0F
CD/3AC4: F0 21        BEQ $3AE7
