...
CD/C30A: 20 30 70     JSR Local_CD7030
...
CD/C319: 20 3C 70     JSR Local_CD703C
...
CD/C3A6: 20 0F 50     JSR Local_CD500F
...
CD/C3D7: 20 0F 50     JSR Local_CD500F
...
CD/C406: 20 0F 50     JSR Local_CD500F
...
CD/C437: 20 0F 50     JSR Local_CD500F
...
CD/C460: 20 1E 34     JSR Local_CD341E
CD/C463: 1A           INC
CD/C464: 22 1B 00 36  JSR Routine_36001B
CD/C468: 06 03        ASL $03
CD/C46A: 20 0F 50     JSR Local_CD500F
...
CD/C49B: 20 0F 50     JSR Local_CD500F
...
CD/C4CC: 20 0F 50     JSR Local_CD500F
...
CD/C503: 20 0F 50     JSR Local_CD500F
...
CD/C539: 20 0F 50     JSR Local_CD500F
...
CD/C568: 20 0F 50     JSR Local_CD500F
...
CD/C57E: 20 1E 06     JSR Local_CD061E
...
CD/C5A5: 20 0F 50     JSR Local_CD500F
CD/C5A8: 2E 01 00     ROL $0001
CD/C5AB: 24 01        BIT $01
CD/C5AD: 06 05        ASL $05
CD/C5AF: 20 70 69     JSR Local_CD6970
...
CD/C5D8: 50 2E        BVC Local_CDC608
...
CD/C607: 50 2E        BVC Local_CDC637
...
CD/C624: 20 40 30     JSR Local_CD3040
CD/C627: 21 B0        AND ($B0,X)
CD/C629: 30 22        BMI Local_CDC64D
CD/C62B: C0 30 23     CPY #$2330
CD/C62E: B0 30        BCS Local_CDC660
CD/C630: 24 80        BIT $80
CD/C632: 30 25        BMI Local_CDC659
CD/C634: 70 72        BVS Local_CDC6A8
...
CD/C644: 50 2E        BVC Local_CDC674
