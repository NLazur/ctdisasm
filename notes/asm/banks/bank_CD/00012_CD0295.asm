...
CD/02AD: 20 5E 02     JSR Local_CD025E
CD/02B0: 20 7F 02     JSR Local_CD027F
CD/02B3: A9 08        LDA #$08
CD/02B5: 20 3B 3E     JSR Local_CD3E3B
CD/02B8: 20 A5 01     JSR Local_CD01A5
CD/02BB: 8D EB CC     STA $CCEB
CD/02BE: AD 18 CE     LDA $CE18
CD/02C1: 8D 17 CE     STA $CE17
CD/02C4: EE ED CC     INC $CCED
CD/02C7: 20 75 3E     JSR Local_CD3E75
CD/02CA: 6B           RTL