...
Routine_CDC7B4:
CD/C7B4: 4C 0C 10     JMP Local_CD100C
...
CD/C7D5: F0 80        BEQ Local_CDC757
...
CD/C7F7: 20 3C 78     JSR Local_CD783C
CD/C7FA: AB           PLB
...
CD/C821: A8           TAY
CD/C822: 20 71 00     JSR Local_CD0071
...
CD/C833: A8           TAY
CD/C834: 20 71 00     JSR Local_CD0071
...
CD/C845: A8           TAY
CD/C846: 20 71 00     JSR Local_CD0071
...
CD/C857: A8           TAY
CD/C858: 20 71 36     JSR Local_CD3671
CD/C85B: 00 90        BRK $90
CD/C85D: F0 80        BEQ Local_CDC7DF
...
CD/C876: 20 1E 06     JSR Local_CD061E
