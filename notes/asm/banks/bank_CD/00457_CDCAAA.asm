...
Routine_CDCAAA:
CD/CAAA: 70 09        BVS Routine_CDCAB5
CD/CAAC: A8           TAY
CD/CAAD: 0A           ASL
CD/CAAE: 0A           ASL
CD/CAAF: A8           TAY
...
CD/CAB2: A8           TAY
CD/CAB3: 0A           ASL
CD/CAB4: 20 0A 03     JSR Routine_CD030A
...
CD/CACB: 70 09        BVS Routine_CDCAD6
CD/CACD: A8           TAY
CD/CACE: 0A           ASL
CD/CACF: 0A           ASL
CD/CAD0: A8           TAY
...
CD/CAD3: A8           TAY
CD/CAD4: 0A           ASL
CD/CAD5: 20 0A 03     JSR Routine_CD030A
...
CD/CAF7: 20 78 30     JSR Routine_CD3078
CD/CAFA: 21 A8        AND ($A8,X)
CD/CAFC: 30 09        BMI Routine_CDCB07
