...
CD/8A72: 20 0A 72     JSR Routine_CD720A
...
CD/8A89: 20 0A 72     JSR Routine_CD720A
CD/8A8C: 00 20        BRK $20
CD/8A8E: 0A           ASL
CD/8A8F: 70 02        BVS Local_CD8A93
...
CD/8AA2: 20 0A 72     JSR Routine_CD720A
...
CD/8ABF: 30 96        BMI Routine_CD8A57
CD/8AC1: 24 01        BIT $01
CD/8AC3: 20 0F 78     JSR Routine_CD780F
CD/8AC6: 4E 1E 44     LSR $441E
CD/8AC9: 36 06        ROL $06,X
CD/8ACB: 03 00        ORA $00,S
CD/8ACD: 90 00        BCC Local_CD8ACF
Local_CD8ACF:
CD/8ACF: 90 00        BCC Local_CD8AD1
Local_CD8AD1:
...
CD/8AE0: 80 12        BRA Routine_CD8AF4
CD/8AE2: A8           TAY
...
CD/8AEA: 08           PHP
CD/8AEB: 6A           ROR
CD/8AEC: 20 08 36     JSR Routine_CD3608
...
CD/8AFC: 30 96        BMI Local_CD8A94
CD/8AFE: 24 01        BIT $01
CD/8B00: 20 0F 78     JSR Routine_CD780F
CD/8B03: 4B           PHK
...
CD/8B18: 20 0F 78     JSR Routine_CD780F
CD/8B1B: 4C 2D 80     JMP Routine_CD802D
...
CD/8B27: 08           PHP
CD/8B28: 6A           ROR
CD/8B29: 20 08 36     JSR Routine_CD3608
...
CD/8B37: 30 96        BMI Local_CD8ACF
CD/8B39: 24 01        BIT $01
CD/8B3B: 20 0F 78     JSR Routine_CD780F
CD/8B3E: B8           CLV
...
CD/8B53: 20 0F 78     JSR Routine_CD780F
CD/8B56: B8           CLV
...
CD/8B62: 08           PHP
CD/8B63: 6A           ROR
CD/8B64: 20 08 36     JSR Routine_CD3608
...
CD/8B85: 8B           PHB
CD/8B86: B0 8B        BCS Routine_CD8B13
...
CD/8C16: 90 00        BCC Local_CD8C18
Local_CD8C18:
CD/8C18: 90 00        BCC Local_CD8C1A
Local_CD8C1A:
CD/8C1A: 22 8C 3C 8C  JSR Routine_8C3C8C
CD/8C1E: 22 8C EA 95  JSR Routine_95EA8C
CD/8C22: 72 0D        ADC ($0D)
CD/8C24: 02 01        COP $01
CD/8C26: 20 14 0C     JSR Routine_CD0C14
...
CD/8C38: 50 2E        BVC Local_CD8C68
...
CD/8C46: 90 00        BCC Local_CD8C48
Local_CD8C48:
CD/8C48: 90 00        BCC Local_CD8C4A
Local_CD8C4A:
...
CD/8CB5: 50 2E        BVC Routine_CD8CE5
CD/8CB7: 01 00        ORA ($00,X)
CD/8CB9: 24 01        BIT $01
CD/8CBB: 78           SEI
CD/8CBC: 74 2D        STZ $2D,X
CD/8CBE: 80 12        BRA Routine_CD8CD2
CD/8CC0: A8           TAY
...
CD/8CC8: 08           PHP
CD/8CC9: 6A           ROR
CD/8CCA: 20 08 24     JSR Routine_CD2408
