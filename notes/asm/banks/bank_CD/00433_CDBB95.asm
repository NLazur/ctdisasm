...
CD/BBD0: 20 06 03     JSR $0306
CD/BBD3: 50 2E        BVC $BC03
...
CD/BBE4: 1B           TCS
CD/BBE5: 22 1B 00 36  JSR $36001B
...
CD/BBF6: 70 09        BVS $BC01
CD/BBF8: 85 00        STA $00
CD/BBFA: A8           TAY
CD/BBFB: 10 0C        BPL $BC09
...
CD/BC0B: 70 09        BVS $BC16
CD/BC0D: 85 20        STA $20
CD/BC0F: A8           TAY
CD/BC10: 10 0C        BPL $BC1E
...
CD/BC20: 70 09        BVS $BC2B
CD/BC22: 85 40        STA $40
CD/BC24: A8           TAY
CD/BC25: 10 0C        BPL $BC33
...
CD/BC35: 70 09        BVS $BC40
CD/BC37: 85 60        STA $60
CD/BC39: A8           TAY
CD/BC3A: 10 0C        BPL $BC48
...
CD/BC4A: 70 09        BVS $BC55
CD/BC4C: 85 80        STA $80
CD/BC4E: A8           TAY
CD/BC4F: 10 0C        BPL $BC5D
...
CD/BC5F: 70 09        BVS $BC6A
CD/BC61: 85 A0        STA $A0
CD/BC63: A8           TAY
CD/BC64: 10 0C        BPL $BC72
...
CD/BC74: 70 09        BVS $BC7F
CD/BC76: 85 C0        STA $C0
CD/BC78: A8           TAY
CD/BC79: 10 0C        BPL $BC87
...
CD/BC89: 70 09        BVS $BC94
CD/BC8B: 85 E0        STA $E0
CD/BC8D: A8           TAY
CD/BC8E: 10 0C        BPL $BC9C
...
CD/BCDC: 20 0F 06     JSR $060F
CD/BCDF: 0A           ASL
CD/BCE0: 20 0F 06     JSR $060F
CD/BCE3: 03 00        ORA $00,S
CD/BCE5: 20 1E 78     JSR $781E
...
CD/BDCF: 20 05 78     JSR $7805
CD/BDD2: 80 34        BRA $BE08
CD/BDD4: 1B           TCS
...
CD/BE82: 20 3C 80     JSR $803C
CD/BE85: 02 69        COP $69
CD/BE87: 20 B4 20     JSR $20B4
CD/BE8A: 05 34        ORA $34
CD/BE8C: 1B           TCS
CD/BE8D: 78           SEI
CD/BE8E: A8           TAY
CD/BE8F: 22 1B 00 78  JSR $78001B
CD/BE93: FF 20 1E 80  SBC $801E20,X
CD/BE97: 12 69        ORA ($69)
CD/BE99: 80 51        BRA $BEEC
CD/BE9B: 36 28        ROL $28,X
CD/BE9D: 20 0F 50     JSR $500F
...
CD/BEB8: 50 10        BVC $BECA
CD/BEBA: 70 02        BVS $BEBE
CD/BEBC: 00 09        BRK $09
CD/BEBE: 85 40        STA $40
CD/BEC0: A8           TAY
CD/BEC1: 5A           PHY
CD/BEC2: 71 20        ADC ($20),Y
CD/BEC4: 10 19        BPL $BEDF
CD/BEC6: 20 10 70     JSR $7010
...
CD/BED6: 20 3C 19     JSR $193C
CD/BED9: 10 10        BPL $BEEB
CD/BEDB: 70 02        BVS $BEDF
CD/BEDD: 00 09        BRK $09
CD/BEDF: 85 40        STA $40
CD/BEE1: A8           TAY
CD/BEE2: 5A           PHY
CD/BEE3: 71 20        ADC ($20),Y
CD/BEE5: 10 19        BPL $BF00
CD/BEE7: 90 10        BCC $BEF9
CD/BEE9: 70 02        BVS $BEED
