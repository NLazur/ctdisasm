...
C0/50C7: D0 21        BNE Local_C050EA
C0/50C9: A5 F0        LDA $F0
C0/50CB: C5 F2        CMP $F2
C0/50CD: D0 1B        BNE Local_C050EA
C0/50CF: BD 81 1C     LDA $1C81,X
C0/50D2: 89 01        BIT #$01
C0/50D4: F0 05        BEQ Local_C050DB
C0/50D6: 20 5D 30     JSR Local_C0305D
C0/50D9: B0 09        BCS Local_C050E4
C0/50DB: 20 8B 56     JSR Local_C0568B
C0/50DE: BB           TYX
C0/50DF: E8           INX
C0/50E0: E8           INX
C0/50E1: E8           INX
