...
C0/B3B9: 80 A8        BRA Routine_C0B363
...
C0/B3DD: 80 84        BRA Routine_C0B363
...
C0/B3EF: F0 0A        BEQ Local_C0B3FB
C0/B3F1: 89 04        BIT #$04
C0/B3F3: D0 03        BNE Local_C0B3F8
C0/B3F5: 82 63 00     BRL Routine_C0B45B
Local_C0B3F8:
C0/B3F8: 82 8E 00     BRL Routine_C0B489
Local_C0B3FB:
...
C0/B457: D0 D9        BNE Local_C0B432
C0/B459: 2B           PLD
C0/B45A: 60           RTS