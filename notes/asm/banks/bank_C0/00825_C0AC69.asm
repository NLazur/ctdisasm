...
C0/AC74: 8D 02 42     STA WRMPYA
C0/AC77: A6 EE        LDX $EE
C0/AC79: BD 00 F8     LDA $F800,X
C0/AC7C: E0 80        CPX #$80
C0/AC7E: B0 13        BCS Local_C0AC93
C0/AC80: 8D 03 42     STA WRMPYB
C0/AC83: EA           NOP
C0/AC84: EA           NOP
C0/AC85: EA           NOP
C0/AC86: EA           NOP
C0/AC87: A6 6D        LDX $6D
C0/AC89: AD 17 42     LDA RDMPYH
C0/AC8C: 85 DB        STA $DB
C0/AC8E: 9D 80 19     STA $1980,X
C0/AC91: 80 17        BRA Local_C0ACAA
Local_C0AC93:
C0/AC93: 49 FF        EOR #$FF
C0/AC95: 1A           INC
C0/AC96: 8D 03 42     STA WRMPYB
C0/AC99: EA           NOP
C0/AC9A: EA           NOP
C0/AC9B: EA           NOP
C0/AC9C: EA           NOP
C0/AC9D: A6 6D        LDX $6D
C0/AC9F: AD 17 42     LDA RDMPYH
...
C0/ACAD: 10 07        BPL Local_C0ACB6
C0/ACAF: A9 FF        LDA #$FF
C0/ACB1: 9D 81 19     STA $1981,X
C0/ACB4: 80 03        BRA Local_C0ACB9
Local_C0ACB6:
