...
C0/3F5E: 1A           INC
C0/3F5F: 8D 04 42     STA WRDIVL
C0/3F62: E2 20        SEP #$20
C0/3F64: A5 F4        LDA $F4
C0/3F66: 8D 06 42     STA WRDIVB
C0/3F69: EA           NOP
C0/3F6A: EA           NOP
C0/3F6B: EA           NOP
C0/3F6C: EA           NOP
