...
C0/ECD9: 30 31        BMI Local_C0ED0C
C0/ECDB: AF 11 42 00  LDA $004211
C0/ECDF: 10 2B        BPL Local_C0ED0C
...
C0/ECEA: AB           PLB
Local_C0ECEB:
C0/ECEB: AD 12 42     LDA HVBJOY
C0/ECEE: 89 40        BIT #$40
C0/ECF0: F0 F9        BEQ Local_C0ECEB
C0/ECF2: A9 80        LDA #$80
C0/ECF4: 8D 00 21     STA INIDISP
C0/ECF7: A9 00        LDA #$00
C0/ECF9: 8D 0C 42     STA HDMAEN
C0/ECFC: AD 53 01     LDA $0153
C0/ECFF: 29 01        AND #$01
C0/ED01: D0 05        BNE Local_C0ED08
C0/ED03: 20 15 ED     JSR Routine_C0ED15
C0/ED06: 80 04        BRA Local_C0ED0C
Local_C0ED08:
C0/ED08: 22 FD FF FD  JSR Routine_FDFFFD
Local_C0ED0C:
