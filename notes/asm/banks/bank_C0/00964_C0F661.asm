...
C0/F67B: 20 1F 1E     JSR Local_C01E1F
...
C0/F6AC: 30 2E        BMI Local_C0F6DC
...
C0/F6CC: 30 2F        BMI Local_C0F6FD
...
C0/F6E3: 3C 3A 39     BIT Local_C0393A,X
C0/F6E6: 38           SEC
C0/F6E7: 37 35        AND [$35],Y
C0/F6E9: 34 33        BIT $33,X
C0/F6EB: 32 30        AND ($30)
C0/F6ED: 30 2E        BMI Local_C0F71D
...
C0/F6FF: 20 03 03     JSR Local_C00303
...
C0/F814: 3C 3F 41     BIT Local_C0413F,X
C0/F817: 44 47 49     MVP $47,$49
C0/F81A: 4C 4E 51     JMP Local_C0514E
