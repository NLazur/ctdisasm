...
C0/95BD: D0 0C        BNE Local_C095CB
C0/95BF: A5 35        LDA $35
C0/95C1: 89 02        BIT #$02
C0/95C3: D0 04        BNE Local_C095C9
...
C0/95CD: D0 0C        BNE Local_C095DB
C0/95CF: A5 35        LDA $35
C0/95D1: 89 02        BIT #$02
C0/95D3: D0 04        BNE Local_C095D9
...
C0/95E0: D0 D4        BNE Local_C095B6
C0/95E2: 60           RTS