...
C0/96C7: D0 0C        BNE Local_C096D5
C0/96C9: A5 35        LDA $35
C0/96CB: 89 04        BIT #$04
C0/96CD: D0 04        BNE Local_C096D3
...
C0/96D7: D0 0C        BNE Local_C096E5
C0/96D9: A5 35        LDA $35
C0/96DB: 89 04        BIT #$04
C0/96DD: D0 04        BNE Local_C096E3
...
C0/96EA: D0 D2        BNE Local_C096BE
C0/96EC: 60           RTS