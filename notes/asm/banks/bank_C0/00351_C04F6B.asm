...
C0/4F88: D0 21        BNE Local_C04FAB
C0/4F8A: A5 F0        LDA $F0
C0/4F8C: C5 F2        CMP $F2
C0/4F8E: D0 1B        BNE Local_C04FAB
C0/4F90: BD 81 1C     LDA $1C81,X
C0/4F93: 89 01        BIT #$01
C0/4F95: F0 05        BEQ Local_C04F9C
C0/4F97: 20 5D 30     JSR Local_C0305D
C0/4F9A: B0 09        BCS Local_C04FA5
C0/4F9C: 20 8B 56     JSR Local_C0568B
C0/4F9F: BB           TYX
C0/4FA0: E8           INX
C0/4FA1: E8           INX
C0/4FA2: E8           INX
