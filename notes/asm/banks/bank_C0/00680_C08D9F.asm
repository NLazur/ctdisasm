...
C0/8DA2: D0 C3        BNE Local_C08D67
...
C0/8DB3: 20 9E 8A     JSR Local_C08A9E
C0/8DB6: 90 02        BCC Local_C08DBA
C0/8DB8: 80 42        BRA Local_C08DFC
...
C0/8DC7: 20 9E 8A     JSR Local_C08A9E
C0/8DCA: 90 09        BCC Local_C08DD5
