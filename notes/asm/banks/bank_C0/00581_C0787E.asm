...
C0/78A7: 8D 80 21     STA WMDATA
C0/78AA: EB           XBA
C0/78AB: 8D 80 21     STA WMDATA
...
C0/78D8: 8D 80 21     STA WMDATA
C0/78DB: EB           XBA
C0/78DC: 8D 80 21     STA WMDATA
...
C0/78F1: 8D 81 21     STA WMADDL
C0/78F4: E2 20        SEP #$20
C0/78F6: A9 00        LDA #$00
C0/78F8: 8D 83 21     STA WMADDH
...
C0/7925: 20 CF 79     JSR Routine_C079CF
