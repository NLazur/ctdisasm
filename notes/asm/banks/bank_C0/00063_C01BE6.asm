...
C0/1BF6: F0 11        BEQ Local_C01C09
C0/1BF8: 3A           DEC
C0/1BF9: F0 03        BEQ Local_C01BFE
C0/1BFB: 3A           DEC
C0/1BFC: 80 0B        BRA Local_C01C09
Local_C01BFE:
C0/1BFE: AF 1F 2A 7E  LDA $7E2A1F
C0/1C02: 89 20        BIT #$20
C0/1C04: D0 03        BNE Local_C01C09
C0/1C06: 82 87 00     BRL Routine_C01C90
Local_C01C09:
C0/1C09: AF 1F 2A 7E  LDA $7E2A1F
C0/1C0D: 89 40        BIT #$40
C0/1C0F: D0 6E        BNE Routine_C01C7F
...
C0/1C52: 22 04 00 C7  JSR Routine_C70004
...
C0/1C65: 22 04 00 C7  JSR Routine_C70004
...
C0/1C78: 22 04 00 C7  JSR Routine_C70004
C0/1C7C: AB           PLB
C0/1C7D: 2B           PLD
C0/1C7E: 6B           RTL