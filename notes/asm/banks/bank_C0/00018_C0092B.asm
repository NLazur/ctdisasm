...
C0/092F: D0 14        BNE Local_C00945
C0/0931: A5 00        LDA $00
C0/0933: 8D 02 42     STA WRMPYA
C0/0936: A9 0E        LDA #$0E
C0/0938: 8D 03 42     STA WRMPYB
C0/093B: EA           NOP
C0/093C: EA           NOP
C0/093D: EA           NOP
C0/093E: C2 20        REP #$20
C0/0940: AD 16 42     LDA RDMPYL
C0/0943: 80 16        BRA Local_C0095B
Local_C00945:
C0/0945: A5 00        LDA $00
C0/0947: 8D 02 42     STA WRMPYA
C0/094A: A9 0E        LDA #$0E
C0/094C: 8D 03 42     STA WRMPYB
C0/094F: EA           NOP
C0/0950: EA           NOP
C0/0951: EA           NOP
C0/0952: C2 20        REP #$20
C0/0954: AD 16 42     LDA RDMPYL
C0/0957: 18           CLC
