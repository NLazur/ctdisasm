...
C0/C141: 10 06        BPL Local_C0C149
...
C0/C152: 10 06        BPL Local_C0C15A
...
C0/C163: 10 06        BPL Local_C0C16B
...
C0/C174: 10 06        BPL Local_C0C17C
...
C0/C185: 10 06        BPL Local_C0C18D
...
C0/C196: 10 06        BPL Local_C0C19E
...
C0/C1A7: 10 06        BPL Local_C0C1AF
...
C0/C1B8: 10 06        BPL Local_C0C1C0
...
C0/C1C9: 10 06        BPL Local_C0C1D1
C0/C1CB: C9 E0 B0     CMP #$B0E0
C0/C1CE: 02 A9        COP $A9
C0/C1D0: E0 9D 01     CPX #$019D
C0/C1D3: 4C BD 0C     JMP Local_C00CBD
C0/C1D6: 4C 18 65     JMP Local_C06518
...
C0/C1EB: 10 06        BPL Local_C0C1F3
C0/C1ED: C9 E0 B0     CMP #$B0E0
C0/C1F0: 02 A9        COP $A9
C0/C1F2: E0 9D 11     CPX #$119D
C0/C1F5: 4C BD 1C     JMP Local_C01CBD
C0/C1F8: 4C 18 65     JMP Local_C06518
