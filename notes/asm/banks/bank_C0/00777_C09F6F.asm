...
C0/9F75: F0 7B        BEQ Routine_C09FF2
C0/9F77: 89 04        BIT #$04
C0/9F79: D0 58        BNE Routine_C09FD3
C0/9F7B: BF 00 0C 7F  LDA $7F0C00,X
C0/9F7F: 10 09        BPL Local_C09F8A
C0/9F81: 89 08        BIT #$08
C0/9F83: F0 0C        BEQ Local_C09F91
C0/9F85: 38           SEC
C0/9F86: E9 08        SBC #$08
C0/9F88: 80 07        BRA Local_C09F91
Local_C09F8A:
C0/9F8A: 89 08        BIT #$08
C0/9F8C: F0 03        BEQ Local_C09F91
C0/9F8E: 18           CLC
...
C0/9F99: 10 05        BPL Local_C09FA0
...
C0/9FA9: 10 09        BPL Local_C09FB4
C0/9FAB: 89 08        BIT #$08
C0/9FAD: F0 0C        BEQ Local_C09FBB
C0/9FAF: 38           SEC
C0/9FB0: E9 08        SBC #$08
C0/9FB2: 80 07        BRA Local_C09FBB
Local_C09FB4:
C0/9FB4: 89 08        BIT #$08
C0/9FB6: F0 03        BEQ Local_C09FBB
C0/9FB8: 18           CLC
...
C0/9FC3: 10 05        BPL Local_C09FCA
