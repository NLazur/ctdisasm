...
C0/0012: 20 64 0B     JSR Routine_C00B64       ; set jump code for NMI
C0/0015: 20 75 0B     JSR Routine_C00B75       ; set jump code for IRQ
C0/0018: C2 20        REP #$20
C0/001A: A9 00 01     LDA #$0100      ; set dp to $0100
C0/001D: 5B           TCD
C0/001E: E2 20        SEP #$20
C0/0020: 20 4E 0B     JSR Routine_C00B4E       ; screen off, disable DMA
...
C0/0031: 20 F1 2D     JSR Routine_C02DF1
...
C0/0042: 20 F1 2D     JSR Routine_C02DF1
...
C0/0050: 20 F1 2D     JSR Routine_C02DF1
C0/0053: 22 00 00 C7  JSR Routine_C70000     ; init SPC
C0/0057: A9 09        LDA #$09        ;
C0/0059: 22 04 80 C2  JSR Routine_C28004
Local_C0005D:
C0/005D: 20 4E 0B     JSR Routine_C00B4E       ; screen off, disable DMA
C0/0060: 20 64 0B     JSR Routine_C00B64       ; set jump code for NMI
C0/0063: 20 75 0B     JSR Routine_C00B75       ; set jump code for IRQ
...
C0/0085: 20 86 0B     JSR Routine_C00B86
C0/0088: 20 F4 00     JSR Routine_C000F4       ; load map
C0/008B: 20 92 B1     JSR Routine_C0B192
C0/008E: 20 A6 56     JSR Routine_C056A6       ; load objects ???
C0/0091: 20 AA 28     JSR Routine_C028AA
C0/0094: 20 48 28     JSR Routine_C02848
Local_C00097:
...
C0/00A1: 20 D9 18     JSR Routine_C018D9
C0/00A4: 20 76 0C     JSR Routine_C00C76
C0/00A7: 20 1E 88     JSR Routine_C0881E
C0/00AA: 20 AC 1A     JSR Routine_C01AAC
C0/00AD: 22 87 1F C0  JSR Routine_C01F87
C0/00B1: 20 E1 21     JSR Routine_C021E1
C0/00B4: 20 4D 27     JSR Routine_C0274D
C0/00B7: 20 BF 00     JSR Local_C000BF
C0/00BA: 20 60 EC     JSR Routine_C0EC60       ; wait for vblank
C0/00BD: 80 D8        BRA Local_C00097
Local_C000BF:
C0/00BF: E2 10        SEP #$10
C0/00C1: 20 D9 59     JSR Routine_C059D9
C0/00C4: 20 46 5A     JSR Routine_C05A46
C0/00C7: 22 C1 C2 FD  JSR Routine_FDC2C1
C0/00CB: C2 10        REP #$10
C0/00CD: 22 F7 FF FD  JSR Routine_FDFFF7
C0/00D1: E2 10        SEP #$10
C0/00D3: 20 10 A8     JSR Routine_C0A810
C0/00D6: 20 76 CA     JSR Routine_C0CA76
