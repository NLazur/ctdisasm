...
C1/F948: 30 29        BMI Local_C1F973
C1/F94A: A2 2D 5E     LDX #$5E2D
C1/F94D: 20 08 F9     JSR Routine_C1F908
Local_C1F950:
...
C1/F968: 20 23 F6     JSR Routine_C1F623
C1/F96B: AE 8C B2     LDX $B28C
C1/F96E: E0 00 00     CPX #$0000
C1/F971: D0 DD        BNE Local_C1F950
Local_C1F973:
C1/F973: FA           PLX
...
C1/F97E: 30 29        BMI Local_C1F9A9
C1/F980: A2 AD 5E     LDX #$5EAD
C1/F983: 20 08 F9     JSR Routine_C1F908
Local_C1F986:
...
C1/F99E: 20 23 F6     JSR Routine_C1F623
C1/F9A1: AE 8C B2     LDX $B28C
C1/F9A4: E0 00 00     CPX #$0000
C1/F9A7: D0 DD        BNE Local_C1F986
Local_C1F9A9:
C1/F9A9: FA           PLX
...
C1/F9B4: 30 29        BMI Local_C1F9DF
C1/F9B6: A2 2D 5F     LDX #$5F2D
C1/F9B9: 20 08 F9     JSR Routine_C1F908
Local_C1F9BC:
...
C1/F9D4: 20 23 F6     JSR Routine_C1F623
C1/F9D7: AE 8C B2     LDX $B28C
C1/F9DA: E0 00 00     CPX #$0000
C1/F9DD: D0 DD        BNE Local_C1F9BC
Local_C1F9DF:
C1/F9DF: FA           PLX
C1/F9E0: 8E 8C B2     STX $B28C
C1/F9E3: 20 05 F2     JSR Routine_C1F205
C1/F9E6: 20 EB F9     JSR Routine_C1F9EB
C1/F9E9: 60           RTS