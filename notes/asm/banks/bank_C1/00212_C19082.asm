...
C1/9093: F0 0E        BEQ $90A3
C1/9095: 7B           TDC
C1/9096: AD 52 B2     LDA $B252
C1/9099: AA           TAX
C1/909A: BD 20 B3     LDA $B320,X
C1/909D: C5 08        CMP $08
C1/909F: B0 12        BCS $90B3
C1/90A1: 80 15        BRA $90B8
C1/90A3: 7B           TDC
C1/90A4: AD 52 B2     LDA $B252
C1/90A7: AA           TAX
C1/90A8: BD 20 B3     LDA $B320,X
C1/90AB: C5 08        CMP $08
C1/90AD: F0 04        BEQ $90B3
C1/90AF: 90 02        BCC $90B3
C1/90B1: 80 05        BRA $90B8
C1/90B3: 20 3E 8C     JSR $8C3E
C1/90B6: 80 05        BRA $90BD
