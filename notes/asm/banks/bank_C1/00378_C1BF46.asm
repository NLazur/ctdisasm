...
C1/BF5F: F0 05        BEQ $BF66
C1/BF61: 20 90 D4     JSR $D490
C1/BF64: 80 12        BRA $BF78
C1/BF66: 89 04        BIT #$04
C1/BF68: F0 05        BEQ $BF6F
C1/BF6A: 20 AD D4     JSR $D4AD
C1/BF6D: 80 09        BRA $BF78
C1/BF6F: 89 40        BIT #$40
C1/BF71: F0 05        BEQ $BF78
C1/BF73: 20 D6 D4     JSR $D4D6
C1/BF76: 80 00        BRA $BF78
C1/BF78: 60           RTS