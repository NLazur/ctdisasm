...
C1/F543: 90 0C        BCC Local_C1F551
...
C1/F557: 90 E5        BCC Local_C1F53E
...
C1/F56D: F0 03        BEQ Local_C1F572
C1/F56F: 4C 01 F6     JMP Local_C1F601
Local_C1F572:
C1/F572: 7B           TDC
C1/F573: AA           TAX
...
C1/F584: F0 20        BEQ Local_C1F5A6
...
C1/F599: B0 07        BCS Local_C1F5A2
C1/F59B: A9 FF        LDA #$FF
C1/F59D: 8D E9 B2     STA $B2E9
C1/F5A0: 80 5F        BRA Local_C1F601
Local_C1F5A2:
C1/F5A2: E6 10        INC $10
C1/F5A4: 80 D7        BRA Local_C1F57D
Local_C1F5A6:
C1/F5A6: 7B           TDC
...
C1/F5CE: D0 1A        BNE Local_C1F5EA
...
C1/F5E8: 80 17        BRA Local_C1F601
Local_C1F5EA:
C1/F5EA: A5 10        LDA $10
C1/F5EC: C9 03        CMP #$03
C1/F5EE: D0 11        BNE Local_C1F601
...
C1/F61D: F0 03        BEQ Local_C1F622
C1/F61F: 4C 65 F5     JMP Local_C1F565
Local_C1F622:
C1/F622: 60           RTS