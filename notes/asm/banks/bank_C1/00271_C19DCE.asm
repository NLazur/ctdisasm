...
C1/9DD9: F0 03        BEQ $9DDE
C1/9DDB: 4C 4D 9E     JMP $9E4D
C1/9DDE: 89 40        BIT #$40
C1/9DE0: F0 0C        BEQ $9DEE
C1/9DE2: 7B           TDC
C1/9DE3: AD C8 AE     LDA $AEC8
C1/9DE6: AA           TAX
C1/9DE7: A9 00        LDA #$00
C1/9DE9: 9D 20 B3     STA $B320,X
C1/9DEC: 80 5F        BRA $9E4D
C1/9DEE: 89 20        BIT #$20
C1/9DF0: F0 16        BEQ $9E08
C1/9DF2: 7B           TDC
...
C1/9E2D: 80 1E        BRA $9E4D
C1/9E2F: 89 02        BIT #$02
C1/9E31: F0 16        BEQ $9E49
C1/9E33: 7B           TDC
