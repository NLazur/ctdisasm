...
C1/F7C6: F0 03        BEQ Local_C1F7CB
C1/F7C8: 4C 5C F8     JMP Local_C1F85C
Local_C1F7CB:
C1/F7CB: AE 85 B2     LDX $B285
C1/F7CE: BD 12 00     LDA $0012,X
C1/F7D1: C9 63        CMP #$63
C1/F7D3: 90 10        BCC Local_C1F7E5
C1/F7D5: 7B           TDC
C1/F7D6: AA           TAX
...
C1/F7E2: 4C 70 F8     JMP Local_C1F870
Local_C1F7E5:
...
C1/F7F8: 90 55        BCC Local_C1F84F
C1/F7FA: 7B           TDC
...
C1/F82B: B0 06        BCS Local_C1F833
...
C1/F84D: 80 0D        BRA Local_C1F85C
Local_C1F84F:
...
C1/F867: 90 07        BCC Local_C1F870
C1/F869: 7B           TDC
