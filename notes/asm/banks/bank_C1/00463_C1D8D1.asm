...
C1/D92C: D0 03        BNE $D931
C1/D92E: 4C B0 D9     JMP $D9B0
C1/D931: AA           TAX
C1/D932: 8E 28 00     STX $0028
C1/D935: A9 0C        LDA #$0C
C1/D937: AA           TAX
C1/D938: 8E 2A 00     STX $002A
C1/D93B: 20 0B C9     JSR $C90B
...
C1/D967: 20 0E EB     JSR $EB0E
C1/D96A: AD CA B2     LDA $B2CA
C1/D96D: 89 C0        BIT #$C0
C1/D96F: F0 10        BEQ $D981
...
C1/D9C2: D0 03        BNE $D9C7
C1/D9C4: 4C CA D9     JMP $D9CA
C1/D9C7: 20 68 EB     JSR $EB68
