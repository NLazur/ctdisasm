...
C1/BA30: 4C 6B BD     JMP Local_C1BD6B
C1/BA33: 7B           TDC
C1/BA34: A8           TAY
...
C1/BA65: 4C E1 BC     JMP Local_C1BCE1
C1/BA68: 7B           TDC
...
C1/BA7D: 20 AA BF     JSR Local_C1BFAA
C1/BA80: 4C E1 BC     JMP Local_C1BCE1
C1/BA83: 7B           TDC
C1/BA84: AA           TAX
...
C1/BABE: 20 DD C1     JSR Local_C1C1DD
...
C1/BB06: 20 09 AD     JSR Local_C1AD09
C1/BB09: 20 35 AD     JSR Local_C1AD35
C1/BB0C: 20 46 BF     JSR Local_C1BF46
...
C1/BB26: 20 57 AC     JSR Local_C1AC57
...
C1/BB46: 4C E1 BC     JMP Local_C1BCE1
C1/BB49: 7B           TDC
...
C1/BB63: 4C E1 BC     JMP Local_C1BCE1
...
C1/BB88: 20 DD C1     JSR Local_C1C1DD
...
C1/BBCE: 20 09 AD     JSR Local_C1AD09
C1/BBD1: 20 35 AD     JSR Local_C1AD35
C1/BBD4: 20 79 BF     JSR Local_C1BF79
...
C1/BBFA: 20 48 CB     JSR Local_C1CB48
C1/BBFD: A8           TAY
C1/BBFE: AD EA B2     LDA $B2EA
C1/BC01: 20 71 CC     JSR Local_C1CC71
C1/BC04: AD 8C B1     LDA $B18C
C1/BC07: 20 61 CB     JSR Local_C1CB61
C1/BC0A: A8           TAY
C1/BC0B: AD EB B2     LDA $B2EB
C1/BC0E: 20 71 CC     JSR Local_C1CC71
C1/BC11: AD 8C B1     LDA $B18C
C1/BC14: 20 7A CB     JSR Local_C1CB7A
C1/BC17: A8           TAY
C1/BC18: AD EC B2     LDA $B2EC
C1/BC1B: 20 71 CC     JSR Local_C1CC71
C1/BC1E: 20 57 AC     JSR Local_C1AC57
...
C1/BC5A: 20 B3 BD     JSR Local_C1BDB3
C1/BC5D: 4C F8 BC     JMP Local_C1BCF8
...
C1/BC7D: 20 0B C9     JSR Local_C1C90B
...
C1/BCB4: 20 3A CE     JSR Local_C1CE3A
...
C1/BCD5: 20 15 CF     JSR Local_C1CF15
