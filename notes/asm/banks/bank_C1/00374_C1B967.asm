...
C1/B9E0: F0 06        BEQ Local_C1B9E8
C1/B9E2: AA           TAX
...
C1/B9F2: F0 06        BEQ Local_C1B9FA
C1/B9F4: AA           TAX
C1/B9F5: A9 01        LDA #$01
C1/B9F7: 9D E7 B3     STA $B3E7,X
Local_C1B9FA:
C1/B9FA: AD E7 B3     LDA $B3E7
C1/B9FD: F0 0B        BEQ Local_C1BA0A
C1/B9FF: A9 00        LDA #$00
C1/BA01: 22 A5 A8 FD  JSR Routine_FDA8A5
C1/BA05: AD EA B3     LDA $B3EA
C1/BA08: D0 22        BNE Local_C1BA2C
Local_C1BA0A:
C1/BA0A: AD E8 B3     LDA $B3E8
C1/BA0D: F0 0B        BEQ Local_C1BA1A
C1/BA0F: A9 01        LDA #$01
C1/BA11: 22 A5 A8 FD  JSR Routine_FDA8A5
C1/BA15: AD EA B3     LDA $B3EA
C1/BA18: D0 12        BNE Local_C1BA2C
Local_C1BA1A:
C1/BA1A: AD E9 B3     LDA $B3E9
C1/BA1D: F0 14        BEQ Local_C1BA33
C1/BA1F: A9 02        LDA #$02
C1/BA21: 22 A5 A8 FD  JSR Routine_FDA8A5
C1/BA25: AD EA B3     LDA $B3EA
C1/BA28: D0 02        BNE Local_C1BA2C
C1/BA2A: 80 07        BRA Local_C1BA33
Local_C1BA2C:
C1/BA2C: 22 3C A9 FD  JSR Routine_FDA93C
C1/BA30: 4C 6B BD     JMP Routine_C1BD6B
Local_C1BA33:
C1/BA33: 7B           TDC
C1/BA34: A8           TAY
...
C1/BA51: 30 15        BMI Local_C1BA68
C1/BA53: 0A           ASL
C1/BA54: 10 03        BPL Local_C1BA59
C1/BA56: 4C 83 BA     JMP Local_C1BA83
Local_C1BA59:
C1/BA59: 0A           ASL
C1/BA5A: 10 03        BPL Local_C1BA5F
C1/BA5C: 4C 49 BB     JMP Local_C1BB49
Local_C1BA5F:
C1/BA5F: 0A           ASL
C1/BA60: 10 03        BPL Local_C1BA65
C1/BA62: 4C 60 BC     JMP Local_C1BC60
Local_C1BA65:
C1/BA65: 4C E1 BC     JMP Routine_C1BCE1
Local_C1BA68:
C1/BA68: 7B           TDC
C1/BA69: A6 06        LDX $06
C1/BA6B: BD 01 00     LDA $0001,X
C1/BA6E: 89 10        BIT #$10
C1/BA70: F0 03        BEQ Local_C1BA75
C1/BA72: 20 60 BC     JSR Local_C1BC60
Local_C1BA75:
C1/BA75: A6 06        LDX $06
C1/BA77: BD 03 00     LDA $0003,X
C1/BA7A: 8D 8E AD     STA $AD8E
C1/BA7D: 20 AA BF     JSR Routine_C1BFAA
C1/BA80: 4C E1 BC     JMP Routine_C1BCE1
Local_C1BA83:
C1/BA83: 7B           TDC
C1/BA84: AA           TAX
...
C1/BA8E: 90 F7        BCC Local_C1BA87
C1/BA90: 7B           TDC
C1/BA91: AA           TAX
...
C1/BABE: 20 DD C1     JSR Routine_C1C1DD
C1/BAC1: AD 23 AF     LDA $AF23
C1/BAC4: F0 03        BEQ Local_C1BAC9
C1/BAC6: 4C 2D BB     JMP Local_C1BB2D
Local_C1BAC9:
C1/BAC9: 7B           TDC
...
C1/BAF3: F0 11        BEQ Local_C1BB06
C1/BAF5: 9D CC AE     STA $AECC,X
C1/BAF8: E8           INX
C1/BAF9: EE CB AE     INC $AECB
C1/BAFC: AD CB AE     LDA $AECB
C1/BAFF: CD 8D AD     CMP $AD8D
C1/BB02: F0 02        BEQ Local_C1BB06
C1/BB04: 80 E8        BRA Local_C1BAEE
Local_C1BB06:
C1/BB06: 20 09 AD     JSR Routine_C1AD09
C1/BB09: 20 35 AD     JSR Routine_C1AD35
C1/BB0C: 20 46 BF     JSR Routine_C1BF46
...
C1/BB26: 20 57 AC     JSR Routine_C1AC57
C1/BB29: 22 EE AC FD  JSR Routine_FDACEE
Local_C1BB2D:
C1/BB2D: AD CC AE     LDA $AECC
C1/BB30: C9 03        CMP #$03
C1/BB32: 90 05        BCC Local_C1BB39
...
C1/BB41: F0 03        BEQ Local_C1BB46
C1/BB43: 20 60 BC     JSR Local_C1BC60
Local_C1BB46:
C1/BB46: 4C E1 BC     JMP Routine_C1BCE1
Local_C1BB49:
C1/BB49: 7B           TDC
C1/BB4A: A6 06        LDX $06
C1/BB4C: BD 01 00     LDA $0001,X
C1/BB4F: 89 10        BIT #$10
C1/BB51: F0 03        BEQ Local_C1BB56
C1/BB53: 20 60 BC     JSR Local_C1BC60
Local_C1BB56:
C1/BB56: A6 06        LDX $06
C1/BB58: BD 02 00     LDA $0002,X
C1/BB5B: C9 01        CMP #$01
C1/BB5D: F0 07        BEQ Local_C1BB66
C1/BB5F: C9 03        CMP #$03
C1/BB61: F0 03        BEQ Local_C1BB66
C1/BB63: 4C E1 BC     JMP Routine_C1BCE1
Local_C1BB66:
...
C1/BB88: 20 DD C1     JSR Routine_C1C1DD
C1/BB8B: AD 23 AF     LDA $AF23
C1/BB8E: F0 03        BEQ Local_C1BB93
C1/BB90: 4C 5A BC     JMP Local_C1BC5A
Local_C1BB93:
C1/BB93: 7B           TDC
...
C1/BBBB: F0 11        BEQ Local_C1BBCE
C1/BBBD: 9D CC AE     STA $AECC,X
C1/BBC0: E8           INX
C1/BBC1: EE CB AE     INC $AECB
C1/BBC4: AD CB AE     LDA $AECB
C1/BBC7: CD 8D AD     CMP $AD8D
C1/BBCA: F0 02        BEQ Local_C1BBCE
C1/BBCC: 80 E8        BRA Local_C1BBB6
Local_C1BBCE:
C1/BBCE: 20 09 AD     JSR Routine_C1AD09
C1/BBD1: 20 35 AD     JSR Routine_C1AD35
C1/BBD4: 20 79 BF     JSR Routine_C1BF79
C1/BBD7: AD 23 AF     LDA $AF23
C1/BBDA: D0 7E        BNE Local_C1BC5A
C1/BBDC: AD C8 B3     LDA $B3C8
C1/BBDF: D0 79        BNE Local_C1BC5A
...
C1/BBFA: 20 48 CB     JSR Routine_C1CB48
C1/BBFD: A8           TAY
C1/BBFE: AD EA B2     LDA $B2EA
C1/BC01: 20 71 CC     JSR Routine_C1CC71
C1/BC04: AD 8C B1     LDA $B18C
C1/BC07: 20 61 CB     JSR Routine_C1CB61
C1/BC0A: A8           TAY
C1/BC0B: AD EB B2     LDA $B2EB
C1/BC0E: 20 71 CC     JSR Routine_C1CC71
C1/BC11: AD 8C B1     LDA $B18C
C1/BC14: 20 7A CB     JSR Routine_C1CB7A
C1/BC17: A8           TAY
C1/BC18: AD EC B2     LDA $B2EC
C1/BC1B: 20 71 CC     JSR Routine_C1CC71
C1/BC1E: 20 57 AC     JSR Routine_C1AC57
C1/BC21: AD BF B3     LDA $B3BF
C1/BC24: F0 24        BEQ Local_C1BC4A
C1/BC26: 30 18        BMI Local_C1BC40
C1/BC28: A5 06        LDA $06
C1/BC2A: 8F 00 02 7F  STA $7F0200
C1/BC2E: A9 03        LDA #$03
C1/BC30: 22 21 00 CD  JSR Routine_CD0021
C1/BC34: 7B           TDC
C1/BC35: AD 8B B1     LDA $B18B
C1/BC38: AA           TAX
C1/BC39: A9 01        LDA #$01
C1/BC3B: 9D B5 A0     STA $A0B5,X
C1/BC3E: 80 0A        BRA Local_C1BC4A
Local_C1BC40:
C1/BC40: C9 FF        CMP #$FF
C1/BC42: D0 06        BNE Local_C1BC4A
C1/BC44: A9 0D        LDA #$0D
C1/BC46: 22 21 00 CD  JSR Routine_CD0021
Local_C1BC4A:
C1/BC4A: AD CC AE     LDA $AECC
C1/BC4D: C9 03        CMP #$03
C1/BC4F: 90 05        BCC Local_C1BC56
C1/BC51: A9 01        LDA #$01
C1/BC53: 8D C0 B2     STA $B2C0
Local_C1BC56:
C1/BC56: 22 EE AC FD  JSR Routine_FDACEE
Local_C1BC5A:
C1/BC5A: 20 B3 BD     JSR Routine_C1BDB3
C1/BC5D: 4C F8 BC     JMP Routine_C1BCF8
Local_C1BC60:
C1/BC60: 80 7E        BRA Local_C1BCE0
...
C1/BCB4: 20 3A CE     JSR Routine_C1CE3A
...
C1/BCD5: 20 15 CF     JSR Routine_C1CF15
C1/BCD8: 22 F2 AE FD  JSR Routine_FDAEF2
