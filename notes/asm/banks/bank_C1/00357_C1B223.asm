...
C1/B251: D0 0A        BNE Local_C1B25D
...
C1/B265: 90 C0        BCC Local_C1B227
C1/B267: 7B           TDC
C1/B268: AA           TAX
Local_C1B269:
C1/B269: BD FF AE     LDA $AEFF,X
C1/B26C: 10 0A        BPL Local_C1B278
C1/B26E: E8           INX
C1/B26F: E0 03 00     CPX #$0003
C1/B272: 90 F5        BCC Local_C1B269
