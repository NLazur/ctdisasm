...
C1/CE08: D0 F7        BNE Local_C1CE01
C1/CE0A: 7B           TDC
C1/CE0B: AA           TAX
...
C1/CE1A: D0 06        BNE Local_C1CE22
C1/CE1C: 22 1C B0 FD  JSR Routine_FDB01C
C1/CE20: 80 0C        BRA Local_C1CE2E
C1/CE22: BD 00 25     LDA $2500,X
C1/CE25: 85 0E        STA $0E
C1/CE27: BD 00 24     LDA $2400,X
C1/CE2A: 22 80 AF FD  JSR Routine_FDAF80
C1/CE2E: A5 08        LDA $08
C1/CE30: F0 03        BEQ Local_C1CE35
C1/CE32: 4C 14 CE     JMP Local_C1CE14
C1/CE35: 60           RTS