...
C1/8AA6: D0 03        BNE Local_C18AAB
...
C1/8ACE: F0 07        BEQ Local_C18AD7
...
C1/8ADC: F0 07        BEQ Local_C18AE5
...
C1/8AF8: F0 15        BEQ Local_C18B0F
...
C1/8B09: 20 F8 EB     JSR Routine_C1EBF8
C1/8B0C: 20 7F EC     JSR Routine_C1EC7F
Local_C18B0F:
C1/8B0F: 60           RTS