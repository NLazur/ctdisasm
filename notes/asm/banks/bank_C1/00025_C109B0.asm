...
C1/09BA: D0 03        BNE $09BF
C1/09BC: 4C 87 0A     JMP $0A87
...
C1/09E2: 20 A9 01     JSR $01A9
C1/09E5: A6 80        LDX $80
C1/09E7: BD 82 15     LDA $1582,X
C1/09EA: 10 0F        BPL $09FB
...
C1/0A41: 20 74 01     JSR $0174
C1/0A44: 20 4E 10     JSR $104E
