...
C1/3BCA: F0 08        BEQ $3BD4
C1/3BCC: BD 86 97     LDA $9786,X
C1/3BCF: 85 DB        STA $DB
C1/3BD1: 4C 81 3C     JMP $3C81
...
C1/3C40: DB           STP
C1/3C41: 20 18 01     JSR $0118
C1/3C44: 85 84        STA $84
C1/3C46: 29 02 D0     AND #$D002
C1/3C49: 18           CLC
C1/3C4A: A5 84        LDA $84
C1/3C4C: D0 0A        BNE $3C58
C1/3C4E: A5 81        LDA $81
C1/3C50: F0 28        BEQ $3C7A
C1/3C52: A5 83        LDA $83
C1/3C54: F0 24        BEQ $3C7A
C1/3C56: 80 29        BRA $3C81
C1/3C58: A5 81        LDA $81
C1/3C5A: 30 1E        BMI $3C7A
C1/3C5C: A5 83        LDA $83
C1/3C5E: F0 1A        BEQ $3C7A
C1/3C60: 80 1F        BRA $3C81
C1/3C62: A5 84        LDA $84
C1/3C64: 29 01 D0     AND #$D001
C1/3C67: 0A           ASL
C1/3C68: A5 81        LDA $81
C1/3C6A: 30 0E        BMI $3C7A
C1/3C6C: A5 83        LDA $83
C1/3C6E: 30 0A        BMI $3C7A
C1/3C70: 80 0F        BRA $3C81
C1/3C72: A5 81        LDA $81
C1/3C74: F0 04        BEQ $3C7A
C1/3C76: A5 83        LDA $83
C1/3C78: F0 07        BEQ $3C81
C1/3C7A: 18           CLC
...
C1/3CFD: 20 26 29     JSR $2926
C1/3D00: 30 0C        BMI $3D0E
C1/3D02: AD B5 A2     LDA $A2B5
C1/3D05: C9 0F F0     CMP #$F00F
C1/3D08: 27 20        AND [$20]
C1/3D0A: B0 28        BCS $3D34
C1/3D0C: 10 22        BPL $3D30
