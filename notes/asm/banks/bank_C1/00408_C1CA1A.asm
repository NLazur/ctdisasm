...
C1/CA63: 20 93 CB     JSR Local_C1CB93
C1/CA66: 7B           TDC
...
C1/CACB: 20 48 CB     JSR Local_C1CB48
C1/CACE: A8           TAY
C1/CACF: 7B           TDC
C1/CAD0: AD EA B2     LDA $B2EA
C1/CAD3: 20 0B CC     JSR Local_C1CC0B
C1/CAD6: 7B           TDC
C1/CAD7: A5 08        LDA $08
C1/CAD9: 20 61 CB     JSR Local_C1CB61
C1/CADC: A8           TAY
C1/CADD: 7B           TDC
C1/CADE: AD EB B2     LDA $B2EB
C1/CAE1: 20 0B CC     JSR Local_C1CC0B
