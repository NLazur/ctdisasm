...
C1/B300: 20 60 BC     JSR Local_C1BC60
...
C1/B329: 20 0B C9     JSR Local_C1C90B
...
C1/B33B: 20 9F E8     JSR Local_C1E89F
...
C1/B35A: 20 F8 EB     JSR Local_C1EBF8
...
C1/B373: 20 09 AD     JSR Local_C1AD09
C1/B376: 20 57 AC     JSR Local_C1AC57
C1/B379: 7B           TDC
