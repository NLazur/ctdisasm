...
C1/41D1: F0 1F        BEQ Local_C141F2
C1/41D3: C9 03 00     CMP #$0003
C1/41D6: D0 1A        BNE Local_C141F2
C1/41D8: BD 30 5E     LDA $5E30,X
C1/41DB: F0 15        BEQ Local_C141F2
C1/41DD: B9 9C AD     LDA $AD9C,Y
C1/41E0: F0 10        BEQ Local_C141F2
C1/41E2: 49 FF FF     EOR #$FFFF
C1/41E5: 1A           INC
C1/41E6: 18           CLC
C1/41E7: 7D 30 5E     ADC $5E30,X
C1/41EA: F0 02        BEQ Local_C141EE
C1/41EC: B0 04        BCS Local_C141F2
...
C1/41FD: D0 CA        BNE Local_C141C9
C1/41FF: 7B           TDC
