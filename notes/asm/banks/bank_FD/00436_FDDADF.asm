...
FD/DB3E: 20 BD DC     JSR Local_FDDCBD
...
FD/DB7D: 20 8B EB     JSR Local_FDEB8B
FD/DB80: 20 23 F1     JSR Local_FDF123
FD/DB83: A4 1B        LDY $1B
FD/DB85: C0 FF        CPY #$FF
FD/DB87: 02 F0        COP $F0
FD/DB89: 03 4C        ORA $4C,S
FD/DB8B: 24 DB        BIT $DB
FD/DB8D: 20 C8 EA     JSR Local_FDEAC8
FD/DB90: 20 B7 EA     JSR Local_FDEAB7
...
FD/DBB8: 20 F4 EA     JSR Local_FDEAF4
FD/DBBB: 20 13 EB     JSR Local_FDEB13
FD/DBBE: 20 A6 EA     JSR Local_FDEAA6
...
FD/DBF1: F0 20        BEQ Local_FDDC13
...
FD/DC18: 20 C1 F1     JSR Local_FDF1C1
FD/DC1B: 20 C0 EC     JSR Local_FDECC0
...
FD/DC5C: 1A           INC
FD/DC5D: 20 D5 EC     JSR Local_FDECD5
...
FD/DCA3: 20 91 EC     JSR Local_FDEC91
FD/DCA6: 64 24        STZ $24
FD/DCA8: 64 23        STZ $23
FD/DCAA: 20 8B EB     JSR Local_FDEB8B
FD/DCAD: E6 24        INC $24
FD/DCAF: 20 8B EB     JSR Local_FDEB8B
FD/DCB2: 20 89 ED     JSR Local_FDED89
FD/DCB5: 20 DA EA     JSR Local_FDEADA
