...
FD/3ACD: F0 7F        BEQ Local_FD3B4E
FD/3ACF: F0 24        BEQ Local_FD3AF5
FD/3AD1: 9F 60 D6 00  STA $00D660,X
FD/3AD5: 30 37        BMI Local_FD3B0E
FD/3AD7: 3C 03 8F     BIT Local_FD8F03,X
FD/3ADA: F0 01        BEQ Local_FD3ADD
FD/3ADC: 0A           ASL
...
FD/3B0D: 08           PHP
FD/3B0E: 30 10        BMI Local_FD3B20
FD/3B10: 44 A0 04     MVP $A0,$04
FD/3B13: FC 03 02     JSR ($0203,X)
FD/3B16: 10 F8        BPL Local_FD3B10
...
FD/3B2E: 2C 00 D5     BIT Local_FDD500
...
FD/3B56: 30 00        BMI Local_FD3B58
FD/3B58: FF F1 FE E3  SBC $E3FEF1,X
FD/3B5C: 10 FC        BPL Local_FD3B5A
