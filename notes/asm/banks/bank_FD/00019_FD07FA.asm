...
FD/085B: 22 44 33 44  JSR $443344
FD/085F: 78           SEI
...
FD/0873: 22 96 34 02  JSR $023496
...
FD/089F: F0 10        BEQ $08B1
FD/08A1: 10 3F        BPL $08E2
FD/08A3: 3B           TSC
FD/08A4: 01 2C        ORA ($2C,X)
FD/08A6: 23 04        AND $04,S
FD/08A8: F0 44        BEQ $08EE
FD/08AA: 93 01        STA ($01,S),Y
FD/08AC: F0 5F        BEQ $090D
...
FD/08BF: 22 68 22 04  JSR $042268
FD/08C3: 30 76        BMI $093B
...
FD/09FF: 22 22 43 23  JSR $234322
FD/0A03: 23 42        AND $42,S
FD/0A05: 44 08 22     MVP $08,$22
FD/0A08: 22 22 D8 04  JSR $04D822
