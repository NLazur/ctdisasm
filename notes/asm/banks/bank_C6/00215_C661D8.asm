...
C6/626C: 20 2E 00     JSR $002E
C6/626F: 00 A1        BRK $A1
C6/6271: 2E 06 08     ROL $0806
C6/6274: D0 36        BNE $62AC
...
C6/62B1: 6A           ROR
C6/62B2: 22 1C 20 00  JSR $00201C
...
C6/62C3: 4A           LSR
C6/62C4: 22 4B 22 00  JSR $00224B
C6/62C8: 5A           PHY
C6/62C9: 22 0C 20 4C  JSR $4C200C
C6/62CD: 22 4D 22 08  JSR $08224D
C6/62D1: 0D 20 0E     ORA $0E20
C6/62D4: 1C 00 90     TRB $9000
C6/62D7: 22 00 00 20  JSR $200000
C6/62DB: 91 22        STA ($22),Y
C6/62DD: D7 2C        CMP [$2C],Y
C6/62DF: D8           CLD
C6/62E0: 58           CLI
C6/62E1: 10 DF        BPL $62C2
