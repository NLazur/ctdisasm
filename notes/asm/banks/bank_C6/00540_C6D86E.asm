...
C6/D8B1: 20 1F 00     JSR $001F
C6/D8B4: 43 BA        EOR $BA,S
C6/D8B6: 00 FD        BRK $FD
C6/D8B8: D2 08        CMP ($08)
C6/D8BA: 22 10 08 40  JSR $400810
C6/D8BE: B0 00        BCS $D8C0
C6/D8C0: 98           TYA
C6/D8C1: 00 00        BRK $00
C6/D8C3: 22 01 C0 1E  JSR $1EC001
C6/D8C7: 18           CLC
C6/D8C8: 20 00 01     JSR $0100
C6/D8CB: 08           PHP
C6/D8CC: 72 02        ADC ($02)
C6/D8CE: 2A           ROL
C6/D8CF: 80 12        BRA $D8E3
C6/D8D1: 11 1E        ORA ($1E),Y
C6/D8D3: 00 1F        BRK $1F
C6/D8D5: 18           CLC
C6/D8D6: 22 08 02 3D  JSR $3D0208
C6/D8DA: 4C 68 21     JMP $2168
C6/D8DD: 20 00 46     JSR $4600
C6/D8E0: 00 41        BRK $41
C6/D8E2: 20 6A 78     JSR $786A
C6/D8E5: 11 21        ORA ($21),Y
C6/D8E7: 1F 68 20 02  ORA $022068,X
C6/D8EB: 00 80        BRK $80
C6/D8ED: B8           CLV
C6/D8EE: 01 F8        ORA ($F8,X)
C6/D8F0: B0 30        BCS $D922
...
C6/D900: 10 FB        BPL $D8FD
C6/D902: F4 48 B4     PEA $B448
C6/D905: 48           PHA
C6/D906: 20 3F 18     JSR $183F
