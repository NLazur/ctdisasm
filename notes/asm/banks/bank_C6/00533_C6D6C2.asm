...
C6/D6D7: 98           TYA
C6/D6D8: 10 51        BPL Local_C6D72B
C6/D6DA: 20 00 00     JSR Local_C60000
C6/D6DD: 10 10        BPL Local_C6D6EF
C6/D6DF: 3C 01 01     BIT Local_C60101,X
C6/D6E2: E0 B8        CPX #$B8
C6/D6E4: 20 00 68     JSR Local_C66800
C6/D6E7: 01 40        ORA ($40,X)
C6/D6E9: 51 00        EOR ($00),Y
C6/D6EB: 22 C6 02 FD  JSR Routine_FD02C6
C6/D6EF: B0 AD        BCS Local_C6D69E
C6/D6F1: 01 14        ORA ($14,X)
C6/D6F3: 10 41        BPL Local_C6D736
...
C6/D720: 10 33        BPL Local_C6D755
