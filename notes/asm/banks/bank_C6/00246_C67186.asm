...
C6/7191: 30 6E        BMI Local_C67201
...
C6/71B7: B0 97        BCS Local_C67150
C6/71B9: 99 3D 97     STA $973D,Y
C6/71BC: A9 0C A5     LDA #$A50C
C6/71BF: 3C BD 7B     BIT Local_C67BBD,X
C6/71C2: B6 00        LDX $00,Y
C6/71C4: 10 7E        BPL Local_C67244
...
C6/7209: 10 2A        BPL Local_C67235
...
C6/721B: F0 23        BEQ Local_C67240
...
C6/7231: 3C 54 53     BIT Local_C65354,X
...
C6/72AD: F0 E3        BEQ Local_C67292
