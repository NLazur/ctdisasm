...
C6/4BFB: 8B           PHB
C6/4BFC: 90 7A        BCC Local_C64C78
C6/4BFE: 00 90        BRK $90
C6/4C00: 7B           TDC
C6/4C01: 90 72        BCC Local_C64C75
C6/4C03: 10 73        BPL Local_C64C78
C6/4C05: 10 82        BPL Local_C64B89
C6/4C07: 21 5E        AND ($5E,X)
C6/4C09: 00 90        BRK $90
C6/4C0B: 90 91        BCC Local_C64B9E
C6/4C0D: 90 94        BCC Local_C64BA3
C6/4C0F: 08           PHP
C6/4C10: 7A           PLY
C6/4C11: 10 02        BPL Local_C64C15
C6/4C13: 7B           TDC
C6/4C14: 6C 00 8B     JMP ($8B00)
C6/4C17: 10 A1        BPL Local_C64BBA
C6/4C19: 28           PLP
...
C6/4C25: 80 B3        BRA Local_C64BDA
C6/4C27: 28           PLP
...
C6/4C33: 20 3B 20     JSR Local_C6203B
C6/4C36: 4A           LSR
C6/4C37: 20 00 4B     JSR Local_C64B00
C6/4C3A: 20 3C 20     JSR Local_C6203C
C6/4C3D: 3D 20 4C     AND $4C20,X
C6/4C40: 20 00 4D     JSR Local_C64D00
C6/4C43: 20 3B 60     JSR Local_C6603B
C6/4C46: 3A           DEC
C6/4C47: 60           RTS