...
C6/6060: 4C E4 4C     JMP Routine_C64CE4
...
C6/6076: 4C C8 4C     JMP Routine_C64CC8
...
C6/60A9: F8           SED
C6/60AA: 10 98        BPL Routine_C66044
C6/60AC: 88           DEY
C6/60AD: A8           TAY
C6/60AE: 88           DEY
...
C6/60C9: 82 43 06     BRL Routine_C6670F
C6/60CC: 00 7A        BRK $7A
C6/60CE: 1B           TCS
C6/60CF: 44 1B 45     MVP $1B,$45
C6/60D2: 08           PHP
C6/60D3: 10 00        BPL Local_C660D5
Local_C660D5:
C6/60D5: 46 1B        LSR $1B
C6/60D7: 47 1B        EOR [$1B]
C6/60D9: 50 1B        BVC Local_C660F6
