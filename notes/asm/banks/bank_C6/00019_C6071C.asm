...
C6/072E: D0 67        BNE Local_C60797
...
C6/0754: 80 BF        BRA Local_C60715
C6/0756: 80 9F        BRA Local_C606F7
C6/0758: 90 BF        BCC Local_C60719
C6/075A: E1 00        SBC ($00,X)
C6/075C: EB           XBA
C6/075D: 30 C0        BMI Local_C6071F
C6/075F: 60           RTS