...
C6/6C82: 10 78        BPL Local_C66CFC
...
C6/6C90: 5A           PHY
C6/6C91: 10 1A        BPL Local_C66CAD
...
C6/6CC2: 90 1F        BCC Local_C66CE3
C6/6CC4: C9 D8 27     CMP #$27D8
C6/6CC7: A0 5A 7B     LDY #$7B5A
C6/6CCA: 48           PHA
C6/6CCB: FA           PLX
C6/6CCC: B5 40        LDA $40,X
C6/6CCE: 90 40        BCC Local_C66D10
C6/6CD0: 2A           ROL
C6/6CD1: 98           TYA
C6/6CD2: 10 12        BPL Local_C66CE6
C6/6CD4: 20 92 C7     JSR Local_C6C792
C6/6CD7: 40           RTI