...
C6/11C1: 4C FF CC     JMP Routine_C6CCFF
...
C6/11FC: 30 DF        BMI Routine_C611DD
C6/11FE: 20 DF 20     JSR Routine_C620DF
C6/1201: DB           STP
...
C6/125E: 10 06        BPL Routine_C61266
C6/1260: 1B           TCS
...
C6/1292: 70 FF        BVS Routine_C61293
...
C6/12BE: 20 DE 48     JSR Routine_C648DE
C6/12C1: F6 B8        INC $B8,X
C6/12C3: D0 00        BNE Local_C612C5
Local_C612C5:
C6/12C5: 78           SEI
C6/12C6: A8           TAY
C6/12C7: 50 60        BVC Routine_C61329
C6/12C9: F0 C0        BEQ Routine_C6128B
