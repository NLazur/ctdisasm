...
C6/C800: 10 20        BPL Routine_C6C822
C6/C802: 11 30        ORA ($30),Y
C6/C804: 00 12        BRK $12
C6/C806: 30 13        BMI Local_C6C81B
C6/C808: 30 14        BMI Routine_C6C81E
C6/C80A: 30 15        BMI Local_C6C821
C6/C80C: 30 30        BMI Routine_C6C83E
C6/C80E: 16 30        ASL $30,X
C6/C810: 17 30        ORA [$30],Y
C6/C812: 32 F8        AND ($F8)
C6/C814: 14 58        TRB $58
C6/C816: 20 30 00     JSR Routine_C60030
C6/C819: 21 30        AND ($30,X)
Local_C6C81B:
C6/C81B: 22 30 23 30  JSR Routine_302330
