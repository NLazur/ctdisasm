...
C6/C9A1: 30 55        BMI $C9F8
C6/C9A3: 30 56        BMI $C9FB
C6/C9A5: 30 57        BMI $C9FE
C6/C9A7: 30 00        BMI $C9A9
C6/C9A9: 58           CLI
C6/C9AA: 30 59        BMI $CA05
C6/C9AC: 30 5A        BMI $CA08
C6/C9AE: 30 5B        BMI $CA0B
C6/C9B0: 30 00        BMI $C9B2
C6/C9B2: 5C 30 5D 30  JMP $305D30
C6/C9B6: 5E 30 5F     LSR $5F30,X
C6/C9B9: 30 01        BMI $C9BC
C6/C9BB: 20 E8 60     JSR $60E8
C6/C9BE: 30 61        BMI $CA21
C6/C9C0: 30 62        BMI $CA24
C6/C9C2: 30 63        BMI $CA27
C6/C9C4: 00 30        BRK $30
C6/C9C6: 64 30        STZ $30
C6/C9C8: 65 30        ADC $30
C6/C9CA: 66 30        ROR $30
C6/C9CC: 67 00        ADC [$00]
C6/C9CE: 30 68        BMI $CA38
C6/C9D0: 30 69        BMI $CA3B
C6/C9D2: 30 6A        BMI $CA3E
C6/C9D4: 30 6B        BMI $CA41
C6/C9D6: 00 30        BRK $30
C6/C9D8: 6C 30 6D     JMP ($6D30)
C6/C9DB: 30 6E        BMI $CA4B
C6/C9DD: 30 6F        BMI $CA4E
C6/C9DF: 01 20        ORA ($20,X)
C6/C9E1: E0 A1 30     CPX #$30A1
C6/C9E4: 70 30        BVS $CA16
C6/C9E6: 71 30        ADC ($30),Y
C6/C9E8: 72 00        ADC ($00)
C6/C9EA: 30 73        BMI $CA5F
C6/C9EC: 30 74        BMI $CA62
C6/C9EE: 30 75        BMI $CA65
C6/C9F0: 30 76        BMI $CA68
C6/C9F2: 00 30        BRK $30
C6/C9F4: 77 30        ADC [$30],Y
C6/C9F6: 78           SEI
C6/C9F7: 30 79        BMI $CA72
C6/C9F9: 30 7A        BMI $CA75
C6/C9FB: 00 30        BRK $30
C6/C9FD: 7B           TDC
C6/C9FE: 30 7C        BMI $CA7C
C6/CA00: 30 7D        BMI $CA7F
C6/CA02: 30 7E        BMI $CA82
C6/CA04: 0C 30 7F     TSB $7F30
C6/CA07: 0A           ASL
C6/CA08: 30 28        BMI $CA32
C6/CA0A: 98           TYA
C6/CA0B: B1 30        LDA ($30),Y
C6/CA0D: 80 30        BRA $CA3F
C6/CA0F: 00 81        BRK $81
C6/CA11: 30 82        BMI $C995
C6/CA13: 30 83        BMI $C998
C6/CA15: 30 84        BMI $C99B
C6/CA17: 30 00        BMI $CA19
C6/CA19: 85 30        STA $30
C6/CA1B: 86 30        STX $30
C6/CA1D: 87 30        STA [$30]
C6/CA1F: 88           DEY
C6/CA20: 30 20        BMI $CA42
C6/CA22: 89 30 8A     BIT #$8A30
C6/CA25: 30 A0        BMI $C9C7
C6/CA27: 5A           PHY
C6/CA28: 00 A2        BRK $A2
C6/CA2A: 30 00        BMI $CA2C
C6/CA2C: A3 30        LDA $30,S
C6/CA2E: A4 30        LDY $30
C6/CA30: A5 30        LDA $30
C6/CA32: A6 30        LDX $30
C6/CA34: 00 A7        BRK $A7
C6/CA36: 30 A8        BMI $C9E0
C6/CA38: 30 A9        BMI $C9E3
C6/CA3A: 30 AA        BMI $C9E6
C6/CA3C: 30 20        BMI $CA5E
C6/CA3E: AB           PLB
C6/CA3F: 30 AC        BMI $C9ED
C6/CA41: 30 AD        BMI $C9F0
C6/CA43: 1C 50 C1     TRB $C150
C6/CA46: 30 00        BMI $CA48
C6/CA48: 90 30        BCC $CA7A
C6/CA4A: 91 30        STA ($30),Y
C6/CA4C: 92 30        STA ($30)
C6/CA4E: 93 30        STA ($30,S),Y
C6/CA50: 00 94        BRK $94
C6/CA52: 30 95        BMI $C9E9
C6/CA54: 30 96        BMI $C9EC
C6/CA56: 30 97        BMI $C9EF
C6/CA58: 30 80        BMI $C9DA
C6/CA5A: 98           TYA
C6/CA5B: 30 99        BMI $C9F6
C6/CA5D: 30 9A        BMI $C9F9
C6/CA5F: 30 B0        BMI $CA11
C6/CA61: 5A           PHY
...
C6/CA6E: 30 B7        BMI $CA27
C6/CA70: 30 B8        BMI $CA2A
C6/CA72: 30 B9        BMI $CA2D
C6/CA74: 30 80        BMI $C9F6
C6/CA76: BA           TSX
C6/CA77: 30 BB        BMI $CA34
C6/CA79: 30 BC        BMI $CA37
C6/CA7B: 30 BD        BMI $CA3A
...
C6/CA8B: 30 C5        BMI $CA52
C6/CA8D: 30 C6        BMI $CA55
C6/CA8F: 30 C7        BMI $CA58
C6/CA91: 30 C8        BMI $CA5B
C6/CA93: 00 30        BRK $30
C6/CA95: C9 30 CA     CMP #$CA30
C6/CA98: 30 CB        BMI $CA65
C6/CA9A: 30 CC        BMI $CA68
C6/CA9C: 8C 30 CD     STY $CD30
C6/CA9F: 1C 60 6A     TRB $6A60
C6/CAA2: C8           INY
C6/CAA3: BE 30 BF     LDX $BF30,Y
C6/CAA6: 7A           PLY
C6/CAA7: 30 8F        BMI $CA38
