...
C6/3CAD: 4C E2 00     JMP $00E2
C6/3CB0: 4C F2 0C     JMP $0CF2
C6/3CB3: E3 4C        SBC $4C,S
C6/3CB5: 2E 00 2F     ROL $2F00
C6/3CB8: 50 00        BVC $3CBA
C6/3CBA: 3E 00 3F     ROL $3F00,X
C6/3CBD: 30 00        BMI $3CBF
C6/3CBF: 8A           TXA
C6/3CC0: 32 00        AND ($00)
C6/3CC2: 9A           TXS
C6/3CC3: 16 00        ASL $00,X
C6/3CC5: 10 28        BPL $3CEF
C6/3CC7: 80 78        BRA $3D41
C6/3CC9: 64 C8        STZ $C8
C6/3CCB: 11 81        ORA ($81),Y
C6/3CCD: 08           PHP
C6/3CCE: 82 00 00     BRL $C63CD1
