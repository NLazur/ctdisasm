...
Routine_C6BE0B:
C6/BE0B: 70 30        BVS Local_C6BE3D
C6/BE0D: A0 BC 9B     LDY #$9BBC
C6/BE10: 2C 2D 2E     BIT Local_C62E2D
...
C6/BE23: F0 03        BEQ Local_C6BE28
...
C6/BE30: 90 BC        BCC Local_C6BDEE
C6/BE32: 9B           TXY
C6/BE33: 3C 3D A2     BIT Local_C6A23D,X
C6/BE36: 08           PHP
C6/BE37: 0B           PHD
...
C6/BE47: D0 72        BNE Local_C6BEBB
C6/BE49: 60           RTS