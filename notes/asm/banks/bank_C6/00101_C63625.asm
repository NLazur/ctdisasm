...
C6/3658: 58           CLI
C6/3659: 58           CLI
C6/365A: 10 B0        BPL $360C
C6/365C: 1B           TCS
C6/365D: 29 00 1E     AND #$1E00
C6/3660: A6 00        LDX $00
C6/3662: FA           PLX
C6/3663: 0B           PHD
C6/3664: 50 50        BVC $36B6
C6/3666: 30 04        BMI $366C
C6/3668: 08           PHP
...
C6/36B8: 90 35        BCC $36EF
C6/36BA: 80 68        BRA $3724
C6/36BC: 88           DEY
C6/36BD: 48           PHA
...
C6/36E3: 30 26        BMI $370B
C6/36E5: C8           INY
C6/36E6: 25 C8        AND $C8
C6/36E8: D0 2D        BNE $3717
C6/36EA: 58           CLI
C6/36EB: 68           PLA
C6/36EC: 70 1B        BVS $3709
C6/36EE: DC 71 1B     JMP [$1B71]
C6/36F1: 20 0D F0     JSR $F00D
...
C6/3701: 08           PHP
C6/3702: 70 28        BVS $372C
C6/3704: A0 2E        LDY #$2E
C6/3706: 50 68        BVC $3770
C6/3708: 08           PHP
C6/3709: F8           SED
