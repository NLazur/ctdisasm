...
C6/4C74: 5C 1E 26 1A  JMP $1A261E
...
C6/4C8C: 10 76        BPL $4D04
C6/4C8E: 10 85        BPL $4C15
C6/4C90: 10 86        BPL $4C18
C6/4C92: 10 01        BPL $4C95
C6/4C94: 10 28        BPL $4CBE
C6/4C96: 77 10        ADC [$10],Y
C6/4C98: 78           SEI
C6/4C99: 10 87        BPL $4C22
C6/4C9B: 10 88        BPL $4C25
...
C6/4D8F: 82 00 10     BRL $C65D92
C6/4D92: B1 08        LDA ($08),Y
C6/4D94: A4 08        LDY $08
C6/4D96: 7B           TDC
C6/4D97: 10 B4        BPL $4D4D
C6/4D99: 00 08        BRK $08
C6/4D9B: 8B           PHB
C6/4D9C: 10 5F        BPL $4DFD
