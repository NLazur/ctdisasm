...
C6/6764: 48           PHA
C6/6765: 22 49 88 04  JSR Routine_048849
C6/6769: 59 00 22     EOR $2200,Y
C6/676C: D0 20        BNE Local_C6678E
C6/676E: D1 20        CMP ($20),Y
C6/6770: E0 20        CPX #$20
C6/6772: E1 00        SBC ($00,X)
C6/6774: 20 D2 2C     JSR Local_C62CD2
C6/6777: D3 2C        CMP ($2C,S),Y
C6/6779: E2 20        SEP #$20
C6/677B: E3 20        SBC $20,S
C6/677D: 2C D4 2C     BIT Local_C62CD4
C6/6780: D5 2C        CMP $2C,X
C6/6782: 70 0C        BVS Local_C66790
C6/6784: D6 2C        DEC $2C,X
C6/6786: 20 D7 2C     JSR Local_C62CD7
C6/6789: E6 2C        INC $2C
C6/678B: E7 A6        SBC [$A6]
C6/678D: 04 D9        TSB $D9
C6/678F: 2C 00 E8     BIT Local_C6E800
C6/6792: 2C E9 2C     BIT Local_C62CE9
C6/6795: DA           PHX
C6/6796: 2C DB 30     BIT Local_C630DB
C6/6799: 00 EA        BRK $EA
C6/679B: 2C EB 2C     BIT Local_C62CEB
C6/679E: DC 30 DD     JMP [$DD30]
C6/67A1: 30 00        BMI Local_C667A3
C6/67A3: EC 2C ED     CPX $ED2C
C6/67A6: 2C DE 30     BIT Local_C630DE
C6/67A9: DF 30 00 EE  CMP $EE0030,X
C6/67AD: 2C EF 30     BIT Local_C630EF
C6/67B0: 50 31        BVC Local_C667E3
...
C6/68B3: D0 2D        BNE Local_C668E2
...
C6/68DE: 22 00 63 22  JSR Routine_226300
C6/68E2: F4 2E F5     PEA $F52E
C6/68E5: 2E F9 2E     ROL $2EF9
C6/68E8: 20 3E 2D     JSR Local_C62D3E
C6/68EB: B0 21        BCS Local_C6690E
...
C6/6936: F0 2D        BEQ Local_C66965
...
C6/6958: 2C 6D 0A     BIT Local_C60A6D
...
C6/6971: 22 10 22 11  JSR Routine_112210
C6/6975: 22 02 22 03  JSR Routine_032202
...
C6/698C: 22 16 22 17  JSR Routine_172216
C6/6990: 22 08 22 09  JSR Routine_092208
C6/6994: 00 22        BRK $22
C6/6996: 18           CLC
C6/6997: 22 19 22 0A  JSR Routine_0A2219
C6/699B: 22 0B 50 22  JSR Routine_22500B
C6/699F: 1A           INC
C6/69A0: 22 1B B6 05  JSR Routine_05B61B
C6/69A4: 0D B6 05     ORA $05B6
C6/69A7: 1D 00 22     ORA $2200,X
C6/69AA: 0E 22 0F     ASL $0F22
C6/69AD: 22 1E 22 1F  JSR Routine_1F221E
C6/69B1: 00 22        BRK $22
C6/69B3: 20 22 41     JSR Local_C64122
...
C6/69CC: 2C 7D B4     BIT Local_C6B47D
C6/69CF: 16 E4        ASL $E4,X
C6/69D1: 2C F4 0B     BIT Local_C60BF4
C6/69D4: 3C 0F 0B     BIT Local_C60B0F,X
C6/69D7: BC 0E 44     LDY $440E,X
C6/69DA: 1E 21 20     ASL $2021,X
C6/69DD: 07 31        ORA [$31]
C6/69DF: 22 22 22 08  JSR Routine_082222
C6/69E3: 23 22        AND $22,S
C6/69E5: 32 2A        AND ($2A)
C6/69E7: 07 24        ORA [$24]
C6/69E9: 22 25 3E 00  JSR Routine_003E25
C6/69ED: 00 00        BRK $00
C6/69EF: 35 3E        AND $3E,X
C6/69F1: 26 22        ROL $22
C6/69F3: 27 22        AND [$22]
C6/69F5: 00 36        BRK $36
C6/69F7: 22 37 22 28  JSR Routine_282237
C6/69FB: 22 29 22 00  JSR Routine_002229
C6/69FF: 38           SEC
C6/6A00: 22 39 22 2A  JSR Routine_2A2239
C6/6A04: 22 2B 22 2A  JSR Routine_2A222B
C6/6A08: 3A           DEC
C6/6A09: B2 05        LDA ($05)
C6/6A0B: 2C B2 05     BIT Local_C605B2
C6/6A0E: 3C B2 05     BIT Local_C605B2,X
