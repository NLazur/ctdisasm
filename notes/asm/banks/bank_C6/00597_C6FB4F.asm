...
C6/FB7C: 10 2D        BPL $FBAB
C6/FB7E: 10 2E        BPL $FBAE
...
C6/FC09: 20 8B 1C     JSR $1C8B
C6/FC0C: F0 14        BEQ $FC22
...
C6/FC19: 80 46        BRA $FC61
C6/FC1B: 4A           LSR
C6/FC1C: 2D C6 1C     AND $1CC6
C6/FC1F: 21 08        AND ($08,X)
C6/FC21: 16 50        ASL $50,X
C6/FC23: F3 40        SBC ($40,S),Y
C6/FC25: F0 3E        BEQ $FC65
C6/FC27: 90 19        BCC $FC42
C6/FC29: 0A           ASL
C6/FC2A: 20 F0 1E     JSR $1EF0
C6/FC2D: 90 60        BCC $FC8F
C6/FC2F: 10 80        BPL $FBB1
C6/FC31: D0 99        BNE $FBCC
C6/FC33: 1E 90 F0     ASL $F090,X
C6/FC36: 14 20        TRB $20
C6/FC38: F0 1E        BEQ $FC58
C6/FC3A: 90 48        BCC $FC84
C6/FC3C: 20 20 F0     JSR $F020
