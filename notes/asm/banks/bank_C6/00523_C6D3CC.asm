...
Routine_C6D3CC:
C6/D3CC: D0 3C        BNE Routine_C6D40A
C6/D3CE: F8           SED
C6/D3CF: 10 80        BPL Routine_C6D351
C6/D3D1: E0 20        CPX #$20
C6/D3D3: E1 20        SBC ($20,X)
C6/D3D5: 80 27        BRA Routine_C6D3FE
C6/D3D7: 20 27 60     JSR Routine_C66027
...
C6/D40D: 10 70        BPL Routine_C6D47F
C6/D40F: 40           RTI