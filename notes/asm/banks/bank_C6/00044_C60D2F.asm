...
C6/0D34: 50 3A        BVC Routine_C60D70
C6/0D36: 28           PLP
C6/0D37: 08           PHP
C6/0D38: 00 F8        BRK $F8
C6/0D3A: 02 D8        COP $D8
C6/0D3C: 76 04        ROR $04,X
C6/0D3E: 80 E0        BRA Routine_C60D20
C6/0D40: E0 30 70     CPX #$7030
C6/0D43: 30 B8        BMI Routine_C60CFD
C6/0D45: 30 10        BMI Routine_C60D57
C6/0D47: 10 D8        BPL Routine_C60D21
C6/0D49: 31 92        AND ($92),Y
C6/0D4B: 15 E6        ORA $E6,X
C6/0D4D: 51 02        EOR ($02),Y
C6/0D4F: 01 00        ORA ($00,X)
C6/0D51: D0 04        BNE Routine_C60D57
