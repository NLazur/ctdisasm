...
D1/FEB3: 48           PHA
D1/FEB4: AB           PLB
D1/FEB5: 8D 0C 42     STA $420C
D1/FEB8: AD 12 42     LDA $4212
D1/FEBB: 29 40        AND #$40
D1/FEBD: F0 F9        BEQ $FEB8
D1/FEBF: A9 80        LDA #$80
D1/FEC1: 8D 00 21     STA $2100
D1/FEC4: A5 7C        LDA $7C
D1/FEC6: 29 01        AND #$01
D1/FEC8: D0 09        BNE $FED3
D1/FECA: A9 7E        LDA #$7E
D1/FECC: 48           PHA
D1/FECD: AB           PLB
D1/FECE: 20 4C FE     JSR $FE4C
D1/FED1: 80 0C        BRA $FEDF
D1/FED3: AF 02 CD 7E  LDA $7ECD02
D1/FED7: D0 06        BNE $FEDF
D1/FED9: 08           PHP
D1/FEDA: 22 FD FF FD  JSR $FDFFFD
D1/FEDE: 28           PLP
D1/FEDF: A2 00 00     LDX #$0000
D1/FEE2: DA           PHX
D1/FEE3: 2B           PLD
D1/FEE4: E2 20        SEP #$20
D1/FEE6: 22 71 FE D1  JSR $D1FE71
