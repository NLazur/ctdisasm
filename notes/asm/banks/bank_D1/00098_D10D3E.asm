...
D1/0D6C: 20 01 22     JSR Local_D12201
...
D1/0D7E: 80 2E        BRA Local_D10DAE
D1/0D80: 01 FF        ORA ($FF,X)
D1/0D82: FF 11 80 2A  SBC $2A8011,X
D1/0D86: 4C 06 18     JMP Local_D11806
...
D1/0D96: 10 6C        BPL Local_D10E04
