...
CC/2176: 80 80        BRA $20F8
CC/2178: 10 04        BPL $217E
CC/217A: 80 03        BRA $217F
CC/217C: 00 00        BRK $00
CC/217E: 00 00        BRK $00
CC/2180: 03 3C        ORA $3C,S
CC/2182: 70 00        BVS $2184
CC/2184: 0E 00 00     ASL $0000
CC/2187: 01 CA        ORA ($CA,X)
CC/2189: 80 00        BRA $218B
...
CC/225A: 50 00        BVC $225C
CC/225C: 20 00 80     JSR $8000
...
CC/2272: 80 80        BRA $21F4
CC/2274: 0B           PHD
CC/2275: 04 80        TSB $80
CC/2277: 00 0E        BRK $0E
CC/2279: 80 00        BRA $227B
...
CC/2296: 80 00        BRA $2298
CC/2298: 15 04        ORA $04,X
CC/229A: 80 00        BRA $229C
CC/229C: 0A           ASL
CC/229D: 80 00        BRA $229F
