...
C3/C790: 50 5A        BVC Local_C3C7EC
...
C3/C7AC: 2C 60 9B     BIT Local_C39B60
C3/C7AF: 2C 00 88     BIT Local_C38800
C3/C7B2: 28           PLP
...
C3/C7BE: 20 40 03     JSR Local_C30340
C3/C7C1: 0B           PHD
C3/C7C2: CA           DEX
...
C3/C7DE: 80 74        BRA Local_C3C854
