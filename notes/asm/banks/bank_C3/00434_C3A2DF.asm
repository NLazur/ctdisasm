...
C3/A2F8: 82 32 20     BRL $C3C32D
C3/A2FB: 82 32 64     BRL $C30730
C3/A2FE: AD 82 32     LDA $3282
C3/A301: 20 82 42     JSR $4282
C3/A304: 34 00        BIT $00,X
C3/A306: 6C C9 00     JMP ($00C9)
C3/A309: E7 CD        SBC [$CD]
C3/A30B: 00 7E        BRK $7E
C3/A30D: 26 34        ROL $34
C3/A30F: 80 FF        BRA $A310
C3/A311: F0 FF        BEQ $A312
C3/A313: 80 68        BRA $A37D
C3/A315: 00 FD        BRK $FD
C3/A317: 80 FB        BRA $A314
C3/A319: 10 28        BPL $A343
...
C3/A359: 2A           ROL
C3/A35A: 70 24        BVS $A380
C3/A35C: 20 43 24     JSR $2443
C3/A35F: 10 82        BPL $A2E3
...
C3/A36F: 30 A2        BMI $A313
C3/A371: A8           TAY
C3/A372: 4C 00 02     JMP $0200
C3/A375: 36 4C        ROL $4C,X
C3/A377: 4C 10 79     JMP $7910
C3/A37A: 4C 30 83     JMP $8330
...
C3/A3CE: 68           PLA
C3/A3CF: 20 00 05     JSR $0500
C3/A3D2: 51 00        EOR ($00),Y
C3/A3D4: E1 16        SBC ($16,X)
C3/A3D6: 01 B0        ORA ($B0,X)
C3/A3D8: CF 40 00 FD  CMP $FD0040
C3/A3DC: 50 DE        BVC $A3BC
C3/A3DE: 10 F8        BPL $A3D8
C3/A3E0: 90 39        BCC $A41B
C3/A3E2: 20 41 71     JSR $7141
