...
C3/4206: B0 3F        BCS Local_C34247
C3/4208: DA           PHX
...
C3/4219: 20 14 1D     JSR Local_C31D14
C3/421C: 50 8D        BVC Local_C341AB
C3/421E: 2D 0A 10     AND $100A
C3/4221: 90 22        BCC Local_C34245
...
C3/42A2: 20 DA 20     JSR Local_C320DA
C3/42A5: 80 4D        BRA Local_C342F4
C3/42A7: 6C FA C2     JMP ($C2FA)
C3/42AA: 20 BF B6     JSR Local_C3B6BF
C3/42AD: 10 20        BPL Local_C342CF
