...
C3/4206: B0 3F        BCS Routine_C34247
C3/4208: DA           PHX
...
C3/4219: 20 14 1D     JSR Routine_C31D14
C3/421C: 50 8D        BVC Routine_C341AB
C3/421E: 2D 0A 10     AND $100A
C3/4221: 90 22        BCC Routine_C34245
...
C3/423B: 82 08 20     BRL Routine_C36246
...
C3/4269: 22 C0 20 4B  JSR Routine_4B20C0
C3/426D: 2B           PLD
C3/426E: 49 22        EOR #$22
C3/4270: 10 00        BPL Local_C34272
Local_C34272:
C3/4272: 22 70 65 45  JSR Routine_456570
C3/4276: 82 14 7E     BRL Routine_C3C08D
...
C3/42A2: 20 DA 20     JSR Routine_C320DA
C3/42A5: 80 4D        BRA Routine_C342F4
C3/42A7: 6C FA C2     JMP ($C2FA)
C3/42AA: 20 BF B6     JSR Routine_C3B6BF
C3/42AD: 10 20        BPL Routine_C342CF
