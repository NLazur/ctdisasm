...
C3/36C4: D0 02        BNE $36C8
C3/36C6: 03 10        ORA $10,S
C3/36C8: 20 66 18     JSR $1866
...
C3/36F7: 70 44        BVS $373D
C3/36F9: 45 85        EOR $85
C3/36FB: 5C 12 2F 5E  JMP $5E2F12
