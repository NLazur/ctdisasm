...
C3/0FC3: 28           PLP
C3/0FC4: 90 1D        BCC Local_C30FE3
C3/0FC6: 9F 00 00 7F  STA $7F0000,X
C3/0FCA: C8           INY
C3/0FCB: C8           INY
C3/0FCC: A5 F0        LDA $F0
C3/0FCE: F0 2E        BEQ Local_C30FFE
...
C3/0FDA: F0 22        BEQ Local_C30FFE
C3/0FDC: 0A           ASL
C3/0FDD: 3A           DEC
C3/0FDE: 54 7F 7F     MVN $7F,$7F
C3/0FE1: 80 1B        BRA Local_C30FFE
C3/0FE3: 9F 00 00 7E  STA $7E0000,X
C3/0FE7: C8           INY
C3/0FE8: C8           INY
C3/0FE9: A5 F0        LDA $F0
C3/0FEB: F0 11        BEQ Local_C30FFE
...
C3/0FF7: F0 05        BEQ Local_C30FFE
C3/0FF9: 0A           ASL
C3/0FFA: 3A           DEC
C3/0FFB: 54 7E 7E     MVN $7E,$7E
C3/0FFE: 4C BA 10     JMP Local_C310BA
...
C3/1041: F0 BE        BEQ Local_C31001
C3/1043: B0 14        BCS Local_C31059
...
C3/108F: D0 E5        BNE Local_C31076
C3/1091: 80 27        BRA Local_C310BA
...
C3/10A1: 30 05        BMI Local_C310A8
C3/10A3: CA           DEX
C3/10A4: E5 FA        SBC $FA
C3/10A6: 10 FB        BPL Local_C310A3
...
C3/10B8: D0 E5        BNE Local_C3109F
C3/10BA: 7B           TDC
C3/10BB: EB           XBA
C3/10BC: 28           PLP
C3/10BD: AB           PLB
