...
C3/33CD: 3A           DEC
C3/33CE: 30 02        BMI Local_C333D2
C3/33D0: D0 0C        BNE Local_C333DE
Local_C333D2:
...
C3/33F3: 90 01        BCC Local_C333F6
C3/33F5: 78           SEI
Local_C333F6:
C3/33F6: 00 C0        BRK $C0
C3/33F8: 80 00        BRA Local_C333FA
Local_C333FA:
C3/33FA: D0 F4        BNE Local_C333F0
C3/33FC: AB           PLB
C3/33FD: 88           DEY
C3/33FE: 00 88        BRK $88
C3/3400: A5 F0        LDA $F0
C3/3402: 45 F2        EOR $F2
C3/3404: F0 18        BEQ Local_C3341E
C3/3406: 98           TYA
...
C3/3418: F0 25        BEQ Routine_C3343F
