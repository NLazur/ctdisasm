...
C3/76A6: 50 FF        BVC Local_C376A7
C3/76A8: 3C 35 68     BIT Local_C36835,X
...
C3/76EC: 3C 25 D0     BIT Local_C3D025,X
...
C3/774F: 20 4C 2C     JSR Local_C32C4C
...
C3/77D4: 28           PLP
C3/77D5: 20 0B 07     JSR Local_C3070B
...
C3/7820: D0 5B        BNE Local_C3787D
...
C3/7832: 20 41 44     JSR Local_C34441
...
C3/784C: 0A           ASL
C3/784D: 0A           ASL
C3/784E: 10 48        BPL Local_C37898
C3/7850: 40           RTI