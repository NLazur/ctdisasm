...
C3/53A5: 50 21        BVC Local_C353C8
...
C3/53D3: D0 08        BNE Routine_C353DD
C3/53D5: 5C 36 E0 08  JMP Routine_08E036
C3/53D9: 5E 00 36     LSR $3600,X
C3/53DC: F0 08        BEQ Local_C353E6
C3/53DE: 5E 76 00     LSR $0076,X
C3/53E1: 08           PHP
C3/53E2: 5C 00 76 10  JMP Routine_107600
Local_C353E6:
C3/53E6: 08           PHP
C3/53E7: 5A           PHY
...
C3/53F2: C8           INY
C3/53F3: 10 69        BPL Routine_C3545E
C3/53F5: 00 64        BRK $64
C3/53F7: 30 10        BMI Routine_C35409
C3/53F9: 68           PLA
C3/53FA: 64 38        STZ $38
C3/53FC: 10 7F        BPL Routine_C3547D
...
C3/5437: 20 8F 64     JSR Routine_C3648F
Local_C3543A:
C3/543A: 00 20        BRK $20
C3/543C: 0B           PHD
C3/543D: 00 70        BRK $70
C3/543F: 30 E0        BMI Local_C35421
C3/5441: F8           SED
C3/5442: 70 70        BVS Routine_C354B4
C3/5444: 10 F8        BPL Routine_C3543E
C3/5446: 00 72        BRK $72
C3/5448: 30 F0        BMI Local_C3543A
C3/544A: F8           SED
C3/544B: 72 70        ADC ($70)
C3/544D: 00 F8        BRK $F8
C3/544F: 00 40        BRK $40
C3/5451: 20 E0 F0     JSR Routine_C3F0E0
C3/5454: 40           RTI