...
C3/5927: 30 A0        BMI Local_C358C9
C3/5929: 14 E2        TRB $E2
C3/592B: 20 7B 8D     JSR Local_C38D7B
...
C3/594F: F0 A0        BEQ Local_C358F1
...
C3/597A: 20 D3 3E     JSR Local_C33ED3
...
C3/598D: 20 CE 04     JSR Local_C304CE
...
C3/59C7: 4C 85 15     JMP Local_C31585
