...
C3/9EA5: 30 60        BMI Local_C39F07
C3/9EA7: 57 00        EOR [$00],Y
C3/9EA9: 3C 60 57     BIT Local_C35760,X
C3/9EAC: 00 51        BRK $51
C3/9EAE: 48           PHA
C3/9EAF: 50 1A        BVC Local_C39ECB
...
C3/9EC4: 9A           TXS
C3/9EC5: 28           PLP
C3/9EC6: 10 02        BPL Local_C39ECA
C3/9EC8: 38           SEC
...
C3/9EEC: 10 7F        BPL Local_C39F6D
