...
C3/A4A4: 10 0D        BPL $A4B3
C3/A4A6: 11 80        ORA ($80),Y
C3/A4A8: 01 0E        ORA ($0E,X)
C3/A4AA: 02 B0        COP $B0
C3/A4AC: 30 30        BMI $A4DE
C3/A4AE: 80 39        BRA $A4E9
C3/A4B0: 00 8B        BRK $8B
C3/A4B2: 50 13        BVC $A4C7
C3/A4B4: 50 81        BVC $A437
...
C3/A4C7: 18           CLC
C3/A4C8: 80 60        BRA $A52A
C3/A4CA: 24 80        BIT $80
C3/A4CC: 80 30        BRA $A4FE
C3/A4CE: 80 8A        BRA $A45A
C3/A4D0: A0 3C        LDY #$3C
C3/A4D2: 80 C0        BRA $A494
C3/A4D4: 48           PHA
C3/A4D5: 70 1A        BVS $A4F1
C3/A4D7: 28           PLP
...
C3/A548: 30 6A        BMI $A5B4
C3/A54A: 00 0D        BRK $0D
C3/A54C: 22 02 2C 68  JSR $682C02
...
C3/A56D: 22 BE 52 3B  JSR $3B52BE
C3/A571: 9A           TXS
C3/A572: 80 39        BRA $A5AD
...
C3/A5D1: B0 45        BCS $A618
C3/A5D3: 10 AA        BPL $A57F
C3/A5D5: 80 B8        BRA $A58F
...
C3/A7FD: 10 9C        BPL $A79B
C3/A7FF: 1B           TCS
C3/A800: 10 9D        BPL $A79F
C3/A802: 1B           TCS
C3/A803: 10 9E        BPL $A7A3
C3/A805: 00 1B        BRK $1B
C3/A807: 10 9F        BPL $A7A8
C3/A809: 1B           TCS
C3/A80A: 10 A0        BPL $A7AC
C3/A80C: 1B           TCS
C3/A80D: 10 00        BPL $A80F
C3/A80F: A1 1B        LDA ($1B,X)
C3/A811: 10 A2        BPL $A7B5
C3/A813: 1B           TCS
...
C3/A81F: 30 00        BMI $A821
C3/A821: 78           SEI
C3/A822: 4C F7 1B     JMP $1BF7
C3/A825: 78           SEI
C3/A826: 0A           ASL
...
C3/A834: 20 34 02     JSR $0234
C3/A837: 10 FE        BPL $A837
C3/A839: 1B           TCS
C3/A83A: 22 F9 37 00  JSR $0037F9
C3/A83E: 38           SEC
C3/A83F: 03 04        ORA $04,S
C3/A841: 00 C0        BRK $C0
C3/A843: 7E 03 00     ROR $0003,X
C3/A846: 00 0D        BRK $0D
C3/A848: 22 08 36 58  JSR $583608
C3/A84C: 06 04        ASL $04
C3/A84E: 20 95 0C     JSR $0C95
C3/A851: 80 40        BRA $A893
C3/A853: 18           CLC
C3/A854: 80 60        BRA $A8B6
