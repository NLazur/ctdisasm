...
Routine_C39589:
C3/9589: 18           CLC
C3/958A: 80 60        BRA Local_C395EC
C3/958C: 24 80        BIT $80
C3/958E: 80 30        BRA Local_C395C0
C3/9590: 80 A0        BRA Local_C39532
C3/9592: 3C 80 02     BIT Local_C30280,X
...
C3/95AC: 20 13 20     JSR Local_C32013
C3/95AF: 00 00        BRK $00
C3/95B1: C0 13 21     CPY #$2113
C3/95B4: 00 FF        BRK $FF
C3/95B6: 10 26        BPL Local_C395DE
C3/95B8: 00 00        BRK $00
C3/95BA: 10 27        BPL Local_C395E3
