...
C3/89A0: 80 92        BRA Local_C38934
...
C3/89AE: 20 20 30     JSR Local_C33020
C3/89B1: 10 30        BPL Local_C389E3
C3/89B3: EE E4 7B     INC $7BE4
C3/89B6: 20 00 3E     JSR Local_C33E00
...
C3/89D1: F0 F0        BEQ Local_C389C3
...
C3/89F4: 80 6B        BRA Local_C38A61
C3/89F6: 6B           RTL