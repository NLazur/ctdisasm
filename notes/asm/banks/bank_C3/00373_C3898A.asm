...
C3/89AE: 20 20 30     JSR $3020
C3/89B1: 10 30        BPL $89E3
C3/89B3: EE E4 7B     INC $7BE4
C3/89B6: 20 00 3E     JSR $3E00
...
C3/89D1: F0 F0        BEQ $89C3
C3/89D3: D0 F7        BNE $89CC
C3/89D5: 00 DF        BRK $DF
C3/89D7: DB           STP
C3/89D8: 80 DF        BRA $89B9
