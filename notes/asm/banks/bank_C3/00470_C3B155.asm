...
C3/B158: 10 40        BPL Routine_C3B19A
C3/B15A: 4A           LSR
C3/B15B: 20 A5 26     JSR Routine_C326A5
C3/B15E: D0 20        BNE Local_C3B180
C3/B160: 4C 10 C4     JMP Routine_C3C410
...
C3/B178: 20 46 12     JSR Routine_C31246
C3/B17B: 12 20        ORA ($20)
C3/B17D: 27 12        AND [$12]
C3/B17F: 1B           TCS
Local_C3B180:
C3/B180: 20 FF 08     JSR Routine_C308FF
C3/B183: 12 24        ORA ($24)
C3/B185: 20 E9 11     JSR Routine_C311E9
C3/B188: 2D 20 CA     AND $CA20
C3/B18B: 11 36        ORA ($36),Y
C3/B18D: 20 AB 11     JSR Routine_C311AB
C3/B190: 3F 20 8F 8C  AND $8C8F20,X
C3/B194: 11 48        ORA ($48),Y
C3/B196: 20 6D 11     JSR Routine_C3116D
...
C3/B1DA: 20 51 61     JSR Routine_C36151
C3/B1DD: 07 51        ORA [$51]
C3/B1DF: 31 26        AND ($26),Y
C3/B1E1: 90 51        BCC Routine_C3B234
C3/B1E3: 11 0D        ORA ($0D),Y
C3/B1E5: B2 48        LDA ($48)
C3/B1E7: 04 CD        TSB $CD
C3/B1E9: F0 CD        BEQ Routine_C3B1B8
C3/B1EB: B0 09        BCS Routine_C3B1F6
