...
C3/414B: 10 10        BPL Local_C3415D
...
C3/4188: 10 8D        BPL Routine_C34117
...
C3/419D: D0 13        BNE Routine_C341B2
C3/419F: 80 A5        BRA Routine_C34146
C3/41A1: C4 F0        CPY $F0
C3/41A3: 0F 3A 85 C4  ORA $C4853A
C3/41A7: 05 0A        ORA $0A
C3/41A9: 00 38        BRK $38
C3/41AB: 2A           ROL
C3/41AC: 8D 06 21     STA MOSAIC
...
C3/41C8: 80 E0        BRA Routine_C341AA
C3/41CA: C0 01        CPY #$01
C3/41CC: D0 F1        BNE Routine_C341BF
C3/41CE: 80 0F        BRA Routine_C341DF
C3/41D0: 0C 20 07     TSB $0720
C3/41D3: 16 20        ASL $20,X
C3/41D5: 11 20        ORA ($20),Y
C3/41D7: 74 04        STZ $04,X
C3/41D9: AD 20 05     LDA $0520
C3/41DC: F0 01        BEQ Routine_C341DF
C3/41DE: 3E 60 4D     ROL $4D60,X
C3/41E1: 22 F0 07 3B  JSR Routine_3B07F0
C3/41E5: 22 95 2C 49  JSR Routine_492C95
C3/41E9: 02 A2        COP $A2
C3/41EB: 74 76        STZ $76,X
C3/41ED: 6A           ROR
C3/41EE: 80 06        BRA Routine_C341F6
