...
Routine_C38226:
C3/8226: F0 01        BEQ Local_C38229
...
C3/8240: 10 1A        BPL Local_C3825C
...
C3/8257: 20 A0 A0     JSR Local_C3A0A0
C3/825A: 20 60 60     JSR Local_C36060
C3/825D: C0 02 40     CPY #$4002
C3/8260: 5B           TCD
C3/8261: 02 40        COP $40
C3/8263: 80 C0        BRA Local_C38225
...
C3/82AF: 90 DB        BCC Local_C3828C
...
C3/82C1: 20 4E 24     JSR Local_C3244E
C3/82C4: 00 6F        BRK $6F
C3/82C6: 90 6C        BCC Local_C38334
