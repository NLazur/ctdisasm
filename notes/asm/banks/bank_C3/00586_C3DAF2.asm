...
C3/DB08: 20 83 20     JSR Routine_C32083
...
C3/DB18: 4C 00 38     JMP Routine_C33800
C3/DB1B: 20 18 1E     JSR Routine_C31E18
C3/DB1E: 18           CLC
C3/DB1F: 02 35        COP $35
C3/DB21: 1E 18 A3     ASL $A318,X
C3/DB24: 80 20        BRA Routine_C3DB46
C3/DB26: 1B           TCS
...
C3/DB36: 20 00 40     JSR Routine_C34000
C3/DB39: 58           CLI
