...
C3/DB01: 2C C2 2C     BIT Local_C32CC2
C3/DB04: A3 2C        LDA $2C,S
C3/DB06: 00 A3        BRK $A3
C3/DB08: 20 83 20     JSR Local_C32083
...
C3/DB18: 4C 00 38     JMP Local_C33800
C3/DB1B: 20 18 1E     JSR Local_C31E18
C3/DB1E: 18           CLC
C3/DB1F: 02 35        COP $35
C3/DB21: 1E 18 A3     ASL $A318,X
C3/DB24: 80 20        BRA Local_C3DB46
C3/DB26: 1B           TCS
...
C3/DB36: 20 00 40     JSR Local_C34000
C3/DB39: 58           CLI
