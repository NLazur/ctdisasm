...
C3/B32D: 10 E0        BPL Local_C3B30F
C3/B32F: 31 3C        AND ($3C),Y
C3/B331: 30 8D        BMI Local_C3B2C0
...
C3/B359: 50 AC        BVC Local_C3B307
...
C3/B380: F0 3B        BEQ Local_C3B3BD
C3/B382: C0 B4        CPY #$B4
C3/B384: 2C 26 64     BIT Local_C36426
...
C3/B39C: 20 27 91     JSR Local_C39127
...
C3/B41D: 20 02 8C     JSR Local_C38C02
...
C3/B435: 18           CLC
C3/B436: 20 0E 00     JSR Local_C3000E
...
C3/B44C: 3C 09 A8     BIT Local_C3A809,X
