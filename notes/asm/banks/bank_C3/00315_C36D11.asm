...
C3/6D35: 08           PHP
C3/6D36: 10 88        BPL Local_C36CC0
...
C3/6D57: 18           CLC
C3/6D58: 10 30        BPL Local_C36D8A
C3/6D5A: A8           TAY
C3/6D5B: 31 10        AND ($10),Y
C3/6D5D: 6D 00 20     ADC $2000
C3/6D60: 30 AC        BMI Local_C36D0E
