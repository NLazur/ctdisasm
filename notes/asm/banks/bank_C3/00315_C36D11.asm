...
C3/6D15: 80 CC        BRA Routine_C36CE3
C3/6D17: 31 20        AND ($20),Y
C3/6D19: 80 00        BRA Local_C36D1B
Local_C36D1B:
C3/6D1B: CE 31 10     DEC $1031
C3/6D1E: 90 E0        BCC Routine_C36D00
C3/6D20: 31 10        AND ($10),Y
C3/6D22: 70 40        BVS Local_C36D64
C3/6D24: E2 31        SEP #$31
C3/6D26: 20 70 12     JSR Routine_C31270
C3/6D29: 80 65        BRA Routine_C36D90
...
C3/6D35: 08           PHP
C3/6D36: 10 88        BPL Routine_C36CC0
...
C3/6D43: 08           PHP
C3/6D44: 50 20        BVC Local_C36D66
...
C3/6D57: 18           CLC
C3/6D58: 10 30        BPL Routine_C36D8A
C3/6D5A: A8           TAY
C3/6D5B: 31 10        AND ($10),Y
C3/6D5D: 6D 00 20     ADC $2000
C3/6D60: 30 AC        BMI Routine_C36D0E
