...
C3/176B: 10 88        BPL Local_C316F5
C3/176D: F4 42 00     PEA $0042
C3/1770: C8           INY
C3/1771: E8           INX
C3/1772: 80 DE        BRA Local_C31752
C3/1774: 00 B9        BRK $B9
C3/1776: 86 F4        STX $F4
C3/1778: 0A           ASL
C3/1779: 99 86 F4     STA $F486,Y
C3/177C: E8           INX
C3/177D: 20 80 D4     JSR Local_C3D480
C3/1780: AF 80 21 DA  LDA $DA2180
C3/1784: 10 AA        BPL Local_C31730
C3/1786: 80 10        BRA Local_C31798
C3/1788: CA           DEX
C3/1789: B9 FC F0     LDA $F0FC,Y
C3/178C: 30 30        BMI Local_C317BE
...
C3/17B9: 80 01        BRA Local_C317BC
...
C3/1841: 08           PHP
C3/1842: 80 E2        BRA Local_C31826
C3/1844: 30 84        BMI Local_C317CA
C3/1846: 80 A9        BRA Local_C317F1
C3/1848: 00 85        BRK $85
C3/184A: 04 20        TSB $20
C3/184C: 81 0A        STA ($0A,X)
C3/184E: 70 CA        BVS Local_C3181A
C3/1850: D0 E9        BNE Local_C3183B
...
C3/1864: 0B           PHD
C3/1865: 50 E2        BVC Local_C31849
C3/1867: 20 8D 8A     JSR Local_C38A8D
...
C3/1876: 50 FF        BVC Local_C31877
