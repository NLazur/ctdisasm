...
C3/17B9: 80 01        BRA $17BC
C3/17BB: 03 00        ORA $00,S
C3/17BD: 22 57 05 C3  JSR $C30557
C3/17C1: 9D 02 02     STA $0202,X
C3/17C4: 8B           PHB
C3/17C5: 1A           INC
C3/17C6: 30 AA        BMI $1772
C3/17C8: AD 05 03     LDA $0305
C3/17CB: 4A           LSR
C3/17CC: 90 00        BCC $17CE
C3/17CE: 09 A5 F0     ORA #$F0A5
C3/17D1: 3A           DEC
C3/17D2: 22 A0 09 C3  JSR $C309A0
C3/17D6: C4 80        CPY $80
C3/17D8: 07 09        ORA [$09]
C3/17DA: 10 9C        BPL $1778
...
C3/1841: 08           PHP
C3/1842: 80 E2        BRA $1826
C3/1844: 30 84        BMI $17CA
C3/1846: 80 A9        BRA $17F1
C3/1848: 00 85        BRK $85
C3/184A: 04 20        TSB $20
C3/184C: 81 0A        STA ($0A,X)
C3/184E: 70 CA        BVS $181A
C3/1850: D0 E9        BNE $183B
