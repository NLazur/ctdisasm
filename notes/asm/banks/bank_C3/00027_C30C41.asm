...
C3/0C4E: 4C B1 0B     JMP $0BB1
C3/0C51: C2 20        REP #$20
C3/0C53: B2 20        LDA ($20)
C3/0C55: 8D F0 00     STA $00F0
C3/0C58: 22 F3 37 7E  JSR $7E37F3
C3/0C5C: 4C B1 0B     JMP $0BB1
