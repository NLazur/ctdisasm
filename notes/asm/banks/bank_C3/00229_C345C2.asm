...
C3/45DB: 10 0A        BPL $45E7
C3/45DD: 0A           ASL
C3/45DE: 10 04        BPL $45E4
C3/45E0: 0E 07 1B     ASL $1B07
C3/45E3: 0C 04 85     TSB $8504
C3/45E6: F0 B7        BEQ $459F
C3/45E8: 1B           TCS
C3/45E9: 08           PHP
C3/45EA: C8           INY
...
C3/4608: 1B           TCS
C3/4609: 22 00 18 65  JSR $651800
...
C3/461A: D0 C2        BNE $45DE
C3/461C: 90 C2        BCC $45E0
C3/461E: 20 86 11     JSR $1186
C3/4621: 4A           LSR
...
C3/4648: 80 A5        BRA $45EF
C3/464A: 71 8D        ADC ($8D),Y
C3/464C: 20 0B A9     JSR $A90B
...
C3/4667: 80 0F        BRA $4678
C3/4669: 8D 8D 03     STA $038D
C3/466C: 20 F5 74     JSR $74F5
C3/466F: 3A           DEC
C3/4670: 1A           INC
...
C3/46AB: 10 85        BPL $4632
C3/46AD: 10 A9        BPL $4658
