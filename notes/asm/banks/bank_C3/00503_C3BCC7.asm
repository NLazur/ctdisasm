...
C3/BCF8: 30 C6        BMI Local_C3BCC0
C3/BCFA: 4E C5 E5     LSR $E5C5
C3/BCFD: 0B           PHD
C3/BCFE: 02 06        COP $06
C3/BD00: 30 1A        BMI Local_C3BD1C
C3/BD02: AA           TAX
C3/BD03: 00 07        BRK $07
C3/BD05: 2C 28 00     BIT Local_C30028
...
C3/BD16: 2C 88 C8     BIT Local_C3C888
...
C3/BD27: D8           CLD
C3/BD28: 20 00 1B     JSR Local_C31B00
C3/BD2B: 20 20 D2     JSR Local_C3D220
C3/BD2E: 3D 5A 11     AND $115A,X
C3/BD31: 2C 50 12     BIT Local_C31250
C3/BD34: 80 2D        BRA Local_C3BD63
C3/BD36: 32 10        AND ($10)
C3/BD38: 9F 02 00 2C  STA $2C0002,X
C3/BD3C: 8C 00 A0     STY $A000
C3/BD3F: 00 09        BRK $09
C3/BD41: 56 09        LSR $09,X
C3/BD43: 10 7F        BPL Local_C3BDC4
C3/BD45: 0D 28 14     ORA $1428
C3/BD48: 4B           PHK
C3/BD49: 20 26 2C     JSR Local_C32C26
C3/BD4C: B4 07        LDY $07,X
C3/BD4E: 59 00 12     EOR $1200,Y
C3/BD51: 30 5D        BMI Local_C3BDB0
C3/BD53: 30 20        BMI Local_C3BD75
C3/BD55: 2C 80 00     BIT Local_C30080
C3/BD58: 68           PLA
