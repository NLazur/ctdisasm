...
C3/C2B7: 08           PHP
C3/C2B8: 0B           PHD
C3/C2B9: 22 41 B6 01  JSR $01B641
C3/C2BD: 38           SEC
C3/C2BE: 01 0D        ORA ($0D,X)
C3/C2C0: 29 20        AND #$20
C3/C2C2: 08           PHP
C3/C2C3: 20 1B 20     JSR $201B
...
C3/C2D6: 30 08        BMI $C2E0
C3/C2D8: 10 21        BPL $C2FB
C3/C2DA: 40           RTI