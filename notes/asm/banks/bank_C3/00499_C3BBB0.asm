...
C3/BBC9: 20 B1 03     JSR Routine_C303B1
...
C3/BBE1: 30 D0        BMI Routine_C3BBB3
C3/BBE3: 01 02        ORA ($02,X)
C3/BBE5: 10 D0        BPL Routine_C3BBB7
...
C3/BBF2: 10 49        BPL Routine_C3BC3D
...
C3/BC00: 30 4E        BMI Routine_C3BC50
...
C3/BC0F: 90 7F        BCC Routine_C3BC90
