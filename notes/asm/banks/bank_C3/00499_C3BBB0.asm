...
C3/BBBA: F0 00        BEQ $BBBC
C3/BBBC: 08           PHP
C3/BBBD: 22 F1 00 FA  JSR $FA00F1
C3/BBC1: 32 10        AND ($10)
C3/BBC3: 10 4E        BPL $BC13
C3/BBC5: AF E2 C6 36  LDA $36C6E2
C3/BBC9: 20 B1 03     JSR $03B1
...
C3/BBE1: 30 D0        BMI $BBB3
C3/BBE3: 01 02        ORA ($02,X)
C3/BBE5: 10 D0        BPL $BBB7
