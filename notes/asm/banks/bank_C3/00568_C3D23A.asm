...
C3/D287: 10 A8        BPL $D231
C3/D289: 20 A0 0D     JSR $0DA0
C3/D28C: 00 00        BRK $00
C3/D28E: F0 35        BEQ $D2C5
...
C3/D2B4: 88           DEY
C3/D2B5: 10 86        BPL $D23D
C3/D2B7: 10 44        BPL $D2FD
C3/D2B9: 08           PHP
