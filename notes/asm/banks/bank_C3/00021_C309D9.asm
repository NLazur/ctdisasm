...
C3/0A24: 8D 80 21     STA WMDATA
C3/0A27: 7B           TDC
C3/0A28: 8D 80 21     STA WMDATA
C3/0A2B: A5 FB        LDA $FB
C3/0A2D: 8D 80 21     STA WMDATA
C3/0A30: E6 FB        INC $FB
C3/0A32: A9 5B        LDA #$5B
C3/0A34: 8D 80 21     STA WMDATA
Local_C30A37:
C3/0A37: A9 AD        LDA #$AD
C3/0A39: 8D 80 21     STA WMDATA
...
C3/0A4E: 8D 80 21     STA WMDATA
C3/0A51: EB           XBA
C3/0A52: 8D 80 21     STA WMDATA
C3/0A55: A9 85        LDA #$85
C3/0A57: 8D 80 21     STA WMDATA
C3/0A5A: 8A           TXA
C3/0A5B: 8D 80 21     STA WMDATA
C3/0A5E: E8           INX
C3/0A5F: E8           INX
