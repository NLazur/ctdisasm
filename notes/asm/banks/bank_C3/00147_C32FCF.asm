...
C3/2FD6: 90 00        BCC Local_C32FD8
C3/2FD8: 20 AA 36     JSR Local_C336AA
...
C3/2FF7: 68           PLA
C3/2FF8: 10 46        BPL Local_C33040
C3/2FFA: 10 0D        BPL Local_C33009
...
C3/3019: 3C 20 A7     BIT Local_C3A720,X
C3/301C: 90 7E        BCC Local_C3309C
C3/301E: 30 A2        BMI Local_C32FC2
C3/3020: 20 7E 10     JSR Local_C3107E
C3/3023: 22 A2 3C 7E  JSR Routine_7E3CA2
C3/3027: 10 06        BPL Local_C3302F
C3/3029: 89 00        BIT #$00
C3/302B: 08           PHP
C3/302C: 23 A2        AND $A2,S
C3/302E: 36 89        ROL $89,X
C3/3030: 10 7B        BPL Local_C330AD
C3/3032: 8F 00 22 10  STA $102200
C3/3036: 7E 8F 01     ROR $018F,X
C3/3039: 22 1B 0C A9  JSR Routine_A90C1B
C3/303D: 2A           ROL
...
C3/304E: 8B           PHB
C3/304F: 20 49 37     JSR Local_C33749
C3/3052: AB           PLB
C3/3053: 01 63        ORA ($63,X)
C3/3055: 0B           PHD
C3/3056: 00 00        BRK $00
C3/3058: 2B           PLD
C3/3059: 20 77 57     JSR Local_C35777
