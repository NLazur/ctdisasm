...
C3/2E81: 80 E1        BRA Routine_C32E64
C3/2E83: 2A           ROL
C3/2E84: 5C 2C 50 60  JMP Routine_60502C
...
C3/2E9B: 10 00        BPL Local_C32E9D
Local_C32E9D:
C3/2E9D: AA           TAX
C3/2E9E: 52 10        EOR ($10)
C3/2EA0: 00 78        BRK $78
C3/2EA2: 10 00        BPL Local_C32EA4
Local_C32EA4:
C3/2EA4: 4A           LSR
C3/2EA5: 10 00        BPL Local_C32EA7
Local_C32EA7:
C3/2EA7: 10 20        BPL Routine_C32EC9
C3/2EA9: 40           RTI