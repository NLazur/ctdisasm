...
C3/3CD9: F0 06        BEQ Local_C33CE1
C3/3CDB: 00 10        BRK $10
C3/3CDD: 03 1A        ORA $1A,S
C3/3CDF: 80 01        BRA Local_C33CE2
C3/3CE1: 3A           DEC
C3/3CE2: 85 F2        STA $F2
C3/3CE4: 49 1A        EOR #$1A
C3/3CE6: 10 E0        BPL Local_C33CC8
C3/3CE8: 03 1A        ORA $1A,S
C3/3CEA: 30 E0        BMI Local_C33CCC
...
C3/3D01: 30 00        BMI Local_C33D03
C3/3D03: 92 7C        STA ($7C)
C3/3D05: 3C 30 00     BIT Local_C30030,X
C3/3D08: 7C 22 50     JMP ($5022,X)
C3/3D0B: 00 04        BRK $04
C3/3D0D: 22 10 20 00  JSR Routine_002010
...
C3/3D1D: D0 99        BNE Local_C33CB8
C3/3D1F: 60           RTS