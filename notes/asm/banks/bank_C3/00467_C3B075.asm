...
C3/B081: DA           PHX
C3/B082: 80 F8        BRA $B07C
C3/B084: EA           NOP
C3/B085: 10 DA        BPL $B061
C3/B087: 70 86        BVS $B00F
C3/B089: 09 2C        ORA #$2C
C3/B08B: A8           TAY
C3/B08C: B0 01        BCS $B08F
C3/B08E: 78           SEI
C3/B08F: 50 50        BVC $B0E1
...
C3/B09F: F0 28        BEQ $B0C9
C3/B0A1: D0 40        BNE $B0E3
C3/B0A3: D6 09        DEC $09,X
C3/B0A5: 2C B8 01     BIT $01B8
C3/B0A8: 70 C3        BVS $B06D
C3/B0AA: 50 28        BVC $B0D4
C3/B0AC: 0B           PHD
...
C3/B0BD: 90 20        BCC $B0DF
C3/B0BF: 50 80        BVC $B041
C3/B0C1: B0 20        BCS $B0E3
C3/B0C3: 78           SEI
C3/B0C4: 70 26        BVS $B0EC
C3/B0C6: AA           TAX
C3/B0C7: 0A           ASL
...
C3/B0E5: 78           SEI
C3/B0E6: 20 04 24     JSR $2404
C3/B0E9: D5 20        CMP $20,X
C3/B0EB: 34 1F        BIT $1F,X
C3/B0ED: 20 34 24     JSR $2434
C3/B0F0: 20 34 1F     JSR $1F34
C3/B0F3: 20 44 62     JSR $6244
