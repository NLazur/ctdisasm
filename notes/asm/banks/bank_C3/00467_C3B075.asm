...
C3/B084: EA           NOP
C3/B085: 10 DA        BPL Routine_C3B061
C3/B087: 70 86        BVS Routine_C3B00F
C3/B089: 09 2C        ORA #$2C
C3/B08B: A8           TAY
C3/B08C: B0 01        BCS Local_C3B08F
C3/B08E: 78           SEI
Local_C3B08F:
C3/B08F: 50 50        BVC Routine_C3B0E1
...
C3/B09F: F0 28        BEQ Routine_C3B0C9
C3/B0A1: D0 40        BNE Local_C3B0E3
C3/B0A3: D6 09        DEC $09,X
C3/B0A5: 2C B8 01     BIT $01B8
C3/B0A8: 70 C3        BVS Routine_C3B06D
...
C3/B0BF: 50 80        BVC Routine_C3B041
C3/B0C1: B0 20        BCS Local_C3B0E3
C3/B0C3: 78           SEI
C3/B0C4: 70 26        BVS Routine_C3B0EC
C3/B0C6: AA           TAX
C3/B0C7: 0A           ASL
...
C3/B0E5: 78           SEI
C3/B0E6: 20 04 24     JSR Routine_C32404
C3/B0E9: D5 20        CMP $20,X
C3/B0EB: 34 1F        BIT $1F,X
C3/B0ED: 20 34 24     JSR Routine_C32434
C3/B0F0: 20 34 1F     JSR Routine_C31F34
C3/B0F3: 20 44 62     JSR Routine_C36244
