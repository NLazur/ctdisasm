...
C3/80FD: 70 A3        BVS $80A2
C3/80FF: 50 A2        BVC $80A3
C3/8101: 4A           LSR
...
C3/8117: 50 70        BVC $8189
C3/8119: 30 90        BMI $80AB
C3/811B: 00 56        BRK $56
C3/811D: 36 00        ROL $00,X
C3/811F: 62 7E 00     PER $C381A0
C3/8122: F2 10        SBC ($10)
C3/8124: 66 80        ROR $80
C3/8126: 30 00        BMI $8128
C3/8128: 08           PHP
C3/8129: 70 00        BVS $812B
C3/812B: 70 08        BVS $8135
C3/812D: D8           CLD
C3/812E: 20 FC 10     JSR $10FC
