...
C3/19FF: 50 68        BVC Local_C31A69
C3/1A01: 9D 2B 20     STA $202B,X
C3/1A04: 16 40        ASL $40,X
C3/1A06: 2B           PLD
C3/1A07: 50 68        BVC Local_C31A71
C3/1A09: 9D 03 2C     STA $2C03,X
C3/1A0C: 10 B5        BPL Local_C319C3
C3/1A0E: 22 BD 50 09  JSR Routine_0950BD
C3/1A12: F0 0B        BEQ Local_C31A1F
C3/1A14: 8B           PHB
