...
C3/6716: 80 16        BRA Local_C3672E
C3/6718: 80 A5        BRA Local_C366BF
C3/671A: 73 C9        ADC ($C9,S),Y
C3/671C: 90 03        BCC Local_C36721
