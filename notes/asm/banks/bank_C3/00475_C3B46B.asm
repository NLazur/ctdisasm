...
C3/B476: F0 02        BEQ Local_C3B47A
...
C3/B489: 30 01        BMI Local_C3B48C
C3/B48B: 1A           INC
...
C3/B497: 3A           DEC
C3/B498: 0B           PHD
C3/B499: 30 93        BMI Local_C3B42E
C3/B49B: 2C B8 02     BIT Local_C302B8
C3/B49E: 70 00        BVS Local_C3B4A0
C3/B4A0: 00 09        BRK $09
C3/B4A2: 4C 12 7F     JMP Local_C37F12
C3/B4A5: 2C F8 02     BIT Local_C302F8
C3/B4A8: 10 6B        BPL Local_C3B515
...
C3/B4C4: 90 24        BCC Local_C3B4EA
C3/B4C6: 00 D0        BRK $D0
C3/B4C8: 15 2D        ORA $2D,X
C3/B4CA: 10 A1        BPL Local_C3B46D
...
C3/B4E2: 10 F8        BPL Local_C3B4DC
...
C3/B508: 10 08        BPL Local_C3B512
C3/B50A: 11 80        ORA ($80),Y
C3/B50C: 4B           PHK
C3/B50D: 22 10 03 22  JSR Routine_220310
C3/B511: D0 10        BNE Local_C3B523
C3/B513: 55 33        EOR $33,X
C3/B515: 30 68        BMI Local_C3B57F
C3/B517: 33 10        AND ($10,S),Y
C3/B519: 32 44        AND ($44)
C3/B51B: 10 02        BPL Local_C3B51F
C3/B51D: 44 30 C4     MVP $30,$C4
C3/B520: 73 44        ADC ($44,S),Y
C3/B522: 00 C0        BRK $C0
C3/B524: 70 31        BVS Local_C3B557
C3/B526: 96 5F        STX $5F,Y
C3/B528: C0 1B        CPY #$1B
C3/B52A: 80 7A        BRA Local_C3B5A6
C3/B52C: 20 12 01     JSR Local_C30112
