...
C3/B778: 30 C1        BMI Local_C3B73B
C3/B77A: B0 40        BCS Local_C3B7BC
C3/B77C: 52 2C        EOR ($2C)
C3/B77E: 70 02        BVS Local_C3B782
C3/B780: 88           DEY
C3/B781: 4E 71 68     LSR $6871
C3/B784: 30 00        BMI Local_C3B786
C3/B786: 0D 22 03     ORA $0322
C3/B789: 09 57        ORA #$57
C3/B78B: 17 7F        ORA [$7F],Y
C3/B78D: 38           SEC
C3/B78E: 22 3C FA 19  JSR Routine_19FA3C
C3/B792: 34 E0        BIT $E0,X
C3/B794: 79 8D 21     ADC $218D,Y
C3/B797: 31 A0        AND ($A0),Y
C3/B799: 15 2C        ORA $2C,X
C3/B79B: C0 5C        CPY #$5C
C3/B79D: 2C 60 89     BIT Local_C38960
C3/B7A0: 2C 00 28     BIT Local_C32800
C3/B7A3: 09 94        ORA #$94
C3/B7A5: B1 06        LDA ($06),Y
C3/B7A7: 10 1B        BPL Local_C3B7C4
C3/B7A9: 22 F4 32 90  JSR Routine_9032F4
