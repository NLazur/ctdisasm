...
C3/2B06: 20 E2 00     JSR Routine_C300E2
...
C3/2B16: 20 10 13     JSR Routine_C31310
C3/2B19: 20 B8 16     JSR Routine_C316B8
C3/2B1C: 5B           TCD
C3/2B1D: A8           TAY
C3/2B1E: AD 00 0B     LDA $0B00
C3/2B21: 25 10        AND $10
C3/2B23: 80 25        BRA Local_C32B4A
C3/2B25: 20 0A 0C     JSR Routine_C30C0A
C3/2B28: 0B           PHD
...
C3/2B32: 0B           PHD
C3/2B33: 5B           TCD
C3/2B34: 20 1B 02     JSR Routine_C3021B
