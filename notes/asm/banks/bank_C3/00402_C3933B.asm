...
C3/9362: 38           SEC
C3/9363: 20 38 E1     JSR Routine_C3E138
...
C3/938B: 90 FF        BCC Routine_C3938C
C3/938D: 88           DEY
...
C3/93A6: 30 82        BMI Routine_C3932A
C3/93A8: 27 F0        AND [$F0]
C3/93AA: EA           NOP
C3/93AB: 70 1A        BVS Routine_C393C7
C3/93AD: 82 0F 27     BRL Routine_C3BABF
C3/93B0: D0 E1        BNE Routine_C39393
...
C3/93C3: 10 71        BPL Routine_C39436
C3/93C5: 1A           INC
C3/93C6: 0D 60 03     ORA $0360
C3/93C9: C5 1A        CMP $1A
C3/93CB: 90 09        BCC Routine_C393D6
...
C3/93DB: 78           SEI
C3/93DC: 4C 02 30     JMP Routine_C33002
C3/93DF: 06 0D        ASL $0D
C3/93E1: 31 2E        AND ($2E),Y
C3/93E3: 10 1F        BPL Routine_C39404
C3/93E5: 5A           PHY
