...
C3/9381: 90 F3        BCC $9376
C3/9383: 12 2C        ORA ($2C)
C3/9385: 68           PLA
C3/9386: F0 00        BEQ $9388
C3/9388: 39 00 27     AND $2700,Y
C3/938B: 90 FF        BCC $938C
C3/938D: 88           DEY
C3/938E: 82 27 F0     BRL $C383B8
C3/9391: 4E 70 72     LSR $7270
C3/9394: 82 27 F0     BRL $C383BE
C3/9397: 75 70        ADC $70,X
C3/9399: 5C 82 27 F0  JMP $F02782
C3/939D: FF 9C 70 46  SBC $46709C,X
C3/93A1: 82 27 F0     BRL $C383CB
C3/93A4: C3 70        CMP $70,S
C3/93A6: 30 82        BMI $932A
C3/93A8: 27 F0        AND [$F0]
C3/93AA: EA           NOP
C3/93AB: 70 1A        BVS $93C7
C3/93AD: 82 0F 27     BRL $C3BABF
C3/93B0: D0 E1        BNE $9393
C3/93B2: 21 AF        AND ($AF,X)
C3/93B4: 59 FB 11     EOR $11FB,Y
C3/93B7: 04 0D        TSB $0D
C3/93B9: 30 04        BMI $93BF
C3/93BB: 73 E3        ADC ($E3,S),Y
C3/93BD: 01 00        ORA ($00,X)
C3/93BF: 22 30 F9 0D  JSR $0DF930
C3/93C3: 10 71        BPL $9436
C3/93C5: 1A           INC
C3/93C6: 0D 60 03     ORA $0360
C3/93C9: C5 1A        CMP $1A
C3/93CB: 90 09        BCC $93D6
...
C3/93DB: 78           SEI
C3/93DC: 4C 02 30     JMP $3002
C3/93DF: 06 0D        ASL $0D
C3/93E1: 31 2E        AND ($2E),Y
C3/93E3: 10 1F        BPL $9404
C3/93E5: 5A           PHY
