...
C3/C518: 10 20        BPL Local_C3C53A
C3/C51A: C0 90        CPY #$90
C3/C51C: 20 10 20     JSR Local_C32010
C3/C51F: 00 1C        BRK $1C
C3/C521: 91 40        STA ($40),Y
C3/C523: 20 20 08     JSR Local_C30820
...
C3/C533: 80 0D        BRA Local_C3C542
...
C3/C55A: D0 41        BNE Local_C3C59D
...
C3/C567: 10 05        BPL Local_C3C56E
...
C3/C579: 30 26        BMI Local_C3C5A1
C3/C57B: 18           CLC
C3/C57C: 0B           PHD
...
C3/C593: 20 01 1B     JSR Local_C31B01
