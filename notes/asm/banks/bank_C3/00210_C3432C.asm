...
C3/434A: 10 64        BPL Local_C343B0
C3/434C: 19 80 ED     ORA $ED80,Y
C3/434F: 24 70        BIT $70
C3/4351: 30 8D        BMI Local_C342E0
...
C3/437F: 80 D8        BRA Local_C34359
C3/4381: 60           RTS