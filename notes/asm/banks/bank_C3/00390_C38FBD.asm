...
Routine_C38FBD:
C3/8FBD: 2C 42 38     BIT Local_C33842
C3/8FC0: 1E 14 01     ASL $0114,X
C3/8FC3: A5 00        LDA $00
C3/8FC5: 38           SEC
C3/8FC6: 50 3B        BVC Local_C39003
...
C3/8FD6: 80 2C        BRA Local_C39004
C3/8FD8: 52 2C        EOR ($2C)
C3/8FDA: F0 01        BEQ Local_C38FDD
C3/8FDC: 50 01        BVC Local_C38FDF
C3/8FDE: 04 02        TSB $02
C3/8FE0: 00 04        BRK $04
C3/8FE2: 30 4A        BMI Local_C3902E
