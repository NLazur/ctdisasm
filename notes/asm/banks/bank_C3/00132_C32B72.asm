...
C3/2BA2: 22 29 0E C3  JSR Routine_C30E29
C3/2BA6: E2 00        SEP #$00
C3/2BA8: 20 AC F4     JSR Routine_C3F4AC
C3/2BAB: 00 8A        BRK $8A
C3/2BAD: 99 46 14     STA $1446,Y
C3/2BB0: 50 C2        BVC Routine_C32B74
C3/2BB2: 20 C2 10     JSR Routine_C310C2
C3/2BB5: A8           TAY
C3/2BB6: 0A           ASL
C3/2BB7: 5B           TCD
...
C3/2BEA: 0B           PHD
C3/2BEB: D0 03        BNE Local_C32BF0
...
C3/2BFF: 30 06        BMI Routine_C32C07
C3/2C01: 17 C7        ORA [$C7],Y
C3/2C03: 08           PHP
C3/2C04: 02 0C        COP $0C
C3/2C06: D0 09        BNE Routine_C32C11
C3/2C08: 20 00 51     JSR Routine_C35100
C3/2C0B: 00 20        BRK $20
C3/2C0D: F1 50        SBC ($50),Y
C3/2C0F: 20 16 51     JSR Routine_C35116
C3/2C12: 20 AD F0     JSR Routine_C3F0AD
...
C3/2C68: 20 71 06     JSR Routine_C30671
...
Local_C32C77:
C3/2C77: 80 4A        BRA Routine_C32CC3
C3/2C79: 90 07        BCC Local_C32C82
...
C3/2C97: 10 02        BPL Local_C32C9B
...
C3/2CB1: 20 70 9A     JSR Routine_C39A70
C3/2CB4: 30 10        BMI Local_C32CC6
C3/2CB6: 58           CLI
...
C3/2CCD: 20 C0 05     JSR Routine_C305C0
C3/2CD0: A9 0A        LDA #$0A
C3/2CD2: 00 80        BRK $80
C3/2CD4: 10 0D        BPL Local_C32CE3
C3/2CD6: 10 9F        BPL Local_C32C77
C3/2CD8: C0 12        CPY #$12
C3/2CDA: 5C 9F 10 A6  JMP Routine_A6109F
C3/2CDE: FE 8C 10     INC $108C,X
C3/2CE1: B0 05        BCS Local_C32CE8
Local_C32CE3:
C3/2CE3: 8A           TXA
C3/2CE4: 04 69        TSB $69
C3/2CE6: 10 2E        BPL Routine_C32D16
Local_C32CE8:
...
C3/2D1F: ED 17 42     SBC RDMPYH
C3/2D22: 85 15        STA $15
C3/2D24: 03 14        ORA $14,S
C3/2D26: 10 9A        BPL Local_C32CC2
