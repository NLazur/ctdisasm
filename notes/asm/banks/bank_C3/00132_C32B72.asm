...
C3/2BA8: 20 AC F4     JSR Local_C3F4AC
C3/2BAB: 00 8A        BRK $8A
C3/2BAD: 99 46 14     STA $1446,Y
C3/2BB0: 50 C2        BVC Local_C32B74
C3/2BB2: 20 C2 10     JSR Local_C310C2
C3/2BB5: A8           TAY
C3/2BB6: 0A           ASL
C3/2BB7: 5B           TCD
...
C3/2BFF: 30 06        BMI Local_C32C07
C3/2C01: 17 C7        ORA [$C7],Y
C3/2C03: 08           PHP
C3/2C04: 02 0C        COP $0C
C3/2C06: D0 09        BNE Local_C32C11
C3/2C08: 20 00 51     JSR Local_C35100
C3/2C0B: 00 20        BRK $20
C3/2C0D: F1 50        SBC ($50),Y
C3/2C0F: 20 16 51     JSR Local_C35116
C3/2C12: 20 AD F0     JSR Local_C3F0AD
...
C3/2CB1: 20 70 9A     JSR Local_C39A70
...
C3/2CCD: 20 C0 05     JSR Local_C305C0
...
C3/2CE6: 10 2E        BPL Local_C32D16
