...
C3/EB04: 50 00        BVC Local_C3EB06
Local_C3EB06:
...
C3/EB20: F0 E8        BEQ Routine_C3EB0A
...
C3/EB31: F0 E8        BEQ Routine_C3EB1B
...
C3/EB42: F0 E8        BEQ Routine_C3EB2C
...
C3/EB57: F0 E8        BEQ Routine_C3EB41
...
C3/EB6C: F0 E8        BEQ Routine_C3EB56
...
C3/EB85: F0 E8        BEQ Routine_C3EB6F
...
C3/EB9E: F0 E8        BEQ Routine_C3EB88
...
C3/EBBB: F0 E8        BEQ Routine_C3EBA5
...
C3/EBD8: F0 E8        BEQ Routine_C3EBC2
...
C3/EBE8: 10 E8        BPL Local_C3EBD2
...
C3/EBF9: F0 E8        BEQ Routine_C3EBE3
...
C3/EC09: 10 E8        BPL Local_C3EBF3
...
C3/EC1A: F0 E8        BEQ Routine_C3EC04
...
C3/EC2A: 10 E8        BPL Local_C3EC14
...
C3/EC36: 80 01        BRA Local_C3EC39
C3/EC38: F8           SED
Local_C3EC39:
C3/EC39: 00 4F        BRK $4F
Local_C3EC3B:
C3/EC3B: 80 02        BRA Routine_C3EC3F
C3/EC3D: F8           SED
C3/EC3E: 00 4F        BRK $4F
C3/EC40: 80 F0        BRA Local_C3EC32
C3/EC42: 08           PHP
C3/EC43: 4E 80 02     LSR $0280
C3/EC46: F8           SED
C3/EC47: 00 4F        BRK $4F
C3/EC49: 80 F0        BRA Local_C3EC3B
C3/EC4B: 08           PHP
C3/EC4C: 4F 80 03 F8  EOR $F80380
C3/EC50: 00 4F        BRK $4F
C3/EC52: 80 F0        BRA Routine_C3EC44
C3/EC54: 08           PHP
C3/EC55: 4F 80 E8 10  EOR $10E880
C3/EC59: 4E 80 03     LSR $0380
C3/EC5C: F8           SED
C3/EC5D: 00 4F        BRK $4F
C3/EC5F: 80 F0        BRA Routine_C3EC51
C3/EC61: 08           PHP
C3/EC62: 4F 80 E8 10  EOR $10E880
C3/EC66: 4F 80 03 F8  EOR $F80380
C3/EC6A: 00 4F        BRK $4F
C3/EC6C: 80 F0        BRA Routine_C3EC5E
C3/EC6E: 08           PHP
C3/EC6F: 4F 80 E8 10  EOR $10E880
C3/EC73: 50 80        BVC Routine_C3EBF5
C3/EC75: 03 F8        ORA $F8,S
C3/EC77: 00 4F        BRK $4F
C3/EC79: 80 F0        BRA Routine_C3EC6B
C3/EC7B: 08           PHP
C3/EC7C: 4F 80 E8 10  EOR $10E880
C3/EC80: 51 80        EOR ($80),Y
C3/EC82: 04 F8        TSB $F8
C3/EC84: 00 4F        BRK $4F
C3/EC86: 80 F0        BRA Routine_C3EC78
C3/EC88: 08           PHP
Local_C3EC89:
C3/EC89: 4F 80 E8 10  EOR $10E880
C3/EC8D: 51 80        EOR ($80),Y
C3/EC8F: F0 10        BEQ Routine_C3ECA1
C3/EC91: 52 80        EOR ($80)
C3/EC93: 04 F8        TSB $F8
C3/EC95: 00 4F        BRK $4F
C3/EC97: 80 F0        BRA Local_C3EC89
C3/EC99: 08           PHP
Local_C3EC9A:
C3/EC9A: 4F 80 E8 10  EOR $10E880
C3/EC9E: 51 80        EOR ($80),Y
C3/ECA0: F0 10        BEQ Routine_C3ECB2
C3/ECA2: 54 80 05     MVN $80,$05
C3/ECA5: F8           SED
C3/ECA6: 00 4F        BRK $4F
C3/ECA8: 80 F0        BRA Local_C3EC9A
C3/ECAA: 08           PHP
C3/ECAB: 4F 80 E8 10  EOR $10E880
Local_C3ECAF:
C3/ECAF: 51 80        EOR ($80),Y
C3/ECB1: F0 10        BEQ Routine_C3ECC3
C3/ECB3: 53 80        EOR ($80,S),Y
C3/ECB5: F8           SED
C3/ECB6: 10 52        BPL Routine_C3ED0A
C3/ECB8: 80 05        BRA Local_C3ECBF
C3/ECBA: F8           SED
C3/ECBB: 00 4F        BRK $4F
C3/ECBD: 80 F0        BRA Local_C3ECAF
Local_C3ECBF:
C3/ECBF: 08           PHP
C3/ECC0: 4F 80 E8 10  EOR $10E880
Local_C3ECC4:
C3/ECC4: 51 80        EOR ($80),Y
C3/ECC6: F0 10        BEQ Routine_C3ECD8
C3/ECC8: 53 80        EOR ($80,S),Y
C3/ECCA: F8           SED
C3/ECCB: 10 54        BPL Local_C3ED21
C3/ECCD: 80 06        BRA Local_C3ECD5
C3/ECCF: F8           SED
C3/ECD0: 00 4F        BRK $4F
C3/ECD2: 80 F0        BRA Local_C3ECC4
C3/ECD4: 08           PHP
Local_C3ECD5:
C3/ECD5: 4F 80 E8 10  EOR $10E880
C3/ECD9: 51 80        EOR ($80),Y
C3/ECDB: F0 10        BEQ Local_C3ECED
Local_C3ECDD:
C3/ECDD: 53 80        EOR ($80,S),Y
C3/ECDF: F8           SED
C3/ECE0: 10 53        BPL Local_C3ED35
C3/ECE2: 80 00        BRA Local_C3ECE4
Local_C3ECE4:
C3/ECE4: 10 52        BPL Routine_C3ED38
C3/ECE6: 80 06        BRA Local_C3ECEE
C3/ECE8: F8           SED
C3/ECE9: 00 4F        BRK $4F
C3/ECEB: 80 F0        BRA Local_C3ECDD
Local_C3ECED:
C3/ECED: 08           PHP
Local_C3ECEE:
C3/ECEE: 4F 80 E8 10  EOR $10E880
C3/ECF2: 51 80        EOR ($80),Y
C3/ECF4: F0 10        BEQ Local_C3ED06
Local_C3ECF6:
C3/ECF6: 53 80        EOR ($80,S),Y
C3/ECF8: F8           SED
C3/ECF9: 10 53        BPL Local_C3ED4E
C3/ECFB: 80 00        BRA Local_C3ECFD
Local_C3ECFD:
C3/ECFD: 10 54        BPL Routine_C3ED53
C3/ECFF: 80 07        BRA Routine_C3ED08
C3/ED01: F8           SED
C3/ED02: 00 4F        BRK $4F
C3/ED04: 80 F0        BRA Local_C3ECF6
Local_C3ED06:
C3/ED06: 08           PHP
C3/ED07: 4F 80 E8 10  EOR $10E880
C3/ED0B: 51 80        EOR ($80),Y
C3/ED0D: F0 10        BEQ Local_C3ED1F
C3/ED0F: 53 80        EOR ($80,S),Y
C3/ED11: F8           SED
C3/ED12: 10 53        BPL Routine_C3ED67
C3/ED14: 80 00        BRA Local_C3ED16
Local_C3ED16:
C3/ED16: 10 53        BPL Routine_C3ED6B
C3/ED18: 80 08        BRA Routine_C3ED22
C3/ED1A: 10 52        BPL Routine_C3ED6E
C3/ED1C: 80 07        BRA Routine_C3ED25
C3/ED1E: F8           SED
Local_C3ED1F:
C3/ED1F: 00 4F        BRK $4F
Local_C3ED21:
C3/ED21: 80 F0        BRA Routine_C3ED13
C3/ED23: 08           PHP
C3/ED24: 4F 80 E8 10  EOR $10E880
C3/ED28: 51 80        EOR ($80),Y
C3/ED2A: F0 10        BEQ Local_C3ED3C
C3/ED2C: 53 80        EOR ($80,S),Y
C3/ED2E: F8           SED
C3/ED2F: 10 53        BPL Routine_C3ED84
C3/ED31: 80 00        BRA Local_C3ED33
Local_C3ED33:
C3/ED33: 10 53        BPL Routine_C3ED88
Local_C3ED35:
C3/ED35: 80 08        BRA Routine_C3ED3F
C3/ED37: 10 54        BPL Local_C3ED8D
C3/ED39: 80 08        BRA Routine_C3ED43
C3/ED3B: F8           SED
Local_C3ED3C:
C3/ED3C: 00 4F        BRK $4F
C3/ED3E: 80 F0        BRA Routine_C3ED30
C3/ED40: 08           PHP
C3/ED41: 4F 80 E8 10  EOR $10E880
C3/ED45: 51 80        EOR ($80),Y
C3/ED47: F0 10        BEQ Routine_C3ED59
C3/ED49: 53 80        EOR ($80,S),Y
C3/ED4B: F8           SED
C3/ED4C: 10 53        BPL Routine_C3EDA1
Local_C3ED4E:
C3/ED4E: 80 00        BRA Local_C3ED50
Local_C3ED50:
C3/ED50: 10 53        BPL Local_C3EDA5
C3/ED52: 80 08        BRA Local_C3ED5C
C3/ED54: 10 53        BPL Routine_C3EDA9
C3/ED56: 80 10        BRA Local_C3ED68
C3/ED58: 10 52        BPL Local_C3EDAC
C3/ED5A: 80 08        BRA Routine_C3ED64
Local_C3ED5C:
C3/ED5C: F8           SED
C3/ED5D: 00 4F        BRK $4F
C3/ED5F: 80 F0        BRA Routine_C3ED51
C3/ED61: 08           PHP
C3/ED62: 4F 80 E8 10  EOR $10E880
C3/ED66: 51 80        EOR ($80),Y
Local_C3ED68:
C3/ED68: F0 10        BEQ Routine_C3ED7A
C3/ED6A: 53 80        EOR ($80,S),Y
C3/ED6C: F8           SED
C3/ED6D: 10 53        BPL Routine_C3EDC2
C3/ED6F: 80 00        BRA Local_C3ED71
Local_C3ED71:
C3/ED71: 10 53        BPL Routine_C3EDC6
C3/ED73: 80 08        BRA Local_C3ED7D
C3/ED75: 10 53        BPL Local_C3EDCA
C3/ED77: 80 10        BRA Local_C3ED89
C3/ED79: 10 54        BPL Routine_C3EDCF
C3/ED7B: 80 09        BRA Routine_C3ED86
Local_C3ED7D:
C3/ED7D: F8           SED
C3/ED7E: 00 4F        BRK $4F
C3/ED80: 80 F0        BRA Routine_C3ED72
C3/ED82: 08           PHP
C3/ED83: 4F 80 E8 10  EOR $10E880
C3/ED87: 51 80        EOR ($80),Y
Local_C3ED89:
C3/ED89: F0 10        BEQ Routine_C3ED9B
C3/ED8B: 53 80        EOR ($80,S),Y
Local_C3ED8D:
C3/ED8D: F8           SED
C3/ED8E: 10 53        BPL Routine_C3EDE3
C3/ED90: 80 00        BRA Local_C3ED92
Local_C3ED92:
C3/ED92: 10 53        BPL Routine_C3EDE7
C3/ED94: 80 08        BRA Local_C3ED9E
C3/ED96: 10 53        BPL Routine_C3EDEB
C3/ED98: 80 10        BRA Routine_C3EDAA
C3/ED9A: 10 53        BPL Routine_C3EDEF
C3/ED9C: 80 18        BRA Routine_C3EDB6
Local_C3ED9E:
C3/ED9E: 10 52        BPL Routine_C3EDF2
C3/EDA0: 80 09        BRA Routine_C3EDAB
C3/EDA2: F8           SED
C3/EDA3: 00 4F        BRK $4F
Local_C3EDA5:
C3/EDA5: 80 F0        BRA Routine_C3ED97
C3/EDA7: 08           PHP
C3/EDA8: 4F 80 E8 10  EOR $10E880
Local_C3EDAC:
C3/EDAC: 51 80        EOR ($80),Y
C3/EDAE: F0 10        BEQ Routine_C3EDC0
C3/EDB0: 53 80        EOR ($80,S),Y
C3/EDB2: F8           SED
C3/EDB3: 10 53        BPL Local_C3EE08
C3/EDB5: 80 00        BRA Local_C3EDB7
Local_C3EDB7:
C3/EDB7: 10 53        BPL Local_C3EE0C
C3/EDB9: 80 08        BRA Local_C3EDC3
C3/EDBB: 10 53        BPL Local_C3EE10
C3/EDBD: 80 10        BRA Routine_C3EDCF
C3/EDBF: 10 53        BPL Local_C3EE14
C3/EDC1: 80 18        BRA Routine_C3EDDB
Local_C3EDC3:
C3/EDC3: 10 54        BPL Local_C3EE19
C3/EDC5: 80 13        BRA Local_C3EDDA
C3/EDC7: F8           SED
C3/EDC8: 00 4F        BRK $4F
Local_C3EDCA:
C3/EDCA: 80 F0        BRA Routine_C3EDBC
C3/EDCC: 08           PHP
C3/EDCD: 4F 80 E8 10  EOR $10E880
C3/EDD1: 51 80        EOR ($80),Y
C3/EDD3: F0 10        BEQ Routine_C3EDE5
C3/EDD5: 53 80        EOR ($80,S),Y
C3/EDD7: F8           SED
C3/EDD8: 10 53        BPL Local_C3EE2D
Local_C3EDDA:
C3/EDDA: 80 00        BRA Local_C3EDDC
Local_C3EDDC:
C3/EDDC: 10 53        BPL Local_C3EE31
Local_C3EDDE:
C3/EDDE: 80 08        BRA Local_C3EDE8
C3/EDE0: 10 53        BPL Local_C3EE35
C3/EDE2: 80 10        BRA Local_C3EDF4
C3/EDE4: 10 53        BPL Local_C3EE39
C3/EDE6: 80 18        BRA Local_C3EE00
Local_C3EDE8:
C3/EDE8: 10 54        BPL Routine_C3EE3E
C3/EDEA: 80 F2        BRA Local_C3EDDE
...
C3/EE17: 80 F0        BRA Routine_C3EE09
Local_C3EE19:
C3/EE19: 08           PHP
C3/EE1A: 4F 80 E8 10  EOR $10E880
C3/EE1E: 51 80        EOR ($80),Y
C3/EE20: F0 10        BEQ Routine_C3EE32
C3/EE22: 53 80        EOR ($80,S),Y
C3/EE24: F8           SED
C3/EE25: 10 53        BPL Local_C3EE7A
C3/EE27: 80 00        BRA Local_C3EE29
Local_C3EE29:
C3/EE29: 10 53        BPL Local_C3EE7E
C3/EE2B: 80 08        BRA Local_C3EE35
Local_C3EE2D:
C3/EE2D: 10 53        BPL Local_C3EE82
C3/EE2F: 80 10        BRA Local_C3EE41
Local_C3EE31:
C3/EE31: 10 54        BPL Routine_C3EE87
C3/EE33: 80 F4        BRA Local_C3EE29
Local_C3EE35:
...
C3/EE5C: 80 F0        BRA Routine_C3EE4E
C3/EE5E: 08           PHP
C3/EE5F: 4F 80 E8 10  EOR $10E880
C3/EE63: 51 80        EOR ($80),Y
C3/EE65: F0 10        BEQ Routine_C3EE77
C3/EE67: 53 80        EOR ($80,S),Y
C3/EE69: F8           SED
Local_C3EE6A:
C3/EE6A: 10 53        BPL Local_C3EEBF
C3/EE6C: 80 00        BRA Local_C3EE6E
Local_C3EE6E:
C3/EE6E: 10 53        BPL Local_C3EEC3
C3/EE70: 80 08        BRA Local_C3EE7A
C3/EE72: 10 54        BPL Routine_C3EEC8
C3/EE74: 80 F4        BRA Local_C3EE6A
...
C3/EEA2: F0 E8        BEQ Routine_C3EE8C
...
C3/EEDB: F0 E8        BEQ Local_C3EEC5
...
C3/EF18: F0 E8        BEQ Local_C3EF02
...
C3/EF4D: F0 E8        BEQ Local_C3EF37
