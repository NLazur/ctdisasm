...
C3/87A4: C8           INY
C3/87A5: 3C 08 C7     BIT Local_C3C708,X
C3/87A8: 0C 91 9A     TSB $9A91
C3/87AB: 07 80        ORA [$80]
C3/87AD: 80 40        BRA Local_C387EF
C3/87AF: 82 04 10     BRL Routine_C397B6
C3/87B2: 10 20        BPL Local_C387D4
C3/87B4: 28           PLP
C3/87B5: 19 43 0E     ORA $0E43,Y
C3/87B8: 20 00 95     JSR Local_C39500
C3/87BB: 05 20        ORA $20
C3/87BD: 20 70 60     JSR Local_C36070
C3/87C0: 60           RTS