...
C3/D0DF: 10 85        BPL Local_C3D066
C3/D0E1: 00 10        BRK $10
C3/D0E3: B1 48        LDA ($48),Y
C3/D0E5: 4C 62 4A     JMP Local_C34A62
...
C3/D108: 10 85        BPL Local_C3D08F
C3/D10A: E8           INX
C3/D10B: 20 20 18     JSR Local_C31820
...
C3/D145: 20 34 14     JSR Local_C31434
...
C3/D157: 20 B9 3D     JSR Local_C33DB9
