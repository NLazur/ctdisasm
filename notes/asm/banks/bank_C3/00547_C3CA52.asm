...
C3/CA86: 10 12        BPL Local_C3CA9A
C3/CA88: 00 10        BRK $10
C3/CA8A: 00 52        BRK $52
C3/CA8C: 2C A0 02     BIT Local_C302A0
C3/CA8F: A8           TAY
...
C3/CA99: B0 30        BCS Local_C3CACB
...
C3/CAB7: 30 59        BMI Local_C3CB12
C3/CAB9: 13 B0        ORA ($B0,S),Y
C3/CABB: 80 10        BRA Local_C3CACD
C3/CABD: 30 6B        BMI Local_C3CB2A
