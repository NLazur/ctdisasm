...
C3/BD80: 20 29 2C     JSR Routine_C32C29
C3/BD83: 44 67 80     MVP $67,$80
C3/BD86: 24 10        BIT $10
Local_C3BD88:
C3/BD88: 20 26 1B     JSR Routine_C31B26
...
C3/BDC7: 20 04 1B     JSR Routine_C31B04
C3/BDCA: 28           PLP
C3/BDCB: F8           SED
...
C3/BDD4: F0 4A        BEQ Routine_C3BE20
C3/BDD6: F0 4A        BEQ Routine_C3BE22
C3/BDD8: 50 AE        BVC Local_C3BD88
C3/BDDA: 09 4A        ORA #$4A
C3/BDDC: F0 4A        BEQ Routine_C3BE28
C3/BDDE: F0 4A        BEQ Routine_C3BE2A
C3/BDE0: 20 3C 4A     JSR Routine_C34A3C
C3/BDE3: E0 70        CPX #$70
C3/BDE5: 94 00        STY $00,X
C3/BDE7: 7E BE 94     ROR $94BE,X
C3/BDEA: 80 0C        BRA Routine_C3BDF8
C3/BDEC: 20 4A 60     JSR Routine_C3604A
C3/BDEF: 1A           INC
C3/BDF0: 10 4A        BPL Routine_C3BE3C
C3/BDF2: 40           RTI