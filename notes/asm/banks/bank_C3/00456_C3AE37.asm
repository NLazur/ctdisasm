...
C3/AE74: 80 00        BRA $AE76
C3/AE76: 00 00        BRK $00
C3/AE78: 0A           ASL
C3/AE79: 22 00 0A 23  JSR $230A00
...
C3/AEA4: 50 1F        BVC $AEC5
C3/AEA6: 00 0B        BRK $0B
C3/AEA8: 22 38 06 04  JSR $040638
C3/AEAC: 08           PHP
C3/AEAD: F0 10        BEQ $AEBF
C3/AEAF: 10 09        BPL $AEBA
C3/AEB1: A4 07        LDY $07
C3/AEB3: 7F 38 C8 30  ADC $30C838,X
C3/AEB7: 0C 22 45     TSB $4522
C3/AEBA: 10 38        BPL $AEF4
C3/AEBC: 04 08        TSB $08
C3/AEBE: F0 10        BEQ $AED0
C3/AEC0: 30 00        BMI $AEC2
...
C3/AF20: 22 70 DF 10  JSR $10DF70
C3/AF24: 40           RTI