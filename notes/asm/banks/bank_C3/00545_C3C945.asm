...
C3/C963: 7A           PLY
C3/C964: 38           SEC
C3/C965: 10 04        BPL $C96B
C3/C967: 80 C0        BRA $C929
C3/C969: 7E A0 01     ROR $01A0,X
C3/C96C: 02 0D        COP $0D
C3/C96E: 22 04 14 10  JSR $101404
C3/C972: A1 14        LDA ($14,X)
C3/C974: 10 A0        BPL $C916
C3/C976: 10 4A        BPL $C9C2
C3/C978: 00 38        BRK $38
C3/C97A: 20 84 31     JSR $3184
...
C3/C98E: 22 F5 38 3C  JSR $3C38F5
C3/C992: 30 09        BMI $C99D
C3/C994: 92 06        STA ($06)
C3/C996: 7F 48 40 34  ADC $344048,X
C3/C99A: B0 3C        BCS $C9D8
