...
C3/C952: 3C 34 56     BIT Local_C35634,X
C3/C955: 7A           PLY
C3/C956: 0D 22 00     ORA $0022
C3/C959: 10 36        BPL Local_C3C991
...
C3/C963: 7A           PLY
C3/C964: 38           SEC
C3/C965: 10 04        BPL Local_C3C96B
C3/C967: 80 C0        BRA Local_C3C929
C3/C969: 7E A0 01     ROR $01A0,X
C3/C96C: 02 0D        COP $0D
C3/C96E: 22 04 14 10  JSR Routine_101404
C3/C972: A1 14        LDA ($14,X)
C3/C974: 10 A0        BPL Local_C3C916
C3/C976: 10 4A        BPL Local_C3C9C2
C3/C978: 00 38        BRK $38
C3/C97A: 20 84 31     JSR Local_C33184
...
C3/C992: 30 09        BMI Local_C3C99D
C3/C994: 92 06        STA ($06)
C3/C996: 7F 48 40 34  ADC $344048,X
C3/C99A: B0 3C        BCS Local_C3C9D8
...
C3/C9BF: B0 08        BCS Local_C3C9C9
...
C3/C9DB: F0 04        BEQ Local_C3C9E1
...
C3/C9F4: 30 1C        BMI Local_C3CA12
