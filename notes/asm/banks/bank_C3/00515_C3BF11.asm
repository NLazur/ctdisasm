...
Routine_C3BF11:
C3/BF11: 58           CLI
C3/BF12: 30 03        BMI Local_C3BF17
C3/BF14: E8           INX
C3/BF15: 08           PHP
...
C3/BF45: 18           CLC
C3/BF46: 90 38        BCC Local_C3BF80
C3/BF48: 3C 28 E2     BIT Local_C3E228,X
...
C3/BF75: F0 07        BEQ Local_C3BF7E
...
C3/BFAC: 20 76 09     JSR Local_C30976
...
C3/C028: 4C A6 00     JMP Local_C300A6
C3/C02B: 1B           TCS
...
C3/C054: 1B           TCS
C3/C055: 10 9E        BPL Local_C3BFF5
C3/C057: 1B           TCS
C3/C058: 10 9F        BPL Local_C3BFF9
C3/C05A: 1B           TCS
C3/C05B: 00 10        BRK $10
C3/C05D: A0 1B        LDY #$1B
C3/C05F: 10 A1        BPL Local_C3C002
C3/C061: 1B           TCS
C3/C062: 10 A2        BPL Local_C3C006
...
C3/C071: 30 79        BMI Local_C3C0EC
C3/C073: 4C F7 1B     JMP Local_C31BF7
C3/C076: 00 78        BRK $78
C3/C078: 0A           ASL
C3/C079: 39 01 1A     AND $1A01,Y
C3/C07C: F0 04        BEQ Local_C3C082
C3/C07E: 38           SEC
C3/C07F: 30 01        BMI Local_C3C082
C3/C081: 11 F7        ORA ($F7),Y
C3/C083: 1B           TCS
C3/C084: 08           PHP
C3/C085: 20 CF 00     JSR Local_C300CF
...
C3/C0A2: 18           CLC
C3/C0A3: 80 60        BRA Local_C3C105
C3/C0A5: 24 70        BIT $70
C3/C0A7: 1A           INC
C3/C0A8: 00 0D        BRK $0D
C3/C0AA: 05 2C        ORA $2C
C3/C0AC: 90 02        BCC Local_C3C0B0
C3/C0AE: D8           CLD
...
C3/C0E1: 98           TYA
C3/C0E2: 20 00 00     JSR Local_C30000
