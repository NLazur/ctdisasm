...
C3/6671: 4C 80 9B     JMP Local_C39B80
C3/6674: 57 A5        EOR [$A5],Y
C3/6676: 08           PHP
C3/6677: 0A           ASL
C3/6678: 85 FE        STA $FE
C3/667A: 8B           PHB
C3/667B: 10 58        BPL Local_C366D5
C3/667D: 08           PHP
C3/667E: 10 04        BPL Local_C36684
...
C3/6696: F0 20        BEQ Local_C366B8
C3/6698: 50 6F        BVC Local_C36709
C3/669A: 60           RTS