...
C3/F1B0: F0 F0        BEQ Local_C3F1A2
...
C3/F1CD: E8           INX
C3/F1CE: 58           CLI
C3/F1CF: 20 00 08     JSR Local_C30800
C3/F1D2: 38           SEC
...
C3/F1D9: 08           PHP
C3/F1DA: 58           CLI
C3/F1DB: 20 00 F0     JSR Local_C3F000
...
C3/F1EA: 10 2A        BPL Local_C3F216
C3/F1EC: 00 F0        BRK $F0
C3/F1EE: 20 0C 00     JSR Local_C3000C
...
C3/F1FE: 20 06 00     JSR Local_C30006
C3/F201: D8           CLD
C3/F202: 30 26        BMI Local_C3F22A
C3/F204: 00 18        BRK $18
C3/F206: 20 06 00     JSR Local_C30006
C3/F209: 18           CLC
C3/F20A: 30 26        BMI Local_C3F232
...
C3/F24C: F8           SED
C3/F24D: 4C 00 03     JMP Local_C30300
C3/F250: E8           INX
C3/F251: F8           SED
C3/F252: 48           PHA
...
C3/F259: F8           SED
C3/F25A: 4C 00 03     JMP Local_C30300
C3/F25D: E8           INX
C3/F25E: F8           SED
C3/F25F: 2A           ROL
C3/F260: 00 F8        BRK $F8
C3/F262: F8           SED
C3/F263: 2C 00 08     BIT Local_C30800
C3/F266: F8           SED
...
C3/F283: 10 0C        BPL Local_C3F291
C3/F285: 00 10        BRK $10
C3/F287: 10 0E        BPL Local_C3F297
C3/F289: 00 04        BRK $04
C3/F28B: E0 F0        CPX #$F0
C3/F28D: 20 00 F0     JSR Local_C3F000
C3/F290: F0 22        BEQ Local_C3F2B4
C3/F292: 00 00        BRK $00
C3/F294: F0 24        BEQ Local_C3F2BA
...
C3/F2C6: F0 40        BEQ Local_C3F308
...
C3/F2DE: F0 60        BEQ Local_C3F340
C3/F2E0: 00 00        BRK $00
C3/F2E2: F0 64        BEQ Local_C3F348
...
C3/F32B: D0 4E        BNE Local_C3F37B
C3/F32D: 00 F0        BRK $F0
C3/F32F: E0 4E        CPX #$4E
C3/F331: 00 F0        BRK $F0
C3/F333: F0 4E        BEQ Local_C3F383
