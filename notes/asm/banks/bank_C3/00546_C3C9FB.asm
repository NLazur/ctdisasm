...
C3/CA04: 10 9F        BPL Local_C3C9A5
C3/CA06: 70 E7        BVS Local_C3C9EF
C3/CA08: 30 5A        BMI Local_C3CA64
...
C3/CA24: 38           SEC
C3/CA25: 3C 4B 88     BIT Local_C3884B,X
C3/CA28: 01 01        ORA ($01,X)
C3/CA2A: 00 00        BRK $00
C3/CA2C: 52 3B        EOR ($3B)
C3/CA2E: 4B           PHK
C3/CA2F: 80 34        BRA Local_C3CA65
C3/CA31: DA           PHX
C3/CA32: 7A           PLY
