...
C3/C12C: 80 30        BRA Routine_C3C15E
C3/C12E: 80 A0        BRA Routine_C3C0D0
...
C3/C14D: 10 E7        BPL Routine_C3C136
...
C3/C15B: 10 E9        BPL Routine_C3C146
...
C3/C173: 90 7F        BCC Routine_C3C1F4
Local_C3C175:
C3/C175: 48           PHA
...
C3/C182: 10 20        BPL Routine_C3C1A4
C3/C184: 7B           TDC
