...
C3/C12C: 80 30        BRA $C15E
C3/C12E: 80 A0        BRA $C0D0
C3/C130: 3C 80 02     BIT $0280,X
C3/C133: C0 48        CPY #$48
C3/C135: 70 1A        BVS $C151
C3/C137: DA           PHX
