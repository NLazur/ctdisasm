...
C3/B9C6: F0 F9        BEQ Local_C3B9C1
...
C3/B9F5: 10 D8        BPL Local_C3B9CF
...
C3/BA06: 4C 05 D1     JMP Local_C3D105
...
C3/BA41: 1B           TCS
C3/BA42: 20 32 00     JSR Local_C30032
...
C3/BA78: 10 6B        BPL Local_C3BAE5
C3/BA7A: 06 7F        ASL $7F
C3/BA7C: 12 20        ORA ($20)
C3/BA7E: 24 DD        BIT $DD
C3/BA80: 0B           PHD
C3/BA81: 08           PHP
C3/BA82: 30 36        BMI Local_C3BABA
...
C3/BA97: 30 35        BMI Local_C3BACE
...
C3/BAB1: 1B           TCS
C3/BAB2: 10 9F        BPL Local_C3BA53
C3/BAB4: 1B           TCS
C3/BAB5: 10 A0        BPL Local_C3BA57
C3/BAB7: 00 1B        BRK $1B
C3/BAB9: 10 A1        BPL Local_C3BA5C
C3/BABB: 1B           TCS
C3/BABC: 10 A2        BPL Local_C3BA60
C3/BABE: 1B           TCS
C3/BABF: 37 00        AND [$00],Y
C3/BAC1: 2C 08 00     BIT Local_C30008
...
C3/BAD6: B0 04        BCS Local_C3BADC
C3/BAD8: 38           SEC
...
C3/BB00: 80 7E        BRA Local_C3BB80
