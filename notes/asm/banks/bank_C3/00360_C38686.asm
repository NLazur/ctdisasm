...
C3/86BE: 70 20        BVS Local_C386E0
C3/86C0: 02 D8        COP $D8
C3/86C2: 01 28        ORA ($28,X)
C3/86C4: F8           SED
C3/86C5: 20 70 30     JSR Local_C33070
C3/86C8: 30 20        BMI Local_C386EA
C3/86CA: 08           PHP
C3/86CB: 50 50        BVC Local_C3871D
C3/86CD: 88           DEY
C3/86CE: 02 20        COP $20
C3/86D0: A8           TAY
C3/86D1: 20 50 00     JSR Local_C30050
