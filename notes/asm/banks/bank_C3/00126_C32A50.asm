...
C3/2A5F: F0 C4        BEQ Local_C32A25
C3/2A61: 18           CLC
C3/2A62: 90 01        BCC Local_C32A65
C3/2A64: 7D 28 94     ADC $9428,X
C3/2A67: 20 4E 4D     JSR Local_C34D4E
C3/2A6A: 20 A5 4D     JSR Local_C34DA5
...
C3/2A9F: F0 A5        BEQ Local_C32A46
...
C3/2AB3: F0 94        BEQ Local_C32A49
C3/2AB5: 2B           PLD
C3/2AB6: F0 85        BEQ Local_C32A3D
C3/2AB8: 48           PHA
C3/2AB9: 60           RTS