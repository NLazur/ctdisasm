...
C3/6CCD: 10 8C        BPL Routine_C36C5B
C3/6CCF: 33 20        AND ($20,S),Y
C3/6CD1: 10 00        BPL Local_C36CD3
Local_C36CD3:
C3/6CD3: 8E 33 30     STX $3033
C3/6CD6: 10 A0        BPL Routine_C36C78
C3/6CD8: 33 00        AND ($00,S),Y
C3/6CDA: 20 00 A2     JSR Routine_C3A200
C3/6CDD: 33 10        AND ($10,S),Y
C3/6CDF: 20 A4 33     JSR Routine_C333A4
C3/6CE2: 20 20 00     JSR Routine_C30020
C3/6CE5: A6 33        LDX $33
C3/6CE7: 30 20        BMI Routine_C36D09
C3/6CE9: A8           TAY
...
C3/6CF1: 30 AC        BMI Routine_C36C9F
