...
D0/AB7E: 58           CLI
D0/AB7F: 38           SEC
D0/AB80: 70 58        BVS $ABDA
D0/AB82: 6C 40 5C     JMP ($5C40)
D0/AB85: B0 44        BCS $ABCB
D0/AB87: D0 00        BNE $AB89
...
D0/ABA8: 80 80        BRA $AB2A
D0/ABAA: 20 60 D0     JSR $D060
D0/ABAD: D0 30        BNE $ABDF
D0/ABAF: F0 18        BEQ $ABC9
D0/ABB1: F0 D4        BEQ $AB87
D0/ABB3: 28           PLP
D0/ABB4: 5C 50 AC E0  JMP $E0AC50
D0/ABB8: 80 E0        BRA $AB9A
D0/ABBA: 30 10        BMI $ABCC
D0/ABBC: 10 F8        BPL $ABB6
D0/ABBE: A8           TAY
D0/ABBF: 18           CLC
...
D0/ABE0: 90 70        BCC $AC52
D0/ABE2: 68           PLA
D0/ABE3: 18           CLC
D0/ABE4: F0 F0        BEQ $ABD6
D0/ABE6: 00 00        BRK $00
D0/ABE8: 7C FC FE     JMP ($FEFC,X)
D0/ABEB: FC F0 F8     JSR ($F8F0,X)
D0/ABEE: F0 00        BEQ $ABF0
D0/ABF0: 50 17        BVC $AC09
D0/ABF2: 5B           TCD
...
D0/AC12: 90 60        BCC $AC74
D0/AC14: F0 E0        BEQ $ABF6
